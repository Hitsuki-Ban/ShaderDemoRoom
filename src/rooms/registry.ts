...
export const roomRegistry = [
  {
    ...
    stageProfile: { shellChrome: 'default' },
    rendererProfile: { transmissionResolutionScale: 1 },
  ...
  },
  {
    ...
    stageProfile: { shellChrome: 'default' },
    rendererProfile: { transmissionResolutionScale: 0.5 },
  ...
  },
  {
    ...
    bridgeCapabilities: ['pause', 'stats', 'set-mode', 'set-quality'],
  ...
  },
  {
    ...
    bridgeCapabilities: ['pause', 'stats', 'set-preview'],
