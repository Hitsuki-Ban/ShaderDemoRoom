...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(e,t,n){let r=new Float32Array(Po),i=new W(0,1,0);return new sa({name:`SphericalGaussianBlur`,defines:{n:Po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zo(),fragmentShader:`
	...
	`}var Qo=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};_u.BlurDirectionX=new U(1,0),_u.BlurDirectionY=new U(0,1);var vu={name:`SMAAEdgesShader`,defines:{SMAA_THRESHOLD:`0.1`},uniforms:{tDiffuse:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
		...
		}`},yu={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
		...
		}`},bu={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
		...
		}`},Cu=class extends su{constructor(){super(),this.isOutputPass=!0,this.uniforms=ia.clone(Su.uniforms),this.material=new ca({name:Su.name,uniforms:this.uniforms,vertexShader:Su.vertexShader,fragmentShader:Su.fragmentShader}),this._fsQuad=new uu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},wu=e=>document.querySelector(e),Tu=e=>[...document.querySelectorAll(e)],Eu=wu(`#scene`),Du=wu(`#loading`),Ou=wu(`#fps`),ku=wu(`#pipeline`),Au=wu(`#state-name`),ju=wu(`#material-type`),Mu=wu(`#material-metrics`),Nu=wu(`#material-note`),Pu=wu(`#matter-state`),Fu=wu(`#toast`),Iu=wu(`#lab-panel`),Lu=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,Ru=window.matchMedia(`(pointer: coarse)`).matches,zu=e=>Ot.clamp(e,0,1),Bu=(e,t,n,r)=>Ot.damp(e,t,n,r),Vu=e=>new q(e),Z=[{zh:`静水`,en:`CALM`,material:`AQUEOUS / WATER`,deep:`#031522`,mid:`#14c8ef`,light:`#efffff`,accent:`#68f2ff`,ink:`#01070d`,floor:`#48ebff`,backdrop:`#0f708c`,deform:.78,speed:.78,bloom:.46,chroma:.25,posterize:0,rim:1.02,viscosity:.16,tension:.92,swell:.18,flow:.35,turbulence:.18,foam:.08,clarity:.94,elasticity:1.08,recovery:1.22,shear:.72,note:55,noteZh:`高表面张力、清澈折射与短促毛细波。`},{zh:`涨潮`,en:`SURGE`,material:`OCEANIC / BREAKER`,deep:`#1b0923`,mid:`#ec3b9b`,light:`#fff7df`,accent:`#ffb72f`,ink:`#10030d`,floor:`#ff56ba`,backdrop:`#8b2859`,deform:1.34,speed:1.16,bloom:.72,chroma:.72,posterize:0,rim:1.17,viscosity:.07,tension:.54,swell:1,flow:1.2,turbulence:.92,foam:1,clarity:.62,elasticity:.82,recovery:.92,shear:1.22,note:65.41,noteZh:`低黏度大惯性浪涌，陡峭波峰与破碎泡沫。`},{zh:`绽生`,en:`BLOOM`,material:`VISCOUS / PROTOPLASM`,deep:`#061b19`,mid:`#35dea8`,light:`#f4ffed`,accent:`#b2ff4d`,ink:`#02100d`,floor:`#63ffc3`,backdrop:`#1b826b`,deform:1.12,speed:.72,bloom:.6,chroma:.42,posterize:0,rim:1.1,viscosity:.9,tension:.7,swell:.34,flow:.76,turbulence:.28,foam:.12,clarity:.48,elasticity:.38,recovery:.34,shear:1.52,note:73.42,noteZh:`高黏度活体胶质，形变滞留并拉出缓慢流丝。`},{zh:`零界`,en:`VOID`,material:`METALLIC / SUPERCOOLED`,deep:`#010204`,mid:`#9eabb5`,light:`#ffffff`,accent:`#ff3a52`,ink:`#000000`,floor:`#e4fbff`,backdrop:`#677984`,deform:.68,speed:.6,bloom:.39,chroma:1.08,posterize:.72,rim:1.42,viscosity:.24,tension:1.24,swell:.08,flow:.16,turbulence:.12,foam:0,clarity:.72,elasticity:1.34,recovery:1.48,shear:.58,note:41.2,noteZh:`超冷却金属水体，流动稀少、回弹尖锐并带离散扫描。`}].map(e=>({...e,deepColor:Vu(e.deep),midColor:Vu(e.mid),lightColor:Vu(e.light),accentColor:Vu(e.accent),inkColor:Vu(e.ink),floorColor:Vu(e.floor),backdropColor:Vu(e.backdrop)})),Hu={userDeform:1,userSpeed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1,quality:Ru?`medium`:`high`},Uu;try{Uu=new Il({canvas:Eu,antialias:!1,alpha:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!0})}catch(e){throw Du.innerHTML=`<p>WEBGL INITIALIZATION FAILED<br>${String(e.message||e)}</p>`,e}Uu.setClearColor(198157,1),Uu.outputColorSpace=ze,Uu.toneMapping=4,Uu.toneMappingExposure=.86,Uu.shadowMap.enabled=!0,Uu.shadowMap.type=1,Uu.debug.checkShaderErrors=!0,ku.textContent=Uu.capabilities.isWebGL2?`WEBGL2 / GLSL`:`WEBGL / GLSL`;var Wu=new Fn;Wu.background=new q(198157),Wu.fog=new Pn(198157,.042);var Gu=new Ha(42,1,.05,80);Gu.position.set(0,1.05,8.1);var Ku=new ql(Gu,Eu);Ku.target.set(0,.42,0),Ku.enableDamping=!0,Ku.dampingFactor=.055,Ku.enablePan=!1,Ku.minDistance=5.2,Ku.maxDistance=10.2,Ku.minPolarAngle=.72,Ku.maxPolarAngle=1.72,Ku.minAzimuthAngle=-1,Ku.maxAzimuthAngle=1,Ku.autoRotate=!1,Ku.autoRotateSpeed=.35,Ku.update();var qu=new Aa(10415871,1180687,.72);Wu.add(qu);var Ju=new Wa(14285823,52,24,Math.PI/5.5,.7,1.5);Ju.position.set(-4.5,7,5.4),Ju.target.position.set(0,0,0),Ju.castShadow=!0,Ju.shadow.mapSize.set(1024,1024),Ju.shadow.bias=-2e-4,Wu.add(Ju,Ju.target);var Yu=new Ka(16732120,22,16,2);Yu.position.set(4.2,1.8,-2.2),Wu.add(Yu);var Xu=new Jt(1,1,{depthBuffer:!0,stencilBuffer:!1,minFilter:c,magFilter:c});Xu.texture.name=`MIZU_REFRACTION_BUFFER`,Xu.texture.generateMipmaps=!1;var Zu=`
...
`,Q={uTime:{value:0},uDeform:{value:Z[0].deform},uTouchStrength:{value:0},uPointerVelocity:{value:0},uPulse:{value:0},uAudio:{value:0},uTension:{value:Z[0].tension},uMode:{value:0},uViscosity:{value:Z[0].viscosity},uSwell:{value:Z[0].swell},uFlowStrength:{value:Z[0].flow},uTurbulence:{value:Z[0].turbulence},uFoam:{value:Z[0].foam},uClarity:{value:Z[0].clarity},uElasticity:{value:Z[0].elasticity},uShear:{value:Z[0].shear},uTouchPoint:{value:new W(0,0,1)},uDragVector:{value:new W},uReleasePoint:{value:new W(0,0,1)},uReleaseVector:{value:new W},uReleaseTime:{value:-100},uReleaseEnergy:{value:0},uFreezeProgress:{value:0},uFreezeOrigin:{value:new W(0,0,1)},uFreezeTime:{value:0},uRipples:{value:Array.from({length:5},()=>new Kt(0,0,1,-100))},uSceneTexture:{value:Xu.texture},uResolution:{value:new U(1,1)},uDeepColor:{value:Z[0].deepColor.clone()},uMidColor:{value:Z[0].midColor.clone()},uLightColor:{value:Z[0].lightColor.clone()},uAccentColor:{value:Z[0].accentColor.clone()},uInkColor:{value:Z[0].inkColor.clone()},uRimStrength:{value:Z[0].rim},uFacet:{value:0},uOpacity:{value:.88},uOutlineThickness:{value:.046}},$u=`
${Zu}
${Qu}
...
`,sd=new En;sd.position.y=.48,Wu.add(sd);var cd=new Ki(1.65,5),ld=new sa({uniforms:Q,vertexShader:$u,fragmentShader:ed,transparent:!0,depthWrite:!1,side:0});ld.extensions.derivatives=!0;var ud=new sa({uniforms:Q,vertexShader:td,fragmentShader:nd,transparent:!0,depthWrite:!1,side:1}),dd=new Zr(cd,ld);dd.renderOrder=3,sd.add(dd);var fd=new Zr(cd,ud);fd.renderOrder=2,sd.add(fd);var pd=new Zr(cd,new sa({uniforms:Q,vertexShader:rd,fragmentShader:id,transparent:!0,depthWrite:!1,side:1}));pd.scale.setScalar(.985),pd.renderOrder=1,sd.add(pd);var md=new Ki(1.69,2),hd=new sa({uniforms:Q,vertexShader:ad,fragmentShader:od,transparent:!0,depthWrite:!1,side:0});hd.extensions.derivatives=!0;var gd=new Zr(md,hd);gd.renderOrder=4,sd.add(gd);var _d=new zr({color:Z[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),vd=new En,yd=[],bd=new qi(.18,0);for(let e=0;e<22;e+=1){let e=new Zr(bd,_d),t=new W(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1).normalize(),n=.18+Math.random()**.72*1.25;e.position.copy(t).multiplyScalar(n),e.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);let r=.22+Math.random()*.48,i=.72+Math.random()*1.75;e.scale.set(r,i,r*(.66+Math.random()*.55)),e.userData.baseScale=e.scale.clone(),e.userData.phase=Math.random()*Math.PI*2,vd.add(e),yd.push(e)}vd.visible=!1,vd.renderOrder=1,sd.add(vd);var xd=new Or;xd.setAttribute(`position`,new J([],3));var Sd=new vi({color:Z[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),Cd=new Ai(xd,Sd);Cd.renderOrder=3,Cd.visible=!1,Cd.userData.vertexCount=0,sd.add(Cd);function wd(e){return function(){let t=e+=1831565813;return t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296}}function Td(e){let t=e.clone().normalize(),n=wd(Math.abs(Math.floor((t.x*1731+t.y*3191+t.z*7919)*1e4))+17),r=new W().crossVectors(t,Math.abs(t.y)<.92?new W(0,1,0):new W(1,0,0)).normalize(),i=new W().crossVectors(t,r).normalize(),a=[],o=(e,o,s,c,l=.22)=>{let u=e.clone(),d=o.clone().normalize();for(let e=0;e<s;e+=1){let e=r.clone().multiplyScalar((n()-.5)*2).addScaledVector(i,(n()-.5)*2).addScaledVector(t,(n()-.5)*.45).normalize(),o=u.clone().normalize().multiplyScalar(-.19);d.multiplyScalar(.78).addScaledVector(e,l).add(o).normalize();let s=u.clone().addScaledVector(d,c*(.78+n()*.46));s.length()>1.57&&s.normalize().multiplyScalar(1.55),a.push(u.x,u.y,u.z,s.x,s.y,s.z),u=s}};for(let e=0;e<12;e+=1){let e=(n()-.5)*.82,a=(n()-.5)*.82,s=t.clone().multiplyScalar(1.57).addScaledVector(r,e*.08).addScaledVector(i,a*.08),c=t.clone().multiplyScalar(-.76-n()*.22).addScaledVector(r,e).addScaledVector(i,a).normalize();o(s,c,8+Math.floor(n()*6),.13,.2),o(s.clone().addScaledVector(c,.42+n()*.3),c.clone().addScaledVector(r,(n()-.5)*1).addScaledVector(i,(n()-.5)*1).normalize(),3+Math.floor(n()*4),.105,.32)}xd.setAttribute(`position`,new J(a,3)),xd.computeBoundingSphere(),Cd.userData.vertexCount=a.length/3,xd.setDrawRange(0,0)}var Ed=new zr({transparent:!0,opacity:0,depthWrite:!1});Ed.colorWrite=!1;var Dd=new Zr(new Xi(1.76,28,20),Ed);Dd.renderOrder=-10,sd.add(Dd);var Od=new sa({uniforms:{uTime:Q.uTime,uAudio:Q.uAudio,uPulse:Q.uPulse,uMode:Q.uMode,uFreezeProgress:Q.uFreezeProgress,uMidColor:Q.uMidColor,uLightColor:Q.uLightColor,uAccentColor:Q.uAccentColor},vertexShader:`
  ...
  `,transparent:!0,depthWrite:!1,blending:2,side:2}),kd=new Zr(new Ki(1.02,4),Od);kd.renderOrder=1,sd.add(kd);var Ad=new zr({color:Z[0].accentColor,transparent:!0,opacity:.28,depthWrite:!1,blending:2}),jd=new Zr(new Qi(.57,.055,220,18,2,3),Ad);jd.renderOrder=1,sd.add(jd);var Md=new En;Wu.add(Md);var Nd=new la({color:462874,roughness:.24,metalness:.82}),Pd=new Zr(new Wi(2.22,2.48,.34,96,1),Nd);Pd.position.y=-1.32,Pd.receiveShadow=!0,Pd.castShadow=!0,Md.add(Pd);var Fd=new la({color:727332,roughness:.12,metalness:.88,emissive:Z[0].floorColor.clone(),emissiveIntensity:.08}),Id=new Zr(new Wi(1.82,1.88,.065,96),Fd);Id.position.y=-1.12,Id.receiveShadow=!0,Md.add(Id);var Ld={uTime:Q.uTime,uMode:Q.uMode,uFlowStrength:Q.uFlowStrength,uTurbulence:Q.uTurbulence,uFoam:Q.uFoam,uFreezeProgress:Q.uFreezeProgress,uColor:{value:Z[0].floorColor.clone()},uLightColor:Q.uLightColor},Rd=new Zr(new Ui(1.79,128),new sa({uniforms:Ld,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));Rd.rotation.x=-Math.PI/2,Rd.position.y=-1.078,Rd.renderOrder=2,Md.add(Rd);var zd=new zr({color:Z[0].floorColor,transparent:!0,opacity:.72,depthWrite:!1,blending:2}),Bd=new Zr(new Zi(1.96,.018,8,192),zd);Bd.rotation.x=Math.PI/2,Bd.position.y=-1.075,Md.add(Bd);var Vd=new zr({color:Z[0].floorColor,transparent:!0,opacity:.3}),Hd=new li(new Hi(.025,.012,.16),Vd,48),Ud=new Tn;for(let e=0;e<48;e+=1){let t=e/48*Math.PI*2;Ud.position.set(Math.cos(t)*2.28,-1.105,Math.sin(t)*2.28),Ud.rotation.y=-t,Ud.scale.z=e%4==0?1.7:.65,Ud.updateMatrix(),Hd.setMatrixAt(e,Ud.matrix)}Md.add(Hd);var Wd={uTime:Q.uTime,uPulse:Q.uPulse,uAudio:Q.uAudio,uColor:{value:Z[0].floorColor.clone()}},Gd=new Zr(new Ji(32,32,1,1),new sa({uniforms:Wd,vertexShader:`
      varying vec2 vWorld;
      void main() {
        vec4 world = modelMatrix * vec4(position, 1.0);
        vWorld = world.xz;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));Gd.rotation.x=-Math.PI/2,Gd.position.y=-1.5,Wu.add(Gd);var Kd={uTime:Q.uTime,uPulse:Q.uPulse,uAudio:Q.uAudio,uColor:{value:Z[0].backdropColor.clone()},uAccent:Q.uAccentColor},qd=new Zr(new Ui(4.25,192),new sa({uniforms:Kd,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));qd.renderOrder=-2,Wu.add(qd);var Jd=new En;Wu.add(Jd);var Yd=[];for(let e=0;e<3;e+=1){let t=new zr({color:Z[0].floorColor,transparent:!0,opacity:.18-e*.035,depthWrite:!1,blending:2});Yd.push(t);let n=new Zr(new Zi(2.4+e*.42,.009+e*.002,6,256),t);n.rotation.set(Math.PI*(.18+e*.21),e*.75,e*.45),n.position.y=.42,Jd.add(n)}var Xd={uTime:Q.uTime,uPulse:Q.uPulse,uColor:{value:Z[0].backdropColor.clone()}},Zd=new En;Wu.add(Zd);for(let e=0;e<7;e+=1){let t=new Zr(new Ji(.08+e%3*.05,7.5),new sa({uniforms:Xd,vertexShader:`
        varying vec2 vUv2;
      ...
      `,transparent:!0,depthWrite:!1,blending:2,side:2}));t.position.set((e-3)*1.18+e%2*.28,1.35+e%2*.2,-4.1-Math.abs(e-3)*.08),Zd.add(t)}var Qd=950,$d=new Float32Array(Qd*3),ef=new Float32Array(Qd),tf=new Float32Array(Qd);for(let e=0;e<Qd;e+=1){let t=4+Math.random()*8.5,n=Math.random()*Math.PI*2;$d[e*3]=Math.cos(n)*t,$d[e*3+1]=-3.6+Math.random()*10.2,$d[e*3+2]=Math.sin(n)*t*.72-1.5,ef[e]=Math.random(),tf[e]=Math.random()*Math.PI*2}var nf=new Or;nf.setAttribute(`position`,new mr($d,3)),nf.setAttribute(`aScale`,new mr(ef,1)),nf.setAttribute(`aPhase`,new mr(tf,1));var rf={uTime:Q.uTime,uAudio:Q.uAudio,uColor:{value:Z[0].floorColor.clone()}},af=new Ii(nf,new sa({uniforms:rf,vertexShader:`
      uniform float uTime;
      uniform float uAudio;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));Wu.add(af);var of=new ei(new Uint8Array([35,145,255]),3,1,k);of.needsUpdate=!0,of.minFilter=a,of.magFilter=a;var sf=new ua({color:Z[0].midColor,gradientMap:of,transparent:!0,opacity:.66}),cf=new Ki(.13,2),lf=new En;Wu.add(lf);var uf=[];for(let e=0;e<16;e+=1){let e=new Zr(cf,sf),t=.45+Math.random()*1.2;e.scale.setScalar(t),lf.add(e),uf.push({mesh:e,radius:2.2+Math.random()*2.7,phase:Math.random()*Math.PI*2,speed:(.08+Math.random()*.12)*(Math.random()>.5?1:-1),yAmp:.35+Math.random()*1.5,tilt:-.35+Math.random()*.7,scale:t})}var df=new class{constructor(e=320){this.max=e,this.cursor=0,this.positions=new Float32Array(e*3),this.velocities=new Float32Array(e*3),this.life=new Float32Array(e),this.size=new Float32Array(e);for(let t=0;t<e;t+=1)this.positions[t*3+1]=-999;this.geometry=new Or,this.geometry.setAttribute(`position`,new mr(this.positions,3)),this.geometry.setAttribute(`aLife`,new mr(this.life,1)),this.geometry.setAttribute(`aSize`,new mr(this.size,1)),this.uniforms={uColor:{value:Z[0].accentColor.clone()}},this.points=new Ii(this.geometry,new sa({uniforms:this.uniforms,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:2})),Wu.add(this.points)}spawn(e,t,n=1,r=36){let i=new W().crossVectors(t,Math.abs(t.y)<.9?new W(0,1,0):new W(1,0,0)).normalize(),a=new W().crossVectors(t,i).normalize();for(let o=0;o<r;o+=1){let r=this.cursor;this.cursor=(this.cursor+1)%this.max;let o=r*3,s=(Math.random()-.5)*2,c=(Math.random()-.5)*2,l=.45+Math.random()*1.4,u=(.8+Math.random()*1.8)*n,d=t.clone().multiplyScalar(l).addScaledVector(i,s).addScaledVector(a,c).normalize().multiplyScalar(u);this.positions[o]=e.x+t.x*.04,this.positions[o+1]=e.y+t.y*.04,this.positions[o+2]=e.z+t.z*.04,this.velocities[o]=d.x,this.velocities[o+1]=d.y,this.velocities[o+2]=d.z,this.life[r]=.62+Math.random()*.38,this.size[r]=2.5+Math.random()*4.5}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aLife.needsUpdate=!0,this.geometry.attributes.aSize.needsUpdate=!0}update(e){for(let t=0;t<this.max;t+=1){if(this.life[t]<=0)continue;let n=t*3;this.life[t]=Math.max(0,this.life[t]-e*.72),this.positions[n]+=this.velocities[n]*e,this.positions[n+1]+=this.velocities[n+1]*e,this.positions[n+2]+=this.velocities[n+2]*e,this.velocities[n]*=.94**(e*60),this.velocities[n+1]=this.velocities[n+1]*.94**(e*60)-.28*e,this.velocities[n+2]*=.94**(e*60),this.life[t]===0&&(this.positions[n+1]=-999)}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aLife.needsUpdate=!0}},ff=[];for(let e=0;e<7;e+=1){let e=new zr({color:Z[0].accentColor,transparent:!0,opacity:0,depthWrite:!1,blending:2,side:2}),t=new Zr(new Yi(.34,.38,96),e);t.visible=!1,Wu.add(t),ff.push({mesh:t,life:0})}var pf=0;function mf(e,t,n=1){let r=ff[pf];pf=(pf+1)%ff.length,r.life=1,r.intensity=n,r.mesh.visible=!0,r.mesh.position.copy(e).addScaledVector(t,.045),r.mesh.quaternion.setFromUnitVectors(new W(0,0,1),t),r.mesh.scale.setScalar(.08),r.mesh.material.opacity=.9}var hf={uniforms:{tDiffuse:{value:null},uTime:{value:0},uResolution:{value:new U(1,1)},uChroma:{value:.002},uPosterize:{value:0},uPulse:Q.uPulse,uAccent:Q.uAccentColor},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},gf=new mu(Uu),_f=new hu(Wu,Gu),vf=new _u(new U(1,1),Z[0].bloom,.26,.94),yf=new du(hf),bf=new xu,xf=new Cu;gf.addPass(_f),gf.addPass(vf),gf.addPass(yf),gf.addPass(bf),gf.addPass(xf);var Sf=new class{constructor(){this.context=null,this.master=null,this.active=!1,this.oscillators=[],this.noiseFilter=null,this.visualEnergy=0}async start(){this.context||this.create(),await this.context.resume(),this.active=!0;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(.075,e+.5)}stop(){if(!this.context)return;this.active=!1;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(0,e+.35)}create(){let e=window.AudioContext||window.webkitAudioContext;if(!e)throw Error(`Web Audio is unavailable`);this.context=new e,this.master=this.context.createGain(),this.master.gain.value=0;let t=this.context.createDynamicsCompressor();t.threshold.value=-22,t.knee.value=20,t.ratio.value=5,t.attack.value=.02,t.release.value=.5,this.master.connect(t).connect(this.context.destination);let n=this.context.createBiquadFilter();n.type=`lowpass`,n.frequency.value=680,n.Q.value=1.2,n.connect(this.master),this.droneFilter=n,[1,1.5,2.01].forEach((e,t)=>{let r=this.context.createOscillator(),i=this.context.createGain();r.type=t===0?`sine`:`triangle`,r.frequency.value=Z[0].note*e,i.gain.value=t===0?.42:.11,r.connect(i).connect(n),r.start(),this.oscillators.push({osc:r,gain:i,ratio:e})});let r=this.context.createBuffer(1,this.context.sampleRate*2,this.context.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e+=1)i[e]=Math.random()*2-1;let a=this.context.createBufferSource();a.buffer=r,a.loop=!0;let o=this.context.createBiquadFilter();o.type=`bandpass`,o.frequency.value=460,o.Q.value=2.2;let s=this.context.createGain();s.gain.value=.045,a.connect(o).connect(s).connect(this.master),a.start(),this.noiseFilter=o}update(e,t,n){if(!this.context)return;let r=this.context.currentTime;this.oscillators.forEach(({osc:n,ratio:i},a)=>{let o=Math.sin(t*(.17+a*.04)+a)*(2+a*1.5);n.frequency.setTargetAtTime(e.note*i+o,r,.18)}),this.droneFilter.frequency.setTargetAtTime(480+e.speed*320+n*840,r,.12),this.noiseFilter&&this.noiseFilter.frequency.setTargetAtTime(380+e.deform*240+n*520,r,.15),this.visualEnergy=this.active?.06+(Math.sin(t*2.35)*.5+.5)*.12+n*.18:0}ping(e=1,t=!1){if(!this.active||!this.context)return;let n=this.context.currentTime,r=this.context.createOscillator(),i=this.context.createGain(),a=this.context.createBiquadFilter();r.type=t?`square`:`sine`,r.frequency.setValueAtTime((t?420:220)+Math.random()*150,n),r.frequency.exponentialRampToValueAtTime(85+Math.random()*40,n+.42),a.type=`lowpass`,a.frequency.value=t?1500:900,i.gain.setValueAtTime(1e-4,n),i.gain.exponentialRampToValueAtTime(.055*e,n+.012),i.gain.exponentialRampToValueAtTime(1e-4,n+.46),r.connect(a).connect(i).connect(this.master),r.start(n),r.stop(n+.5)}},Cf={active:!1,stream:null,context:null,analyser:null,data:null,energy:0};async function wf(){if(!navigator.mediaDevices?.getUserMedia)throw Error(`该浏览器不支持麦克风输入`);let e=await navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!1,noiseSuppression:!1,autoGainControl:!1},video:!1}),t=new(window.AudioContext||window.webkitAudioContext);await t.resume();let n=t.createMediaStreamSource(e),r=t.createAnalyser();r.fftSize=256,r.smoothingTimeConstant=.78,n.connect(r),Cf.active=!0,Cf.stream=e,Cf.context=t,Cf.analyser=r,Cf.data=new Uint8Array(r.frequencyBinCount)}async function Tf(){Cf.active=!1,Cf.energy=0,Cf.stream?.getTracks().forEach(e=>e.stop()),Cf.context&&Cf.context.state!==`closed`&&await Cf.context.close(),Cf.stream=null,Cf.context=null,Cf.analyser=null,Cf.data=null}function Ef(){if(!Cf.active||!Cf.analyser||!Cf.data)return 0;Cf.analyser.getByteFrequencyData(Cf.data);let e=0,t=Math.min(30,Cf.data.length);for(let n=1;n<t;n+=1)e+=Cf.data[n];let n=zu((e/Math.max(1,t-1)-18)/105);return Cf.energy=Bu(Cf.energy,n,12,1/60),Cf.energy}var Df=0,Of=0,kf=0,Af=0,jf=0,Mf=0,Nf=!1,$=0,Pf=0,Ff=0,If=0,Lf=performance.now(),Rf=performance.now(),zf=0;function Bf(e,t=1300){Fu.textContent=e,Fu.classList.add(`is-visible`),clearTimeout(zf),zf=setTimeout(()=>Fu.classList.remove(`is-visible`),t)}function Vf(){Lf=performance.now(),Ku.autoRotate=!1}function Hf(e,t=!0){let n=Ot.clamp(Number(e),0,Z.length-1);Df=n,Of=n,kf=n;let r=Z[n];Au.textContent=`${r.zh} ${r.en}`,ju.textContent=r.material,Mu.textContent=`μ ${r.viscosity.toFixed(2)} · σ ${r.tension.toFixed(2)} · FLOW ${r.flow.toFixed(2)}`,Nu.textContent=r.noteZh,Tu(`.mode-btn`).forEach((e,t)=>{let r=t===n;e.classList.toggle(`is-active`,r),e.setAttribute(`aria-pressed`,String(r))}),document.documentElement.style.setProperty(`--accent`,r.accent),document.documentElement.style.setProperty(`--accent-2`,r.floor),Af=Math.max(Af,.45),jf=0,Vf(),Sf.ping(.72,n===3),t&&Bf(`PHASE ${String(n+1).padStart(2,`0`)} // ${r.zh} ${r.en}`)}function Uf(e=1){Af=Math.max(Af,e),jf=0,Q.uPulse.value=Af;let t=sd.getWorldPosition(new W);df.spawn(t,new W(0,1,0),e*.75,Math.round(28+e*20)),Sf.ping(1.15*e,Df===3),navigator.vibrate?.(Math.round(10+e*14)),Vf()}function Wf(e,t,n,r=1){Q.uRipples.value[If].set(e.x,e.y,e.z,Ff),If=(If+1)%Q.uRipples.value.length,Q.uPointerVelocity.value=Math.max(Q.uPointerVelocity.value,r*.7),mf(t,n,r),df.spawn(t,n,r,Math.round(24+r*18)),Af=Math.max(Af,.5*r),Sf.ping(.8+r*.35,Df===3),navigator.vibrate?.(12)}var Gf=new mo,Kf=new U,qf=new W(0,0,1),Jf=new W(0,0,1),Yf=0,Xf=0,Zf=0,Qf=new W,$f=new W,ep=new W(0,0,1),tp=!1,np=0,rp=!1,ip=null,ap=0,op={x:0,y:0,time:performance.now()},sp=0,cp=0;function lp(e){let t=Eu.getBoundingClientRect();Kf.x=(e.clientX-t.left)/t.width*2-1,Kf.y=-((e.clientY-t.top)/t.height)*2+1}function up(e){lp(e),Gf.setFromCamera(Kf,Gu);let t=Gf.intersectObject(Dd,!1);if(!t.length)return null;let n=t[0],r=sd.worldToLocal(n.point.clone()).normalize(),i=sd.getWorldPosition(new W),a=n.point.clone().sub(i).normalize();return{...n,localPoint:r,worldNormal:a}}function dp(e){Jf.copy(e.localPoint);let t=performance.now(),n=Math.max(8,t-op.time);if(ap=zu(Math.hypot(Kf.x-op.x,Kf.y-op.y)/n*420),op={x:Kf.x,y:Kf.y,time:t},rp&&tp){let t=e.localPoint.clone().sub(ep);t.addScaledVector(e.localPoint,-t.dot(e.localPoint));let n=Math.min(1.6,t.length()*26+ap*.32);t.lengthSq()>1e-7&&(t.normalize().multiplyScalar(n),$f.lerp(t,.74),np=Math.min(1.65,np+n*.12))}ep.copy(e.localPoint),tp=!0}Eu.addEventListener(`pointermove`,e=>{if(ip!==null&&e.pointerId!==ip)return;let t=up(e);t?(dp(t),Xf=Nf?.06:rp?1.36:.15,Eu.style.cursor=rp?`grabbing`:`crosshair`,rp&&performance.now()-sp>90&&(df.spawn(t.point,t.worldNormal,.25+ap*.35,5),sp=performance.now())):(Xf=Nf?0:rp?.78:0,Eu.style.cursor=rp?`grabbing`:`grab`)},{passive:!0}),Eu.addEventListener(`pointerdown`,e=>{let t=up(e);if(!t){Ku.enabled=!0,Vf();return}if(e.preventDefault(),ip=e.pointerId,Eu.setPointerCapture?.(e.pointerId),Nf){Ku.enabled=!0,qf.copy(t.localPoint),Jf.copy(t.localPoint),df.spawn(t.point,t.worldNormal,.42,14),Af=Math.max(Af,.46),Sf.ping(.68,!0),Vf();return}rp=!0,Eu.classList.add(`is-sculpting`),Ku.enabled=!1,tp=!1,$f.set(0,0,0),Qf.set(0,0,0),np=.18,dp(t),Xf=1.36,Wf(t.localPoint,t.point,t.worldNormal,.85+Z[Df].swell*.15),Vf()},{passive:!1});function fp(e){if(ip!==null&&e.pointerId!==ip)return;let t=rp;if(rp=!1,Eu.classList.remove(`is-sculpting`),Ku.enabled=!0,Xf=0,ip!==null&&Eu.releasePointerCapture?.(ip),ip=null,t){let e=Math.min(1.7,.35+np+ap*.45);Q.uReleasePoint.value.copy(qf),Q.uReleaseVector.value.copy(Qf.lengthSq()>1e-4?Qf:$f),Q.uReleaseTime.value=Ff,Q.uReleaseEnergy.value=e,$f.set(0,0,0),tp=!1,Af=Math.max(Af,.34+e*.18)}if(t&&Ru){let e=performance.now();e-cp<285&&pp(qf),cp=e}}Eu.addEventListener(`pointerup`,fp,{passive:!0}),Eu.addEventListener(`pointercancel`,fp,{passive:!0}),Eu.addEventListener(`pointerleave`,()=>{rp||(Xf=0)},{passive:!0});function pp(e=qf){if(Nf=!Nf,Pf=+!!Nf,Mf=+!!Nf,Af=Math.max(Af,1),Nf){let t=e.clone().normalize();Q.uFreezeOrigin.value.copy(t),Q.uFreezeTime.value=Ff,Td(t),Cd.visible=!0,vd.visible=!0,Pu.textContent=`CRYSTAL`,Pu.classList.add(`is-crystal`);let n=sd.localToWorld(t.multiplyScalar(1.64));df.spawn(n,n.clone().sub(sd.getWorldPosition(new W)).normalize(),1.05,54)}else Pu.textContent=`LIQUID`,Pu.classList.remove(`is-crystal`),Q.uReleasePoint.value.copy(Q.uFreezeOrigin.value),Q.uReleaseVector.value.copy(Q.uFreezeOrigin.value).cross(new W(.2,1,.3)).normalize(),Q.uReleaseTime.value=Ff,Q.uReleaseEnergy.value=1.15;Sf.ping(1.25,!0),Bf(Nf?`PHASE TRANSITION // 晶核扩散`:`PHASE TRANSITION // 晶格熔解`),Vf()}Eu.addEventListener(`dblclick`,e=>{e.preventDefault(),pp(up(e)?.localPoint||qf)}),window.addEventListener(`keydown`,e=>{e.target instanceof HTMLInputElement||e.target instanceof HTMLButtonElement||(e.code===`Space`?(e.preventDefault(),Uf(1)):/^Digit[1-4]$/.test(e.code)?Hf(Number(e.code.slice(-1))-1):e.key.toLowerCase()===`f`?gp():e.key.toLowerCase()===`m`&&wu(`#mic-toggle`).click())}),Tu(`.mode-btn`).forEach(e=>e.addEventListener(`click`,()=>Hf(e.dataset.mode))),wu(`#audio-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;try{Sf.active?(Sf.stop(),t.textContent=`声场 OFF`,t.setAttribute(`aria-pressed`,`false`),Bf(`GENERATIVE SOUND FIELD // OFF`)):(await Sf.start(),t.textContent=`声场 ON`,t.setAttribute(`aria-pressed`,`true`),Bf(`GENERATIVE SOUND FIELD // ON`),Uf(.55))}catch(e){Bf(`AUDIO ERROR // ${e.message}`)}}),wu(`#mic-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{Cf.active?(await Tf(),t.textContent=`MIC OFF`,t.setAttribute(`aria-pressed`,`false`),Bf(`MIC REACTIVITY // OFF`)):(await wf(),t.textContent=`MIC LIVE`,t.setAttribute(`aria-pressed`,`true`),Bf(`MIC REACTIVITY // LIVE`),Uf(.7))}catch(e){Bf(`MIC DENIED // ${e.message}`)}finally{t.disabled=!1}});function mp(e){Iu.hidden=!e,wu(`#panel-toggle`).setAttribute(`aria-expanded`,String(e))}wu(`#panel-toggle`).addEventListener(`click`,()=>mp(Iu.hidden)),wu(`#panel-close`).addEventListener(`click`,()=>mp(!1)),[[`deform`,`userDeform`,2],[`speed`,`userSpeed`,2],[`outline`,`outline`,2],[`bloom`,`bloom`,2],[`chroma`,`chroma`,2],[`flow`,`flow`,2],[`liveliness`,`liveliness`,2]].forEach(([e,t,n])=>{let r=wu(`#${e}`),i=wu(`#${e}-out`);r.addEventListener(`input`,()=>{Hu[t]=Number(r.value),i.value=Hu[t].toFixed(n),i.textContent=i.value,Vf()})}),wu(`#reset-params`).addEventListener(`click`,()=>{Object.entries({deform:1,speed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1}).forEach(([e,t])=>{let n=wu(`#${e}`);n.value=t,n.dispatchEvent(new Event(`input`))}),Bf(`MATERIAL PARAMETERS RESET`)}),Tu(`.quality`).forEach(e=>e.addEventListener(`click`,()=>hp(e.dataset.quality)));function hp(e){Hu.quality=e;let t=Math.min(window.devicePixelRatio||1,{high:1.5,medium:1.25,low:1}[e]);Uu.setPixelRatio(t),bf.enabled=e!==`low`,Uu.shadowMap.enabled=e!==`low`,nf.setDrawRange(0,e===`high`?Qd:e===`medium`?700:430),Tu(`.quality`).forEach(t=>t.classList.toggle(`is-active`,t.dataset.quality===e)),_p(),Bf(`RENDER QUALITY // ${e.toUpperCase()}`)}function gp(){document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.(),Vf()}wu(`#fullscreen`).addEventListener(`click`,gp),wu(`#capture`).addEventListener(`click`,()=>{Tp(),gf.render(),Eu.toBlob(e=>{if(!e){Bf(`CAPTURE FAILED`);return}let t=document.createElement(`a`);t.download=`mizu-kokoro-${Z[Df].en.toLowerCase()}-${Date.now()}.png`,t.href=URL.createObjectURL(e),t.click(),setTimeout(()=>URL.revokeObjectURL(t.href),1e3),Bf(`FRAME CAPTURED // PNG`)},`image/png`)});function _p(){let e=Math.max(1,window.innerWidth),t=Math.max(1,window.innerHeight);Gu.aspect=e/t,Gu.updateProjectionMatrix(),Uu.setSize(e,t,!1),gf.setSize(e,t);let n=Uu.getPixelRatio(),r={high:.82,medium:.66,low:.5}[Hu.quality]||.66,i=Math.max(1,Math.floor(e*n*r)),a=Math.max(1,Math.floor(t*n*r));Xu.setSize(i,a),Q.uResolution.value.set(i,a),yf.uniforms.uResolution.value.set(e*n,t*n)}window.addEventListener(`resize`,_p,{passive:!0});var vp=performance.now(),yp=0,bp=0,xp=!1;function Sp(e){let t=Z[Of],n=1-Math.exp(-e*3.4);Q.uDeepColor.value.lerp(t.deepColor,n),Q.uMidColor.value.lerp(t.midColor,n),Q.uLightColor.value.lerp(t.lightColor,n),Q.uAccentColor.value.lerp(t.accentColor,n),Q.uInkColor.value.lerp(t.inkColor,n),Wd.uColor.value.lerp(t.floorColor,n),Kd.uColor.value.lerp(t.backdropColor,n),Xd.uColor.value.lerp(t.backdropColor,n),rf.uColor.value.lerp(t.floorColor,n),df.uniforms.uColor.value.lerp(t.accentColor,n),sf.color.lerp(t.midColor,n),Ad.color.lerp(t.accentColor,n),zd.color.lerp(t.floorColor,n),Vd.color.lerp(t.floorColor,n),Fd.emissive.lerp(t.floorColor,n),Ld.uColor.value.lerp(t.floorColor,n),_d.color.lerp(t.lightColor,n),Sd.color.lerp(t.lightColor,n),Yd.forEach(e=>e.color.lerp(t.floorColor,n)),ff.forEach(e=>e.mesh.material.color.lerp(t.accentColor,n)),Ju.color.lerp(t.lightColor,n*.35),Yu.color.lerp(t.accentColor,n*.45)}function Cp(e){let t=Z[Of];$=Bu($,Pf,Nf?2.45:3.6,e),Math.abs($-Pf)<5e-4&&($=Pf),Q.uFreezeProgress.value=$,Q.uMode.value=Bu(Q.uMode.value,kf,3.2,e),Q.uDeform.value=Bu(Q.uDeform.value,t.deform*Hu.userDeform,4,e),Q.uTension.value=Bu(Q.uTension.value,t.tension,4.2,e),Q.uViscosity.value=Bu(Q.uViscosity.value,t.viscosity,4,e),Q.uSwell.value=Bu(Q.uSwell.value,t.swell,4,e),Q.uFlowStrength.value=Bu(Q.uFlowStrength.value,t.flow*Hu.flow,4,e),Q.uTurbulence.value=Bu(Q.uTurbulence.value,t.turbulence,4,e),Q.uFoam.value=Bu(Q.uFoam.value,t.foam,4,e),Q.uClarity.value=Bu(Q.uClarity.value,t.clarity,4,e),Q.uElasticity.value=Bu(Q.uElasticity.value,t.elasticity*Hu.liveliness,4,e),Q.uShear.value=Bu(Q.uShear.value,t.shear,4,e),Q.uRimStrength.value=Bu(Q.uRimStrength.value,t.rim,4,e),Q.uFacet.value=Bu(Q.uFacet.value,Mf*$,5,e),Q.uOutlineThickness.value=Bu(Q.uOutlineThickness.value,.046*Hu.outline,5,e);let n=.86+(1-t.clarity)*.075+(Df===3?.025:0);Q.uOpacity.value=Bu(Q.uOpacity.value,n,4,e);let r=Hu.quality===`low`?.72:1;vf.strength=Bu(vf.strength,(t.bloom+$*.24)*Hu.bloom*r,4,e),vf.radius=Bu(vf.radius,Df===3||$>.5?.16:.28,4,e),yf.uniforms.uChroma.value=Bu(yf.uniforms.uChroma.value,75e-5*(t.chroma+$*.42)*Hu.chroma,5,e),yf.uniforms.uPosterize.value=Bu(yf.uniforms.uPosterize.value,Math.min(.92,t.posterize+$*.08),4,e),Fd.emissiveIntensity=Bu(Fd.emissiveIntensity,.07+Af*.18+$*.08,4,e);let i=$>.002;gd.visible=i,vd.visible=i,Cd.visible=i&&Cd.userData.vertexCount>0,_d.opacity=$*(.16+Af*.08),Sd.opacity=$*(.54+Af*.22),xd.setDrawRange(0,Math.floor(Cd.userData.vertexCount*$)),Ad.opacity=.28*(1-$*.88)}function wp(e){let t=Z[Df],n=1-$*.88;kd.rotation.y+=e*(.19+t.speed*.12)*n,kd.rotation.x=Math.sin(Ff*.21)*.14*n,jd.rotation.x+=e*.23*n,jd.rotation.y-=e*.31*n,jd.scale.setScalar(1+Af*.07+Q.uAudio.value*.08),vd.rotation.y-=e*.08*$,vd.rotation.x=Math.sin(Ff*.16)*.08*$,yd.forEach((t,n)=>{let r=.82+Math.sin(Ff*.9+t.userData.phase+n*.17)*.12,i=$*r;t.scale.copy(t.userData.baseScale).multiplyScalar(i),t.rotation.y+=e*(.018+n*8e-4)*$}),sd.rotation.y+=e*Ot.lerp(.028,.006,$),sd.rotation.x=Math.sin(Ff*.19)*Ot.lerp(.027,.006,$);let r=Ot.lerp(.048,.015,$),i=Math.sin(Ff*.72)*(Lu?.012:r);sd.position.y=.48+i,Jd.rotation.y+=e*.045,Jd.rotation.z=Math.sin(Ff*.12)*.08,Jd.children.forEach((t,n)=>{t.rotation.z+=e*(.025+n*.013)*(n%2?-1:1),t.material.opacity=.13-n*.02+Af*.1+Q.uAudio.value*.12+$*.04});let a=(.34+t.flow*.78)*(1-t.viscosity*.32);sf.opacity=Ot.lerp(.72,.42,$),uf.forEach((e,n)=>{let r=e.phase+Ff*e.speed*a,i=Math.sin(Ff*(.52+t.turbulence*.46)+e.phase)*(.08+t.swell*.1);e.mesh.position.set(Math.cos(r)*(e.radius+i),.45+Math.sin(r*(1.45+t.swell*.35)+e.phase)*e.yAmp,Math.sin(r)*e.radius*(.55+e.tilt*.15)),e.mesh.rotation.set(r*.7,r*1.3+n,r*.35);let o=1+Q.uAudio.value*(.18+n%4*.04),s=e.scale*o,c=1+t.viscosity*1.35+t.swell*.22,l=1+t.swell*.24;e.mesh.scale.set(s/l,s*c,s/l)}),Rd.rotation.z+=e*(.012+t.flow*.018)*(1-$*.72),ff.forEach(n=>{if(n.life<=0)return;let r=Ot.lerp(1.35,.62,t.viscosity);n.life=Math.max(0,n.life-e*r);let i=1-n.life,a=3.1+t.tension*.72+t.swell*.55,o=Ot.lerp(.08,a*n.intensity,1-(1-i)**2);n.mesh.scale.setScalar(o),n.mesh.material.opacity=n.life*n.life*(.72+t.tension*.12),n.life===0&&(n.mesh.visible=!1)}),df.update(e)}function Tp(){let e=sd.visible;sd.visible=!1,Uu.setRenderTarget(Xu),Uu.clear(),Uu.render(Wu,Gu),Uu.setRenderTarget(null),sd.visible=e}function Ep(){let e=new W;Gu.getWorldDirection(e),qd.position.copy(Ku.target).addScaledVector(e,4.2),qd.quaternion.copy(Gu.quaternion),Zd.quaternion.copy(Gu.quaternion),Zd.position.copy(Ku.target).addScaledVector(e,.25)}function Dp(){let e=performance.now(),t=e-Lf;t>15e3&&(Ku.autoRotate=!0,Xf=Nf?0:.1,Jf.set(Math.sin(Ff*.27),Math.sin(Ff*.19+1.4)*.65,Math.cos(Ff*.27)).normalize()),t>3e4&&e-Rf>17e3&&(Hf((Df+1)%Z.length,!1),Rf=e,Lf=e-2e4)}function Op(e=performance.now()){requestAnimationFrame(Op);let t=Math.min(Math.max((e-vp)/1e3,0),.05);vp=e;let n=Z[Df],r=Lu?.34:1;Ff+=t*n.speed*Hu.userSpeed*r,Q.uTime.value=Ff,yf.uniforms.uTime.value=Ff,Dp(),Sp(t),Cp(t);let i=rp?Ot.lerp(20,8,n.viscosity):6.5;qf.lerp(Jf,1-Math.exp(-t*i)),qf.normalize(),Q.uTouchPoint.value.copy(qf);let a=rp?185:42*n.recovery*Math.max(.25,Hu.liveliness),o=rp?.92:Ot.clamp((.24+n.viscosity*1.02)/Math.sqrt(Math.max(.22,n.elasticity*Hu.liveliness)),.18,1.42),s=2*Math.sqrt(a)*o,c=(Xf-Yf)*a-Zf*s;if(Zf+=c*t,Yf=Ot.clamp(Yf+Zf*t,-.52,1.46),$>.72&&(Yf*=Math.exp(-t*10),Zf*=Math.exp(-t*10)),Q.uTouchStrength.value=Yf,!rp){let e=Ot.lerp(10.5,2,n.viscosity);$f.multiplyScalar(Math.exp(-t*e))}let l=Ot.lerp(18,5.2,n.viscosity);Qf.lerp($f,1-Math.exp(-t*l)),$>.35&&Qf.multiplyScalar(Math.exp(-t*8*$)),Q.uDragVector.value.copy(Qf).multiplyScalar(Hu.liveliness),ap=Bu(ap,0,7,t),Q.uPointerVelocity.value=Bu(Q.uPointerVelocity.value,ap,12,t),Af=Bu(Af,jf,3.3,t),Q.uPulse.value=Af,Sf.update(n,Ff,Af);let u=Ef(),d=Cf.active?u:Sf.visualEnergy;Q.uAudio.value=Bu(Q.uAudio.value,d,Cf.active?11:5,t),Yu.intensity=20+Af*15+Q.uAudio.value*18+$*8,Ju.intensity=48+Af*18+$*7,Bd.scale.setScalar(1+Af*.04+Q.uAudio.value*.025+$*.018),zd.opacity=.55+Af*.35+Q.uAudio.value*.25+$*.08,wp(t),Ku.update(t),Ep(),Tp(),gf.render(t),yp+=t,bp+=1,yp>=.5&&(Ou.textContent=`${Math.round(bp/yp)} FPS`,yp=0,bp=0,performance.now()),xp||(xp=!0,setTimeout(()=>Du.classList.add(`is-hidden`),280))}hp(Hu.quality),Hf(0,!1),_p(),Op();
//# sourceMappingURL=index-CR_YyWXx.js.map