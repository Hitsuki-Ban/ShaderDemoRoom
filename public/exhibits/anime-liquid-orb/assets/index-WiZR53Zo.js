...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},wu=class extends cu{constructor(){super(),this.isOutputPass=!0,this.uniforms=aa.clone(Cu.uniforms),this.material=new la({name:Cu.name,uniforms:this.uniforms,vertexShader:Cu.vertexShader,fragmentShader:Cu.fragmentShader}),this._fsQuad=new du(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},G.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Tu=e=>document.querySelector(e),Eu=e=>[...document.querySelectorAll(e)],Du=Tu(`#scene`),Ou=Tu(`#loading`),ku=Tu(`#fps`),Au=Tu(`#pipeline`),ju=Tu(`#state-name`),Mu=Tu(`#material-type`),Nu=Tu(`#material-metrics`),Pu=Tu(`#material-note`),Fu=Tu(`#matter-state`),Iu=Tu(`#toast`),Lu=Tu(`#lab-panel`),Ru=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,zu=window.matchMedia(`(pointer: coarse)`).matches,Bu=e=>kt.clamp(e,0,1),Vu=(e,t,n,r)=>kt.damp(e,t,n,r),Hu=e=>new K(e),Uu=`shader-demo-room`,Wu=1,Gu=Object.freeze([`pause`,`stats`,`set-mode`,`set-quality`]),Ku=window.parent===window?null:Object.freeze({instanceId:crypto.randomUUID(),targetOrigin:location.origin});function qu(e){return typeof e==`object`&&!!e&&!Array.isArray(e)&&Object.getPrototypeOf(e)===Object.prototype}function Ju(e,t){if(!qu(e))return!1;let n=Object.keys(e).sort(),r=[...t].sort();return n.length===r.length&&n.every((e,t)=>e===r[t])}function Yu(e,t){Ku&&window.parent.postMessage({context:Uu,v:Wu,instanceId:Ku.instanceId,type:e,payload:t},Ku.targetOrigin)}function Xu(e,t){if(e===`set-paused`){if(!Ju(t,[`paused`])||typeof t.paused!=`boolean`)throw Error(`Invalid set-paused payload`);return}if(e===`set-orb-mode`){if(!Ju(t,[`mode`])||!Number.isInteger(t.mode)||t.mode<0||t.mode>3)throw Error(`Invalid set-orb-mode payload`);return}if(e===`set-orb-quality`){if(!Ju(t,[`quality`])||![`high`,`medium`,`low`].includes(t.quality))throw Error(`Invalid set-orb-quality payload`);return}throw Error(`Unknown embedded command: ${String(e)}`)}function Zu(e){if(!Ku||e.origin!==location.origin||e.source!==window.parent)return;let t=e.data;if(!Ju(t,[`context`,`v`,`instanceId`,`type`,`payload`]))throw Error(`Invalid embedded command envelope`);if(t.context!==Uu||t.v!==Wu)throw Error(`Embedded command envelope does not match this runtime`);if(t.instanceId===Ku.instanceId){if(typeof t.type!=`string`)throw Error(`Embedded command type must be a string`);Xu(t.type,t.payload),t.type===`set-paused`?Yp(t.payload.paused):t.type===`set-orb-mode`?ep(t.payload.mode):t.type===`set-orb-quality`&&Dp(t.payload.quality)}}var X=[{zh:`静水`,en:`CALM`,material:`AQUEOUS / WATER`,deep:`#031522`,mid:`#14c8ef`,light:`#efffff`,accent:`#68f2ff`,ink:`#01070d`,floor:`#48ebff`,backdrop:`#0f708c`,deform:.78,speed:.78,bloom:.46,chroma:.25,posterize:0,rim:1.02,viscosity:.16,tension:.92,swell:.18,flow:.35,turbulence:.18,foam:.08,clarity:.94,elasticity:1.08,recovery:1.22,shear:.72,note:55,noteZh:`高表面张力、清澈折射与短促毛细波。`},{zh:`涨潮`,en:`SURGE`,material:`OCEANIC / BREAKER`,deep:`#1b0923`,mid:`#ec3b9b`,light:`#fff7df`,accent:`#ffb72f`,ink:`#10030d`,floor:`#ff56ba`,backdrop:`#8b2859`,deform:1.34,speed:1.16,bloom:.72,chroma:.72,posterize:0,rim:1.17,viscosity:.07,tension:.54,swell:1,flow:1.2,turbulence:.92,foam:1,clarity:.62,elasticity:.82,recovery:.92,shear:1.22,note:65.41,noteZh:`低黏度大惯性浪涌，陡峭波峰与破碎泡沫。`},{zh:`绽生`,en:`BLOOM`,material:`VISCOUS / PROTOPLASM`,deep:`#061b19`,mid:`#35dea8`,light:`#f4ffed`,accent:`#b2ff4d`,ink:`#02100d`,floor:`#63ffc3`,backdrop:`#1b826b`,deform:1.12,speed:.72,bloom:.6,chroma:.42,posterize:0,rim:1.1,viscosity:.9,tension:.7,swell:.34,flow:.76,turbulence:.28,foam:.12,clarity:.48,elasticity:.38,recovery:.34,shear:1.52,note:73.42,noteZh:`高黏度活体胶质，形变滞留并拉出缓慢流丝。`},{zh:`零界`,en:`VOID`,material:`METALLIC / SUPERCOOLED`,deep:`#010204`,mid:`#9eabb5`,light:`#ffffff`,accent:`#ff3a52`,ink:`#000000`,floor:`#e4fbff`,backdrop:`#677984`,deform:.68,speed:.6,bloom:.39,chroma:1.08,posterize:.72,rim:1.42,viscosity:.24,tension:1.24,swell:.08,flow:.16,turbulence:.12,foam:0,clarity:.72,elasticity:1.34,recovery:1.48,shear:.58,note:41.2,noteZh:`超冷却金属水体，流动稀少、回弹尖锐并带离散扫描。`}].map(e=>({...e,deepColor:Hu(e.deep),midColor:Hu(e.mid),lightColor:Hu(e.light),accentColor:Hu(e.accent),inkColor:Hu(e.ink),floorColor:Hu(e.floor),backdropColor:Hu(e.backdrop)})),Qu={userDeform:1,userSpeed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1,quality:zu?`medium`:`high`},$u;try{$u=new Ll({canvas:Du,antialias:!1,alpha:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!0})}catch(e){throw Ou.innerHTML=`<p>WEBGL INITIALIZATION FAILED<br>${String(e.message||e)}</p>`,e}$u.setClearColor(198157,1),$u.outputColorSpace=Be,$u.toneMapping=4,$u.toneMappingExposure=.86,$u.shadowMap.enabled=!0,$u.shadowMap.type=1,$u.debug.checkShaderErrors=!0,Au.textContent=$u.capabilities.isWebGL2?`WEBGL2 / GLSL`:`WEBGL / GLSL`;var ed=new In;ed.background=new K(198157),ed.fog=new Fn(198157,.042);var td=new Ua(42,1,.05,80);td.position.set(0,1.05,8.1);var nd=new Jl(td,Du);nd.target.set(0,.42,0),nd.enableDamping=!0,nd.dampingFactor=.055,nd.enablePan=!1,nd.minDistance=5.2,nd.maxDistance=10.2,nd.minPolarAngle=.72,nd.maxPolarAngle=1.72,nd.minAzimuthAngle=-1,nd.maxAzimuthAngle=1,nd.autoRotate=!1,nd.autoRotateSpeed=.35,nd.update();var rd=Object.freeze({default:Object.freeze({fov:42,targetY:.42,offsetY:.63,positionZ:8.1}),portrait:Object.freeze({fov:42,targetY:.05,offsetY:.62,positionZ:10.18}),compact:Object.freeze({fov:58,targetY:-.65,offsetY:.54,positionZ:10.18})}),id=``;function ad(e,t){let n=e<=420?t<=520?`compact`:`portrait`:`default`;if(n===id)return;let r=rd[n],i=Math.hypot(r.offsetY,r.positionZ);if(i<nd.minDistance||i>nd.maxDistance)throw Error(`Orb ${n} camera frame violates OrbitControls distance limits.`);td.fov=r.fov,td.position.set(0,r.targetY+r.offsetY,r.positionZ),nd.target.set(0,r.targetY,0),nd.update(),id=n}var od=new ja(10415871,1180687,.72);ed.add(od);var sd=new Ga(14285823,52,24,Math.PI/5.5,.7,1.5);sd.position.set(-4.5,7,5.4),sd.target.position.set(0,0,0),sd.castShadow=!0,sd.shadow.mapSize.set(1024,1024),sd.shadow.bias=-2e-4,ed.add(sd,sd.target);var cd=new qa(16732120,22,16,2);cd.position.set(4.2,1.8,-2.2),ed.add(cd);var ld=new Yt(1,1,{depthBuffer:!0,stencilBuffer:!1,minFilter:c,magFilter:c});ld.texture.name=`MIZU_REFRACTION_BUFFER`,ld.texture.generateMipmaps=!1;var ud=`
...
`,bd=new Dn;bd.position.y=.48,ed.add(bd);var xd=new qi(1.65,5),Sd=new ca({uniforms:Z,vertexShader:fd,fragmentShader:pd,transparent:!0,depthWrite:!1,side:0});Sd.extensions.derivatives=!0;var Cd=new ca({uniforms:Z,vertexShader:md,fragmentShader:hd,transparent:!0,depthWrite:!1,side:1}),wd=new Qr(xd,Sd);wd.renderOrder=3,bd.add(wd);var Td=new Qr(xd,Cd);Td.renderOrder=2,bd.add(Td);var Ed=new Qr(xd,new ca({uniforms:Z,vertexShader:gd,fragmentShader:_d,transparent:!0,depthWrite:!1,side:1}));Ed.scale.setScalar(.985),Ed.renderOrder=1,bd.add(Ed);var Dd=new qi(1.69,2),Od=new ca({uniforms:Z,vertexShader:vd,fragmentShader:yd,transparent:!0,depthWrite:!1,side:0});Od.extensions.derivatives=!0;var kd=new Qr(Dd,Od);kd.renderOrder=4,bd.add(kd);var Ad=new Br({color:X[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),jd=new Dn,Md=[],Nd=new Ji(.18,0);for(let e=0;e<22;e+=1){let e=new Qr(Nd,Ad),t=new U(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1).normalize(),n=.18+Math.random()**.72*1.25;e.position.copy(t).multiplyScalar(n),e.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);let r=.22+Math.random()*.48,i=.72+Math.random()*1.75;e.scale.set(r,i,r*(.66+Math.random()*.55)),e.userData.baseScale=e.scale.clone(),e.userData.phase=Math.random()*Math.PI*2,jd.add(e),Md.push(e)}jd.visible=!1,jd.renderOrder=1,bd.add(jd);var Pd=new kr;Pd.setAttribute(`position`,new q([],3));var Fd=new yi({color:X[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),Id=new ji(Pd,Fd);Id.renderOrder=3,Id.visible=!1,Id.userData.vertexCount=0,bd.add(Id);function Ld(e){return function(){let t=e+=1831565813;return t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296}}function Rd(e){let t=e.clone().normalize(),n=Ld(Math.abs(Math.floor((t.x*1731+t.y*3191+t.z*7919)*1e4))+17),r=new U().crossVectors(t,Math.abs(t.y)<.92?new U(0,1,0):new U(1,0,0)).normalize(),i=new U().crossVectors(t,r).normalize(),a=[],o=(e,o,s,c,l=.22)=>{let u=e.clone(),d=o.clone().normalize();for(let e=0;e<s;e+=1){let e=r.clone().multiplyScalar((n()-.5)*2).addScaledVector(i,(n()-.5)*2).addScaledVector(t,(n()-.5)*.45).normalize(),o=u.clone().normalize().multiplyScalar(-.19);d.multiplyScalar(.78).addScaledVector(e,l).add(o).normalize();let s=u.clone().addScaledVector(d,c*(.78+n()*.46));s.length()>1.57&&s.normalize().multiplyScalar(1.55),a.push(u.x,u.y,u.z,s.x,s.y,s.z),u=s}};for(let e=0;e<12;e+=1){let e=(n()-.5)*.82,a=(n()-.5)*.82,s=t.clone().multiplyScalar(1.57).addScaledVector(r,e*.08).addScaledVector(i,a*.08),c=t.clone().multiplyScalar(-.76-n()*.22).addScaledVector(r,e).addScaledVector(i,a).normalize();o(s,c,8+Math.floor(n()*6),.13,.2),o(s.clone().addScaledVector(c,.42+n()*.3),c.clone().addScaledVector(r,(n()-.5)*1).addScaledVector(i,(n()-.5)*1).normalize(),3+Math.floor(n()*4),.105,.32)}Pd.setAttribute(`position`,new q(a,3)),Pd.computeBoundingSphere(),Id.userData.vertexCount=a.length/3,Pd.setDrawRange(0,0)}var zd=new Br({transparent:!0,opacity:0,depthWrite:!1});zd.colorWrite=!1;var Bd=new Qr(new Zi(1.76,28,20),zd);Bd.renderOrder=-10,bd.add(Bd);var Vd=new ca({uniforms:{uTime:Z.uTime,uAudio:Z.uAudio,uPulse:Z.uPulse,uMode:Z.uMode,uFreezeProgress:Z.uFreezeProgress,uMidColor:Z.uMidColor,uLightColor:Z.uLightColor,uAccentColor:Z.uAccentColor},vertexShader:`
  ...
  `,transparent:!0,depthWrite:!1,blending:2,side:2}),Hd=new Qr(new qi(1.02,4),Vd);Hd.renderOrder=1,bd.add(Hd);var Ud=new Br({color:X[0].accentColor,transparent:!0,opacity:.28,depthWrite:!1,blending:2}),Wd=new Qr(new $i(.57,.055,220,18,2,3),Ud);Wd.renderOrder=1,bd.add(Wd);var Gd=new Dn;ed.add(Gd);var Kd=new ua({color:462874,roughness:.24,metalness:.82}),qd=new Qr(new Gi(2.22,2.48,.34,96,1),Kd);qd.position.y=-1.32,qd.receiveShadow=!0,qd.castShadow=!0,Gd.add(qd);var Jd=new ua({color:727332,roughness:.12,metalness:.88,emissive:X[0].floorColor.clone(),emissiveIntensity:.08}),Yd=new Qr(new Gi(1.82,1.88,.065,96),Jd);Yd.position.y=-1.12,Yd.receiveShadow=!0,Gd.add(Yd);var Xd={uTime:Z.uTime,uMode:Z.uMode,uFlowStrength:Z.uFlowStrength,uTurbulence:Z.uTurbulence,uFoam:Z.uFoam,uFreezeProgress:Z.uFreezeProgress,uColor:{value:X[0].floorColor.clone()},uLightColor:Z.uLightColor},Zd=new Qr(new Wi(1.79,128),new ca({uniforms:Xd,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));Zd.rotation.x=-Math.PI/2,Zd.position.y=-1.078,Zd.renderOrder=2,Gd.add(Zd);var Qd=new Br({color:X[0].floorColor,transparent:!0,opacity:.72,depthWrite:!1,blending:2}),$d=new Qr(new Qi(1.96,.018,8,192),Qd);$d.rotation.x=Math.PI/2,$d.position.y=-1.075,Gd.add($d);var ef=new Br({color:X[0].floorColor,transparent:!0,opacity:.3}),tf=new ui(new Ui(.025,.012,.16),ef,48),nf=new En;for(let e=0;e<48;e+=1){let t=e/48*Math.PI*2;nf.position.set(Math.cos(t)*2.28,-1.105,Math.sin(t)*2.28),nf.rotation.y=-t,nf.scale.z=e%4==0?1.7:.65,nf.updateMatrix(),tf.setMatrixAt(e,nf.matrix)}Gd.add(tf);var rf={uTime:Z.uTime,uPulse:Z.uPulse,uAudio:Z.uAudio,uColor:{value:X[0].floorColor.clone()}},af=new Qr(new Yi(32,32,1,1),new ca({uniforms:rf,vertexShader:`
      varying vec2 vWorld;
      void main() {
        vec4 world = modelMatrix * vec4(position, 1.0);
        vWorld = world.xz;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));af.rotation.x=-Math.PI/2,af.position.y=-1.5,ed.add(af);var of={uTime:Z.uTime,uPulse:Z.uPulse,uAudio:Z.uAudio,uColor:{value:X[0].backdropColor.clone()},uAccent:Z.uAccentColor},sf=new Qr(new Wi(4.25,192),new ca({uniforms:of,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));sf.renderOrder=-2,ed.add(sf);var cf=new Dn;ed.add(cf);var lf=[];for(let e=0;e<3;e+=1){let t=new Br({color:X[0].floorColor,transparent:!0,opacity:.18-e*.035,depthWrite:!1,blending:2});lf.push(t);let n=new Qr(new Qi(2.4+e*.42,.009+e*.002,6,256),t);n.rotation.set(Math.PI*(.18+e*.21),e*.75,e*.45),n.position.y=.42,cf.add(n)}var uf={uTime:Z.uTime,uPulse:Z.uPulse,uColor:{value:X[0].backdropColor.clone()}},df=new Dn;ed.add(df);for(let e=0;e<7;e+=1){let t=new Qr(new Yi(.08+e%3*.05,7.5),new ca({uniforms:uf,vertexShader:`
        varying vec2 vUv2;
      ...
      `,transparent:!0,depthWrite:!1,blending:2,side:2}));t.position.set((e-3)*1.18+e%2*.28,1.35+e%2*.2,-4.1-Math.abs(e-3)*.08),df.add(t)}var ff=950,pf=new Float32Array(ff*3),mf=new Float32Array(ff),hf=new Float32Array(ff);for(let e=0;e<ff;e+=1){let t=4+Math.random()*8.5,n=Math.random()*Math.PI*2;pf[e*3]=Math.cos(n)*t,pf[e*3+1]=-3.6+Math.random()*10.2,pf[e*3+2]=Math.sin(n)*t*.72-1.5,mf[e]=Math.random(),hf[e]=Math.random()*Math.PI*2}var gf=new kr;gf.setAttribute(`position`,new hr(pf,3)),gf.setAttribute(`aScale`,new hr(mf,1)),gf.setAttribute(`aPhase`,new hr(hf,1));var _f={uTime:Z.uTime,uAudio:Z.uAudio,uColor:{value:X[0].floorColor.clone()}},vf=new Li(gf,new ca({uniforms:_f,vertexShader:`
      uniform float uTime;
      uniform float uAudio;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));ed.add(vf);var yf=new ti(new Uint8Array([35,145,255]),3,1,k);yf.needsUpdate=!0,yf.minFilter=a,yf.magFilter=a;var bf=new da({color:X[0].midColor,gradientMap:yf,transparent:!0,opacity:.66}),xf=new qi(.13,2),Sf=new Dn;ed.add(Sf);var Cf=[];for(let e=0;e<16;e+=1){let e=new Qr(xf,bf),t=.45+Math.random()*1.2;e.scale.setScalar(t),Sf.add(e),Cf.push({mesh:e,radius:2.2+Math.random()*2.7,phase:Math.random()*Math.PI*2,speed:(.08+Math.random()*.12)*(Math.random()>.5?1:-1),yAmp:.35+Math.random()*1.5,tilt:-.35+Math.random()*.7,scale:t})}var wf=new class{constructor(e=320){this.max=e,this.cursor=0,this.positions=new Float32Array(e*3),this.velocities=new Float32Array(e*3),this.life=new Float32Array(e),this.size=new Float32Array(e);for(let t=0;t<e;t+=1)this.positions[t*3+1]=-999;this.geometry=new kr,this.geometry.setAttribute(`position`,new hr(this.positions,3)),this.geometry.setAttribute(`aLife`,new hr(this.life,1)),this.geometry.setAttribute(`aSize`,new hr(this.size,1)),this.uniforms={uColor:{value:X[0].accentColor.clone()}},this.points=new Li(this.geometry,new ca({uniforms:this.uniforms,vertexShader:`
  ...
  `},kf=new hu($u),Af=new gu(ed,td),jf=new vu(new H(1,1),X[0].bloom,.26,.94),Mf=new fu(Of),Nf=new Su,Pf=new wu;kf.addPass(Af),kf.addPass(jf),kf.addPass(Mf),kf.addPass(Nf),kf.addPass(Pf);var Ff=new class{constructor(){this.context=null,this.master=null,this.active=!1,this.oscillators=[],this.noiseFilter=null,this.visualEnergy=0}async start(){this.context||this.create(),await this.context.resume(),this.active=!0;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(.075,e+.5),Bp&&Kp()}stop(){if(!this.context)return;this.active=!1;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(0,e+.35)}create(){let e=window.AudioContext||window.webkitAudioContext;if(!e)throw Error(`Web Audio is unavailable`);this.context=new e,this.master=this.context.createGain(),this.master.gain.value=0;let t=this.context.createDynamicsCompressor();t.threshold.value=-22,t.knee.value=20,t.ratio.value=5,t.attack.value=.02,t.release.value=.5,this.master.connect(t).connect(this.context.destination);let n=this.context.createBiquadFilter();n.type=`lowpass`,n.frequency.value=680,n.Q.value=1.2,n.connect(this.master),this.droneFilter=n,[1,1.5,2.01].forEach((e,t)=>{let r=this.context.createOscillator(),i=this.context.createGain();r.type=t===0?`sine`:`triangle`,r.frequency.value=X[0].note*e,i.gain.value=t===0?.42:.11,r.connect(i).connect(n),r.start(),this.oscillators.push({osc:r,gain:i,ratio:e})});let r=this.context.createBuffer(1,this.context.sampleRate*2,this.context.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e+=1)i[e]=Math.random()*2-1;let a=this.context.createBufferSource();a.buffer=r,a.loop=!0;let o=this.context.createBiquadFilter();o.type=`bandpass`,o.frequency.value=460,o.Q.value=2.2;let s=this.context.createGain();s.gain.value=.045,a.connect(o).connect(s).connect(this.master),a.start(),this.noiseFilter=o}update(e,t,n){if(!this.context)return;let r=this.context.currentTime;this.oscillators.forEach(({osc:n,ratio:i},a)=>{let o=Math.sin(t*(.17+a*.04)+a)*(2+a*1.5);n.frequency.setTargetAtTime(e.note*i+o,r,.18)}),this.droneFilter.frequency.setTargetAtTime(480+e.speed*320+n*840,r,.12),this.noiseFilter&&this.noiseFilter.frequency.setTargetAtTime(380+e.deform*240+n*520,r,.15),this.visualEnergy=this.active?.06+(Math.sin(t*2.35)*.5+.5)*.12+n*.18:0}ping(e=1,t=!1){if(!this.active||!this.context)return;let n=this.context.currentTime,r=this.context.createOscillator(),i=this.context.createGain(),a=this.context.createBiquadFilter();r.type=t?`square`:`sine`,r.frequency.setValueAtTime((t?420:220)+Math.random()*150,n),r.frequency.exponentialRampToValueAtTime(85+Math.random()*40,n+.42),a.type=`lowpass`,a.frequency.value=t?1500:900,i.gain.setValueAtTime(1e-4,n),i.gain.exponentialRampToValueAtTime(.055*e,n+.012),i.gain.exponentialRampToValueAtTime(1e-4,n+.46),r.connect(a).connect(i).connect(this.master),r.start(n),r.stop(n+.5)}},Q={active:!1,stream:null,context:null,analyser:null,data:null,energy:0};async function If(){if(!navigator.mediaDevices?.getUserMedia)throw Error(`该浏览器不支持麦克风输入`);let e=await navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!1,noiseSuppression:!1,autoGainControl:!1},video:!1}),t=new(window.AudioContext||window.webkitAudioContext);await t.resume();let n=t.createMediaStreamSource(e),r=t.createAnalyser();r.fftSize=256,r.smoothingTimeConstant=.78,n.connect(r),Q.active=!0,Q.stream=e,Q.context=t,Q.analyser=r,Q.data=new Uint8Array(r.frequencyBinCount),Bp&&Kp()}async function Lf(){Q.active=!1,Q.energy=0,Q.stream?.getTracks().forEach(e=>e.stop()),Q.context&&Q.context.state!==`closed`&&await Q.context.close(),Q.stream=null,Q.context=null,Q.analyser=null,Q.data=null}function Rf(){if(!Q.active||!Q.analyser||!Q.data)return 0;Q.analyser.getByteFrequencyData(Q.data);let e=0,t=Math.min(30,Q.data.length);for(let n=1;n<t;n+=1)e+=Q.data[n];let n=Bu((e/Math.max(1,t-1)-18)/105);return Q.energy=Vu(Q.energy,n,12,1/60),Q.energy}var zf=0,Bf=0,Vf=0,Hf=0,Uf=0,Wf=0,Gf=!1,$=0,Kf=0,qf=0,Jf=0,Yf=performance.now(),Xf=performance.now(),Zf=0;function Qf(e,t=1300){Iu.textContent=e,Iu.classList.add(`is-visible`),clearTimeout(Zf),Zf=setTimeout(()=>Iu.classList.remove(`is-visible`),t)}function $f(){Yf=performance.now(),nd.autoRotate=!1}function ep(e,t=!0){let n=kt.clamp(Number(e),0,X.length-1);zf=n,Bf=n,Vf=n;let r=X[n];ju.textContent=`${r.zh} ${r.en}`,Mu.textContent=r.material,Nu.textContent=`μ ${r.viscosity.toFixed(2)} · σ ${r.tension.toFixed(2)} · FLOW ${r.flow.toFixed(2)}`,Pu.textContent=r.noteZh,Eu(`.mode-btn`).forEach((e,t)=>{let r=t===n;e.classList.toggle(`is-active`,r),e.setAttribute(`aria-pressed`,String(r))}),document.documentElement.style.setProperty(`--accent`,r.accent),document.documentElement.style.setProperty(`--accent-2`,r.floor),Hf=Math.max(Hf,.45),Uf=0,$f(),Ff.ping(.72,n===3),t&&Qf(`PHASE ${String(n+1).padStart(2,`0`)} // ${r.zh} ${r.en}`)}function tp(e=1){Hf=Math.max(Hf,e),Uf=0,Z.uPulse.value=Hf;let t=bd.getWorldPosition(new U);wf.spawn(t,new U(0,1,0),e*.75,Math.round(28+e*20)),Ff.ping(1.15*e,zf===3),navigator.vibrate?.(Math.round(10+e*14)),$f()}function np(e,t,n,r=1){Z.uRipples.value[Jf].set(e.x,e.y,e.z,qf),Jf=(Jf+1)%Z.uRipples.value.length,Z.uPointerVelocity.value=Math.max(Z.uPointerVelocity.value,r*.7),Df(t,n,r),wf.spawn(t,n,r,Math.round(24+r*18)),Hf=Math.max(Hf,.5*r),Ff.ping(.8+r*.35,zf===3),navigator.vibrate?.(12)}var rp=new ho,ip=new H,ap=new U(0,0,1),op=new U(0,0,1),sp=0,cp=0,lp=0,up=new U,dp=new U,fp=new U(0,0,1),pp=!1,mp=0,hp=!1,gp=null,_p=0,vp={x:0,y:0,time:performance.now()},yp=0,bp=0;function xp(e){let t=Du.getBoundingClientRect();ip.x=(e.clientX-t.left)/t.width*2-1,ip.y=-((e.clientY-t.top)/t.height)*2+1}function Sp(e){xp(e),rp.setFromCamera(ip,td);let t=rp.intersectObject(Bd,!1);if(!t.length)return null;let n=t[0],r=bd.worldToLocal(n.point.clone()).normalize(),i=bd.getWorldPosition(new U),a=n.point.clone().sub(i).normalize();return{...n,localPoint:r,worldNormal:a}}function Cp(e){op.copy(e.localPoint);let t=performance.now(),n=Math.max(8,t-vp.time);if(_p=Bu(Math.hypot(ip.x-vp.x,ip.y-vp.y)/n*420),vp={x:ip.x,y:ip.y,time:t},hp&&pp){let t=e.localPoint.clone().sub(fp);t.addScaledVector(e.localPoint,-t.dot(e.localPoint));let n=Math.min(1.6,t.length()*26+_p*.32);t.lengthSq()>1e-7&&(t.normalize().multiplyScalar(n),dp.lerp(t,.74),mp=Math.min(1.65,mp+n*.12))}fp.copy(e.localPoint),pp=!0}Du.addEventListener(`pointermove`,e=>{if(gp!==null&&e.pointerId!==gp)return;let t=Sp(e);t?(Cp(t),cp=Gf?.06:hp?1.36:.15,Du.style.cursor=hp?`grabbing`:`crosshair`,hp&&performance.now()-yp>90&&(wf.spawn(t.point,t.worldNormal,.25+_p*.35,5),yp=performance.now())):(cp=Gf?0:hp?.78:0,Du.style.cursor=hp?`grabbing`:`grab`)},{passive:!0}),Du.addEventListener(`pointerdown`,e=>{let t=Sp(e);if(!t){nd.enabled=!0,$f();return}if(e.preventDefault(),gp=e.pointerId,Du.setPointerCapture?.(e.pointerId),Gf){nd.enabled=!0,ap.copy(t.localPoint),op.copy(t.localPoint),wf.spawn(t.point,t.worldNormal,.42,14),Hf=Math.max(Hf,.46),Ff.ping(.68,!0),$f();return}hp=!0,Du.classList.add(`is-sculpting`),nd.enabled=!1,pp=!1,dp.set(0,0,0),up.set(0,0,0),mp=.18,Cp(t),cp=1.36,np(t.localPoint,t.point,t.worldNormal,.85+X[zf].swell*.15),$f()},{passive:!1});function wp(e){if(gp!==null&&e.pointerId!==gp)return;let t=hp;if(hp=!1,Du.classList.remove(`is-sculpting`),nd.enabled=!0,cp=0,gp!==null&&Du.releasePointerCapture?.(gp),gp=null,t){let e=Math.min(1.7,.35+mp+_p*.45);Z.uReleasePoint.value.copy(ap),Z.uReleaseVector.value.copy(up.lengthSq()>1e-4?up:dp),Z.uReleaseTime.value=qf,Z.uReleaseEnergy.value=e,dp.set(0,0,0),pp=!1,Hf=Math.max(Hf,.34+e*.18)}if(t&&zu){let e=performance.now();e-bp<285&&Tp(ap),bp=e}}Du.addEventListener(`pointerup`,wp,{passive:!0}),Du.addEventListener(`pointercancel`,wp,{passive:!0}),Du.addEventListener(`pointerleave`,()=>{hp||(cp=0)},{passive:!0});function Tp(e=ap){if(Gf=!Gf,Kf=+!!Gf,Wf=+!!Gf,Hf=Math.max(Hf,1),Gf){let t=e.clone().normalize();Z.uFreezeOrigin.value.copy(t),Z.uFreezeTime.value=qf,Rd(t),Id.visible=!0,jd.visible=!0,Fu.textContent=`CRYSTAL`,Fu.classList.add(`is-crystal`);let n=bd.localToWorld(t.multiplyScalar(1.64));wf.spawn(n,n.clone().sub(bd.getWorldPosition(new U)).normalize(),1.05,54)}else Fu.textContent=`LIQUID`,Fu.classList.remove(`is-crystal`),Z.uReleasePoint.value.copy(Z.uFreezeOrigin.value),Z.uReleaseVector.value.copy(Z.uFreezeOrigin.value).cross(new U(.2,1,.3)).normalize(),Z.uReleaseTime.value=qf,Z.uReleaseEnergy.value=1.15;Ff.ping(1.25,!0),Qf(Gf?`PHASE TRANSITION // 晶核扩散`:`PHASE TRANSITION // 晶格熔解`),$f()}Du.addEventListener(`dblclick`,e=>{e.preventDefault(),Tp(Sp(e)?.localPoint||ap)}),window.addEventListener(`keydown`,e=>{e.target instanceof HTMLInputElement||e.target instanceof HTMLButtonElement||(e.code===`Space`?(e.preventDefault(),tp(1)):/^Digit[1-4]$/.test(e.code)?ep(Number(e.code.slice(-1))-1):e.key.toLowerCase()===`f`?Op():e.key.toLowerCase()===`m`&&Tu(`#mic-toggle`).click())}),Eu(`.mode-btn`).forEach(e=>e.addEventListener(`click`,()=>ep(e.dataset.mode))),Tu(`#audio-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;try{Ff.active?(Ff.stop(),t.textContent=`声场 OFF`,t.setAttribute(`aria-pressed`,`false`),Qf(`GENERATIVE SOUND FIELD // OFF`)):(await Ff.start(),t.textContent=`声场 ON`,t.setAttribute(`aria-pressed`,`true`),Qf(`GENERATIVE SOUND FIELD // ON`),tp(.55))}catch(e){Qf(`AUDIO ERROR // ${e.message}`)}}),Tu(`#mic-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{Q.active?(await Lf(),t.textContent=`MIC OFF`,t.setAttribute(`aria-pressed`,`false`),Qf(`MIC REACTIVITY // OFF`)):(await If(),t.textContent=`MIC LIVE`,t.setAttribute(`aria-pressed`,`true`),Qf(`MIC REACTIVITY // LIVE`),tp(.7))}catch(e){Qf(`MIC DENIED // ${e.message}`)}finally{t.disabled=!1}});function Ep(e){Lu.hidden=!e,Tu(`#panel-toggle`).setAttribute(`aria-expanded`,String(e))}Tu(`#panel-toggle`).addEventListener(`click`,()=>Ep(Lu.hidden)),Tu(`#panel-close`).addEventListener(`click`,()=>Ep(!1)),[[`deform`,`userDeform`,2],[`speed`,`userSpeed`,2],[`outline`,`outline`,2],[`bloom`,`bloom`,2],[`chroma`,`chroma`,2],[`flow`,`flow`,2],[`liveliness`,`liveliness`,2]].forEach(([e,t,n])=>{let r=Tu(`#${e}`),i=Tu(`#${e}-out`);r.addEventListener(`input`,()=>{Qu[t]=Number(r.value),i.value=Qu[t].toFixed(n),i.textContent=i.value,$f()})}),Tu(`#reset-params`).addEventListener(`click`,()=>{Object.entries({deform:1,speed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1}).forEach(([e,t])=>{let n=Tu(`#${e}`);n.value=t,n.dispatchEvent(new Event(`input`))}),Qf(`MATERIAL PARAMETERS RESET`)}),Eu(`.quality`).forEach(e=>e.addEventListener(`click`,()=>Dp(e.dataset.quality)));function Dp(e){Qu.quality=e;let t=Math.min(window.devicePixelRatio||1,{high:1.5,medium:1.25,low:1}[e]);$u.setPixelRatio(t),Nf.enabled=e!==`low`,$u.shadowMap.enabled=e!==`low`,gf.setDrawRange(0,e===`high`?ff:e===`medium`?700:430),Eu(`.quality`).forEach(t=>t.classList.toggle(`is-active`,t.dataset.quality===e)),kp(),Qf(`RENDER QUALITY // ${e.toUpperCase()}`)}function Op(){document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.(),$f()}Tu(`#fullscreen`).addEventListener(`click`,Op),Tu(`#capture`).addEventListener(`click`,()=>{em(),kf.render(),Du.toBlob(e=>{if(!e){Qf(`CAPTURE FAILED`);return}let t=document.createElement(`a`);t.download=`mizu-kokoro-${X[zf].en.toLowerCase()}-${Date.now()}.png`,t.href=URL.createObjectURL(e),t.click(),setTimeout(()=>URL.revokeObjectURL(t.href),1e3),Qf(`FRAME CAPTURED // PNG`)},`image/png`)});function kp(){let e=Math.max(1,window.innerWidth),t=Math.max(1,window.innerHeight);ad(e,t),td.aspect=e/t,td.updateProjectionMatrix(),$u.setSize(e,t,!1),kf.setSize(e,t);let n=$u.getPixelRatio(),r={high:.82,medium:.66,low:.5}[Qu.quality]||.66,i=Math.max(1,Math.floor(e*n*r)),a=Math.max(1,Math.floor(t*n*r));ld.setSize(i,a),Z.uResolution.value.set(i,a),Mf.uniforms.uResolution.value.set(e*n,t*n)}window.addEventListener(`resize`,kp,{passive:!0});var Ap=performance.now(),jp=performance.now(),Mp=0,Np=!1,Pp=0,Fp=0,Ip=0,Lp=null,Rp=document.hidden,zp=!1,Bp=null,Vp=new Set,Hp=new Set,Up=Promise.resolve();function Wp(e){Yu(`stats`,{fps:Fp,frameTimeMs:Ip,frameCount:Pp,paused:e})}async function Gp(){for(;;){let e=Bp;if(e){for(let e of[Ff.context,Q.context])e?.state===`running`&&Vp.add(e);for(let e of Q.stream?.getAudioTracks()??[])e.enabled&&e.readyState===`live`&&(Hp.add(e),e.enabled=!1);await Promise.all([...Vp].map(e=>e.state===`running`?e.suspend():void 0))}else{await Promise.all([...Vp].map(e=>e.state===`suspended`?e.resume():void 0));for(let e of Hp)e.readyState===`live`&&(e.enabled=!0)}if(Bp===e){e||(Vp.clear(),Hp.clear());return}}}function Kp(){Up=Up.then(Gp).catch(e=>{console.error(`Orb runtime audio transition failed.`,e)})}function qp(){Bp||Lp!==null||(Lp=requestAnimationFrame(rm))}function Jp(){let e=Rp||zp;if(Bp===e)return;if(Bp=e,Bp){Lp!==null&&(cancelAnimationFrame(Lp),Lp=null),Kp(),Wp(!0);return}let t=performance.now();Ap=t,Yf=t,Xf=t,jp=t,Mp=0,Kp(),Wp(!1),qp()}function Yp(e){zp=e,Jp()}function Xp(){Rp=document.hidden,Jp()}function Zp(e){let t=X[Bf],n=1-Math.exp(-e*3.4);Z.uDeepColor.value.lerp(t.deepColor,n),Z.uMidColor.value.lerp(t.midColor,n),Z.uLightColor.value.lerp(t.lightColor,n),Z.uAccentColor.value.lerp(t.accentColor,n),Z.uInkColor.value.lerp(t.inkColor,n),rf.uColor.value.lerp(t.floorColor,n),of.uColor.value.lerp(t.backdropColor,n),uf.uColor.value.lerp(t.backdropColor,n),_f.uColor.value.lerp(t.floorColor,n),wf.uniforms.uColor.value.lerp(t.accentColor,n),bf.color.lerp(t.midColor,n),Ud.color.lerp(t.accentColor,n),Qd.color.lerp(t.floorColor,n),ef.color.lerp(t.floorColor,n),Jd.emissive.lerp(t.floorColor,n),Xd.uColor.value.lerp(t.floorColor,n),Ad.color.lerp(t.lightColor,n),Fd.color.lerp(t.lightColor,n),lf.forEach(e=>e.color.lerp(t.floorColor,n)),Tf.forEach(e=>e.mesh.material.color.lerp(t.accentColor,n)),sd.color.lerp(t.lightColor,n*.35),cd.color.lerp(t.accentColor,n*.45)}function Qp(e){let t=X[Bf];$=Vu($,Kf,Gf?2.45:3.6,e),Math.abs($-Kf)<5e-4&&($=Kf),Z.uFreezeProgress.value=$,Z.uMode.value=Vu(Z.uMode.value,Vf,3.2,e),Z.uDeform.value=Vu(Z.uDeform.value,t.deform*Qu.userDeform,4,e),Z.uTension.value=Vu(Z.uTension.value,t.tension,4.2,e),Z.uViscosity.value=Vu(Z.uViscosity.value,t.viscosity,4,e),Z.uSwell.value=Vu(Z.uSwell.value,t.swell,4,e),Z.uFlowStrength.value=Vu(Z.uFlowStrength.value,t.flow*Qu.flow,4,e),Z.uTurbulence.value=Vu(Z.uTurbulence.value,t.turbulence,4,e),Z.uFoam.value=Vu(Z.uFoam.value,t.foam,4,e),Z.uClarity.value=Vu(Z.uClarity.value,t.clarity,4,e),Z.uElasticity.value=Vu(Z.uElasticity.value,t.elasticity*Qu.liveliness,4,e),Z.uShear.value=Vu(Z.uShear.value,t.shear,4,e),Z.uRimStrength.value=Vu(Z.uRimStrength.value,t.rim,4,e),Z.uFacet.value=Vu(Z.uFacet.value,Wf*$,5,e),Z.uOutlineThickness.value=Vu(Z.uOutlineThickness.value,.046*Qu.outline,5,e);let n=.86+(1-t.clarity)*.075+(zf===3?.025:0);Z.uOpacity.value=Vu(Z.uOpacity.value,n,4,e);let r=Qu.quality===`low`?.72:1;jf.strength=Vu(jf.strength,(t.bloom+$*.24)*Qu.bloom*r,4,e),jf.radius=Vu(jf.radius,zf===3||$>.5?.16:.28,4,e),Mf.uniforms.uChroma.value=Vu(Mf.uniforms.uChroma.value,75e-5*(t.chroma+$*.42)*Qu.chroma,5,e),Mf.uniforms.uPosterize.value=Vu(Mf.uniforms.uPosterize.value,Math.min(.92,t.posterize+$*.08),4,e),Jd.emissiveIntensity=Vu(Jd.emissiveIntensity,.07+Hf*.18+$*.08,4,e);let i=$>.002;kd.visible=i,jd.visible=i,Id.visible=i&&Id.userData.vertexCount>0,Ad.opacity=$*(.16+Hf*.08),Fd.opacity=$*(.54+Hf*.22),Pd.setDrawRange(0,Math.floor(Id.userData.vertexCount*$)),Ud.opacity=.28*(1-$*.88)}function $p(e){let t=X[zf],n=1-$*.88;Hd.rotation.y+=e*(.19+t.speed*.12)*n,Hd.rotation.x=Math.sin(qf*.21)*.14*n,Wd.rotation.x+=e*.23*n,Wd.rotation.y-=e*.31*n,Wd.scale.setScalar(1+Hf*.07+Z.uAudio.value*.08),jd.rotation.y-=e*.08*$,jd.rotation.x=Math.sin(qf*.16)*.08*$,Md.forEach((t,n)=>{let r=.82+Math.sin(qf*.9+t.userData.phase+n*.17)*.12,i=$*r;t.scale.copy(t.userData.baseScale).multiplyScalar(i),t.rotation.y+=e*(.018+n*8e-4)*$}),bd.rotation.y+=e*kt.lerp(.028,.006,$),bd.rotation.x=Math.sin(qf*.19)*kt.lerp(.027,.006,$);let r=kt.lerp(.048,.015,$),i=Math.sin(qf*.72)*(Ru?.012:r);bd.position.y=.48+i,cf.rotation.y+=e*.045,cf.rotation.z=Math.sin(qf*.12)*.08,cf.children.forEach((t,n)=>{t.rotation.z+=e*(.025+n*.013)*(n%2?-1:1),t.material.opacity=.13-n*.02+Hf*.1+Z.uAudio.value*.12+$*.04});let a=(.34+t.flow*.78)*(1-t.viscosity*.32);bf.opacity=kt.lerp(.72,.42,$),Cf.forEach((e,n)=>{let r=e.phase+qf*e.speed*a,i=Math.sin(qf*(.52+t.turbulence*.46)+e.phase)*(.08+t.swell*.1);e.mesh.position.set(Math.cos(r)*(e.radius+i),.45+Math.sin(r*(1.45+t.swell*.35)+e.phase)*e.yAmp,Math.sin(r)*e.radius*(.55+e.tilt*.15)),e.mesh.rotation.set(r*.7,r*1.3+n,r*.35);let o=1+Z.uAudio.value*(.18+n%4*.04),s=e.scale*o,c=1+t.viscosity*1.35+t.swell*.22,l=1+t.swell*.24;e.mesh.scale.set(s/l,s*c,s/l)}),Zd.rotation.z+=e*(.012+t.flow*.018)*(1-$*.72),Tf.forEach(n=>{if(n.life<=0)return;let r=kt.lerp(1.35,.62,t.viscosity);n.life=Math.max(0,n.life-e*r);let i=1-n.life,a=3.1+t.tension*.72+t.swell*.55,o=kt.lerp(.08,a*n.intensity,1-(1-i)**2);n.mesh.scale.setScalar(o),n.mesh.material.opacity=n.life*n.life*(.72+t.tension*.12),n.life===0&&(n.mesh.visible=!1)}),wf.update(e)}function em(){let e=bd.visible;bd.visible=!1,$u.setRenderTarget(ld),$u.clear(),$u.render(ed,td),$u.setRenderTarget(null),bd.visible=e}function tm(){let e=new U;td.getWorldDirection(e),sf.position.copy(nd.target).addScaledVector(e,4.2),sf.quaternion.copy(td.quaternion),df.quaternion.copy(td.quaternion),df.position.copy(nd.target).addScaledVector(e,.25)}function nm(){let e=performance.now(),t=e-Yf;t>15e3&&(nd.autoRotate=!0,cp=Gf?0:.1,op.set(Math.sin(qf*.27),Math.sin(qf*.19+1.4)*.65,Math.cos(qf*.27)).normalize()),t>3e4&&e-Xf>17e3&&(ep((zf+1)%X.length,!1),Xf=e,Yf=e-2e4)}function rm(e=performance.now()){if(Lp=null,Bp)return;let t=Math.min(Math.max((e-Ap)/1e3,0),.05);Ap=e;let n=X[zf],r=Ru?.34:1;qf+=t*n.speed*Qu.userSpeed*r,Z.uTime.value=qf,Mf.uniforms.uTime.value=qf,nm(),Zp(t),Qp(t);let i=hp?kt.lerp(20,8,n.viscosity):6.5;ap.lerp(op,1-Math.exp(-t*i)),ap.normalize(),Z.uTouchPoint.value.copy(ap);let a=hp?185:42*n.recovery*Math.max(.25,Qu.liveliness),o=hp?.92:kt.clamp((.24+n.viscosity*1.02)/Math.sqrt(Math.max(.22,n.elasticity*Qu.liveliness)),.18,1.42),s=2*Math.sqrt(a)*o,c=(cp-sp)*a-lp*s;if(lp+=c*t,sp=kt.clamp(sp+lp*t,-.52,1.46),$>.72&&(sp*=Math.exp(-t*10),lp*=Math.exp(-t*10)),Z.uTouchStrength.value=sp,!hp){let e=kt.lerp(10.5,2,n.viscosity);dp.multiplyScalar(Math.exp(-t*e))}let l=kt.lerp(18,5.2,n.viscosity);up.lerp(dp,1-Math.exp(-t*l)),$>.35&&up.multiplyScalar(Math.exp(-t*8*$)),Z.uDragVector.value.copy(up).multiplyScalar(Qu.liveliness),_p=Vu(_p,0,7,t),Z.uPointerVelocity.value=Vu(Z.uPointerVelocity.value,_p,12,t),Hf=Vu(Hf,Uf,3.3,t),Z.uPulse.value=Hf,Ff.update(n,qf,Hf);let u=Rf(),d=Q.active?u:Ff.visualEnergy;Z.uAudio.value=Vu(Z.uAudio.value,d,Q.active?11:5,t),cd.intensity=20+Hf*15+Z.uAudio.value*18+$*8,sd.intensity=48+Hf*18+$*7,$d.scale.setScalar(1+Hf*.04+Z.uAudio.value*.025+$*.018),Qd.opacity=.55+Hf*.35+Z.uAudio.value*.25+$*.08,$p(t),nd.update(t),tm(),em(),kf.render(t),Pp+=1,Mp+=1;let f=e-jp;f>=500&&(Fp=Mp*1e3/f,Ip=f/Mp,ku.textContent=`${Math.round(Fp)} FPS`,Wp(!1),jp=e,Mp=0),Np||(Np=!0,setTimeout(()=>Ou.classList.add(`is-hidden`),280)),qp()}Dp(Qu.quality),ep(0,!1),kp(),document.addEventListener(`visibilitychange`,Xp),Ku&&(window.addEventListener(`message`,Zu),Yu(`ready`,{capabilities:[...Gu]})),Jp();
//# sourceMappingURL=index-WiZR53Zo.js.map