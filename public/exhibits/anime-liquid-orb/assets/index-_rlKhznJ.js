...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(e,t,n){let r=new Float32Array(Fo),i=new U(0,1,0);return new ca({name:`SphericalGaussianBlur`,defines:{n:Fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Qo(),fragmentShader:`
	...
	`}var $o=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var wc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Tc(e,t){let n=wc[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ec=new U;function Dc(){return G.getLuminanceCoefficients(Ec),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ec.x.toFixed(4)}, ${Ec.y.toFixed(4)}, ${Ec.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=gc(i,i.VERTEX_SHADER,y),S=gc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Sc(i,x,`vertex`),n=Sc(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},cu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},lu=new Ja(-1,1,1,-1,0,1),uu=new class extends kr{constructor(){super(),this.setAttribute(`position`,new q([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new q([0,2,0,0,2,0],2))}},du=class{constructor(e){this._mesh=new Qr(uu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,lu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},fu=class extends cu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ca?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=aa.clone(e.uniforms),this.material=new ca({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new du(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},pu=class extends cu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},mu=class extends cu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},hu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new H);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new fu(su),this.copyPass.material.blending=0,this.timer=new $a}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}pu!==void 0&&(r instanceof pu?n=!0:r instanceof mu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new H);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},gu=class extends cu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},_u={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};vu.BlurDirectionX=new H(1,0),vu.BlurDirectionY=new H(0,1);var yu={name:`SMAAEdgesShader`,defines:{SMAA_THRESHOLD:`0.1`},uniforms:{tDiffuse:{value:null},resolution:{value:new H(1/1024,1/512)}},vertexShader:`
		...
		}`},bu={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new H(1/1024,1/512)}},vertexShader:`
		...
		}`},xu={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new H(1/1024,1/512)}},vertexShader:`
		...
		}`},wu=class extends cu{constructor(){super(),this.isOutputPass=!0,this.uniforms=aa.clone(Cu.uniforms),this.material=new la({name:Cu.name,uniforms:this.uniforms,vertexShader:Cu.vertexShader,fragmentShader:Cu.fragmentShader}),this._fsQuad=new du(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},G.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Tu=e=>document.querySelector(e),Eu=e=>[...document.querySelectorAll(e)],Du=Tu(`#scene`),Ou=Tu(`#loading`),ku=Tu(`#fps`),Au=Tu(`#pipeline`),ju=Tu(`#state-name`),Mu=Tu(`#material-type`),Nu=Tu(`#material-metrics`),Pu=Tu(`#material-note`),Fu=Tu(`#matter-state`),Iu=Tu(`#toast`),Lu=Tu(`#lab-panel`),Ru=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,zu=window.matchMedia(`(pointer: coarse)`).matches,Bu=new URLSearchParams(window.location.search).getAll(`qa`),Vu=Bu.length===1&&Bu[0]===`1`,Hu=e=>kt.clamp(e,0,1),Uu=(e,t,n,r)=>kt.damp(e,t,n,r),Wu=e=>new K(e);function Gu(e){let t=e>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}var Ku=Vu?Gu(1296652885):Math.random,qu=`shader-demo-room`,Ju=1,Yu=Object.freeze([`pause`,`stats`,`set-mode`,`set-quality`]),Xu=window.parent===window?null:Object.freeze({instanceId:crypto.randomUUID(),targetOrigin:location.origin});function Zu(e){return typeof e==`object`&&!!e&&!Array.isArray(e)&&Object.getPrototypeOf(e)===Object.prototype}function Qu(e,t){if(!Zu(e))return!1;let n=Object.keys(e).sort(),r=[...t].sort();return n.length===r.length&&n.every((e,t)=>e===r[t])}function $u(e,t){Xu&&window.parent.postMessage({context:qu,v:Ju,instanceId:Xu.instanceId,type:e,payload:t},Xu.targetOrigin)}function ed(e,t){if(e===`set-paused`){if(!Qu(t,[`paused`])||typeof t.paused!=`boolean`)throw Error(`Invalid set-paused payload`);return}if(e===`set-orb-mode`){if(!Qu(t,[`mode`])||!Number.isInteger(t.mode)||t.mode<0||t.mode>3)throw Error(`Invalid set-orb-mode payload`);return}if(e===`set-orb-quality`){if(!Qu(t,[`quality`])||![`high`,`medium`,`low`].includes(t.quality))throw Error(`Invalid set-orb-quality payload`);return}throw Error(`Unknown embedded command: ${String(e)}`)}function td(e){if(!Xu||e.origin!==location.origin||e.source!==window.parent)return;let t=e.data;if(!Qu(t,[`context`,`v`,`instanceId`,`type`,`payload`]))throw Error(`Invalid embedded command envelope`);if(t.context!==qu||t.v!==Ju)throw Error(`Embedded command envelope does not match this runtime`);if(t.instanceId===Xu.instanceId){if(typeof t.type!=`string`)throw Error(`Embedded command type must be a string`);ed(t.type,t.payload),t.type===`set-paused`?am(t.payload.paused):t.type===`set-orb-mode`?rp(t.payload.mode):t.type===`set-orb-quality`&&Ip(t.payload.quality)}}var X=[{zh:`静水`,en:`CALM`,material:`AQUEOUS / WATER`,deep:`#031522`,mid:`#14c8ef`,light:`#efffff`,accent:`#68f2ff`,ink:`#01070d`,floor:`#48ebff`,backdrop:`#0f708c`,deform:.78,speed:.78,bloom:.46,chroma:.25,posterize:0,rim:1.02,viscosity:.16,tension:.92,swell:.18,flow:.35,turbulence:.18,foam:.08,clarity:.94,elasticity:1.08,recovery:1.22,shear:.72,note:55,noteZh:`高表面张力、清澈折射与短促毛细波。`},{zh:`涨潮`,en:`SURGE`,material:`OCEANIC / BREAKER`,deep:`#1b0923`,mid:`#ec3b9b`,light:`#fff7df`,accent:`#ffb72f`,ink:`#10030d`,floor:`#ff56ba`,backdrop:`#8b2859`,deform:1.34,speed:1.16,bloom:.72,chroma:.72,posterize:0,rim:1.17,viscosity:.07,tension:.54,swell:1,flow:1.2,turbulence:.92,foam:1,clarity:.62,elasticity:.82,recovery:.92,shear:1.22,note:65.41,noteZh:`低黏度大惯性浪涌，陡峭波峰与破碎泡沫。`},{zh:`绽生`,en:`BLOOM`,material:`VISCOUS / PROTOPLASM`,deep:`#061b19`,mid:`#35dea8`,light:`#f4ffed`,accent:`#b2ff4d`,ink:`#02100d`,floor:`#63ffc3`,backdrop:`#1b826b`,deform:1.12,speed:.72,bloom:.6,chroma:.42,posterize:0,rim:1.1,viscosity:.9,tension:.7,swell:.34,flow:.76,turbulence:.28,foam:.12,clarity:.48,elasticity:.38,recovery:.34,shear:1.52,note:73.42,noteZh:`高黏度活体胶质，形变滞留并拉出缓慢流丝。`},{zh:`零界`,en:`VOID`,material:`METALLIC / SUPERCOOLED`,deep:`#010204`,mid:`#9eabb5`,light:`#ffffff`,accent:`#ff3a52`,ink:`#000000`,floor:`#e4fbff`,backdrop:`#677984`,deform:.68,speed:.6,bloom:.39,chroma:1.08,posterize:.72,rim:1.42,viscosity:.24,tension:1.24,swell:.08,flow:.16,turbulence:.12,foam:0,clarity:.72,elasticity:1.34,recovery:1.48,shear:.58,note:41.2,noteZh:`超冷却金属水体，流动稀少、回弹尖锐并带离散扫描。`}].map(e=>({...e,deepColor:Wu(e.deep),midColor:Wu(e.mid),lightColor:Wu(e.light),accentColor:Wu(e.accent),inkColor:Wu(e.ink),floorColor:Wu(e.floor),backdropColor:Wu(e.backdrop)})),nd={userDeform:1,userSpeed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1,quality:zu?`medium`:`high`},rd;try{rd=new Ll({canvas:Du,antialias:!1,alpha:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!0})}catch(e){throw Ou.innerHTML=`<p>WEBGL INITIALIZATION FAILED<br>${String(e.message||e)}</p>`,e}rd.setClearColor(198157,1),rd.outputColorSpace=Be,rd.toneMapping=4,rd.toneMappingExposure=.86,rd.shadowMap.enabled=!0,rd.shadowMap.type=1,rd.debug.checkShaderErrors=!0,Au.textContent=rd.capabilities.isWebGL2?`WEBGL2 / GLSL`:`WEBGL / GLSL`;var id=new In;id.background=new K(198157),id.fog=new Fn(198157,.042);var ad=new Ua(42,1,.05,80);ad.position.set(0,1.05,8.1);var od=new Jl(ad,Du);od.target.set(0,.42,0),od.enableDamping=!0,od.dampingFactor=.055,od.enablePan=!1,od.minDistance=5.2,od.maxDistance=10.2,od.minPolarAngle=.72,od.maxPolarAngle=1.72,od.minAzimuthAngle=-1,od.maxAzimuthAngle=1,od.autoRotate=!1,od.autoRotateSpeed=.35,od.update();var sd=Object.freeze({default:Object.freeze({fov:42,targetY:.42,offsetY:.63,positionZ:8.1}),portrait:Object.freeze({fov:42,targetY:.05,offsetY:.62,positionZ:10.18}),compact:Object.freeze({fov:58,targetY:-.65,offsetY:.54,positionZ:10.18})}),cd=``;function ld(e,t){let n=e<=420?t<=520?`compact`:`portrait`:`default`;if(n===cd)return;let r=sd[n],i=Math.hypot(r.offsetY,r.positionZ);if(i<od.minDistance||i>od.maxDistance)throw Error(`Orb ${n} camera frame violates OrbitControls distance limits.`);ad.fov=r.fov,ad.position.set(0,r.targetY+r.offsetY,r.positionZ),od.target.set(0,r.targetY,0),od.update(),cd=n}var ud=new ja(10415871,1180687,.72);id.add(ud);var dd=new Ga(14285823,52,24,Math.PI/5.5,.7,1.5);dd.position.set(-4.5,7,5.4),dd.target.position.set(0,0,0),dd.castShadow=!0,dd.shadow.mapSize.set(1024,1024),dd.shadow.bias=-2e-4,id.add(dd,dd.target);var fd=new qa(16732120,22,16,2);fd.position.set(4.2,1.8,-2.2),id.add(fd);var pd=new Yt(1,1,{depthBuffer:!0,stencilBuffer:!1,minFilter:c,magFilter:c});pd.texture.name=`MIZU_REFRACTION_BUFFER`,pd.texture.generateMipmaps=!1;var md=`
...
`,Z={uTime:{value:0},uDeform:{value:X[0].deform},uTouchStrength:{value:0},uPointerVelocity:{value:0},uPulse:{value:0},uAudio:{value:0},uTension:{value:X[0].tension},uMode:{value:0},uViscosity:{value:X[0].viscosity},uSwell:{value:X[0].swell},uFlowStrength:{value:X[0].flow},uTurbulence:{value:X[0].turbulence},uFoam:{value:X[0].foam},uClarity:{value:X[0].clarity},uElasticity:{value:X[0].elasticity},uShear:{value:X[0].shear},uTouchPoint:{value:new U(0,0,1)},uDragVector:{value:new U},uReleasePoint:{value:new U(0,0,1)},uReleaseVector:{value:new U},uReleaseTime:{value:-100},uReleaseEnergy:{value:0},uFreezeProgress:{value:0},uFreezeOrigin:{value:new U(0,0,1)},uFreezeTime:{value:0},uRipples:{value:Array.from({length:5},()=>new qt(0,0,1,-100))},uSceneTexture:{value:pd.texture},uResolution:{value:new H(1,1)},uDeepColor:{value:X[0].deepColor.clone()},uMidColor:{value:X[0].midColor.clone()},uLightColor:{value:X[0].lightColor.clone()},uAccentColor:{value:X[0].accentColor.clone()},uInkColor:{value:X[0].inkColor.clone()},uRimStrength:{value:X[0].rim},uFacet:{value:0},uOpacity:{value:.88},uOutlineThickness:{value:.046}},gd=`
${md}
${hd}
...
`,wd=new Dn;wd.position.y=.48,id.add(wd);var Td=new qi(1.65,5),Ed=new ca({uniforms:Z,vertexShader:gd,fragmentShader:_d,transparent:!0,depthWrite:!1,side:0});Ed.extensions.derivatives=!0;var Dd=new ca({uniforms:Z,vertexShader:vd,fragmentShader:yd,transparent:!0,depthWrite:!1,side:1}),Od=new Qr(Td,Ed);Od.renderOrder=3,wd.add(Od);var kd=new Qr(Td,Dd);kd.renderOrder=2,wd.add(kd);var Ad=new Qr(Td,new ca({uniforms:Z,vertexShader:bd,fragmentShader:xd,transparent:!0,depthWrite:!1,side:1}));Ad.scale.setScalar(.985),Ad.renderOrder=1,wd.add(Ad);var jd=new qi(1.69,2),Md=new ca({uniforms:Z,vertexShader:Sd,fragmentShader:Cd,transparent:!0,depthWrite:!1,side:0});Md.extensions.derivatives=!0;var Nd=new Qr(jd,Md);Nd.renderOrder=4,wd.add(Nd);var Pd=new Br({color:X[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),Fd=new Dn,Id=[],Ld=new Ji(.18,0);for(let e=0;e<22;e+=1){let e=new Qr(Ld,Pd),t=new U(Ku()*2-1,Ku()*2-1,Ku()*2-1).normalize(),n=.18+Ku()**.72*1.25;e.position.copy(t).multiplyScalar(n),e.rotation.set(Ku()*Math.PI,Ku()*Math.PI,Ku()*Math.PI);let r=.22+Ku()*.48,i=.72+Ku()*1.75;e.scale.set(r,i,r*(.66+Ku()*.55)),e.userData.baseScale=e.scale.clone(),e.userData.phase=Ku()*Math.PI*2,Fd.add(e),Id.push(e)}Fd.visible=!1,Fd.renderOrder=1,wd.add(Fd);var Rd=new kr;Rd.setAttribute(`position`,new q([],3));var zd=new yi({color:X[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),Bd=new ji(Rd,zd);Bd.renderOrder=3,Bd.visible=!1,Bd.userData.vertexCount=0,wd.add(Bd);function Vd(e){let t=e.clone().normalize(),n=Gu(Math.abs(Math.floor((t.x*1731+t.y*3191+t.z*7919)*1e4))+17),r=new U().crossVectors(t,Math.abs(t.y)<.92?new U(0,1,0):new U(1,0,0)).normalize(),i=new U().crossVectors(t,r).normalize(),a=[],o=(e,o,s,c,l=.22)=>{let u=e.clone(),d=o.clone().normalize();for(let e=0;e<s;e+=1){let e=r.clone().multiplyScalar((n()-.5)*2).addScaledVector(i,(n()-.5)*2).addScaledVector(t,(n()-.5)*.45).normalize(),o=u.clone().normalize().multiplyScalar(-.19);d.multiplyScalar(.78).addScaledVector(e,l).add(o).normalize();let s=u.clone().addScaledVector(d,c*(.78+n()*.46));s.length()>1.57&&s.normalize().multiplyScalar(1.55),a.push(u.x,u.y,u.z,s.x,s.y,s.z),u=s}};for(let e=0;e<12;e+=1){let e=(n()-.5)*.82,a=(n()-.5)*.82,s=t.clone().multiplyScalar(1.57).addScaledVector(r,e*.08).addScaledVector(i,a*.08),c=t.clone().multiplyScalar(-.76-n()*.22).addScaledVector(r,e).addScaledVector(i,a).normalize();o(s,c,8+Math.floor(n()*6),.13,.2),o(s.clone().addScaledVector(c,.42+n()*.3),c.clone().addScaledVector(r,(n()-.5)*1).addScaledVector(i,(n()-.5)*1).normalize(),3+Math.floor(n()*4),.105,.32)}Rd.setAttribute(`position`,new q(a,3)),Rd.computeBoundingSphere(),Bd.userData.vertexCount=a.length/3,Rd.setDrawRange(0,0)}var Hd=new Br({transparent:!0,opacity:0,depthWrite:!1});Hd.colorWrite=!1;var Ud=new Qr(new Zi(1.76,28,20),Hd);Ud.renderOrder=-10,wd.add(Ud);var Wd=new ca({uniforms:{uTime:Z.uTime,uAudio:Z.uAudio,uPulse:Z.uPulse,uMode:Z.uMode,uFreezeProgress:Z.uFreezeProgress,uMidColor:Z.uMidColor,uLightColor:Z.uLightColor,uAccentColor:Z.uAccentColor},vertexShader:`
  ...
  `,transparent:!0,depthWrite:!1,blending:2,side:2}),Gd=new Qr(new qi(1.02,4),Wd);Gd.renderOrder=1,wd.add(Gd);var Kd=new Br({color:X[0].accentColor,transparent:!0,opacity:.28,depthWrite:!1,blending:2}),qd=new Qr(new $i(.57,.055,220,18,2,3),Kd);qd.renderOrder=1,wd.add(qd);var Jd=new Dn;id.add(Jd);var Yd=new ua({color:462874,roughness:.24,metalness:.82}),Xd=new Qr(new Gi(2.22,2.48,.34,96,1),Yd);Xd.position.y=-1.32,Xd.receiveShadow=!0,Xd.castShadow=!0,Jd.add(Xd);var Zd=new ua({color:727332,roughness:.12,metalness:.88,emissive:X[0].floorColor.clone(),emissiveIntensity:.08}),Qd=new Qr(new Gi(1.82,1.88,.065,96),Zd);Qd.position.y=-1.12,Qd.receiveShadow=!0,Jd.add(Qd);var $d={uTime:Z.uTime,uMode:Z.uMode,uFlowStrength:Z.uFlowStrength,uTurbulence:Z.uTurbulence,uFoam:Z.uFoam,uFreezeProgress:Z.uFreezeProgress,uColor:{value:X[0].floorColor.clone()},uLightColor:Z.uLightColor},ef=new Qr(new Wi(1.79,128),new ca({uniforms:$d,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));ef.rotation.x=-Math.PI/2,ef.position.y=-1.078,ef.renderOrder=2,Jd.add(ef);var tf=new Br({color:X[0].floorColor,transparent:!0,opacity:.72,depthWrite:!1,blending:2}),nf=new Qr(new Qi(1.96,.018,8,192),tf);nf.rotation.x=Math.PI/2,nf.position.y=-1.075,Jd.add(nf);var rf=new Br({color:X[0].floorColor,transparent:!0,opacity:.3}),af=new ui(new Ui(.025,.012,.16),rf,48),of=new En;for(let e=0;e<48;e+=1){let t=e/48*Math.PI*2;of.position.set(Math.cos(t)*2.28,-1.105,Math.sin(t)*2.28),of.rotation.y=-t,of.scale.z=e%4==0?1.7:.65,of.updateMatrix(),af.setMatrixAt(e,of.matrix)}Jd.add(af);var sf={uTime:Z.uTime,uPulse:Z.uPulse,uAudio:Z.uAudio,uColor:{value:X[0].floorColor.clone()}},cf=new Qr(new Yi(32,32,1,1),new ca({uniforms:sf,vertexShader:`
      varying vec2 vWorld;
      void main() {
        vec4 world = modelMatrix * vec4(position, 1.0);
        vWorld = world.xz;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));cf.rotation.x=-Math.PI/2,cf.position.y=-1.5,id.add(cf);var lf={uTime:Z.uTime,uPulse:Z.uPulse,uAudio:Z.uAudio,uColor:{value:X[0].backdropColor.clone()},uAccent:Z.uAccentColor},uf=new Qr(new Wi(4.25,192),new ca({uniforms:lf,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));uf.renderOrder=-2,id.add(uf);var df=new Dn;id.add(df);var ff=[];for(let e=0;e<3;e+=1){let t=new Br({color:X[0].floorColor,transparent:!0,opacity:.18-e*.035,depthWrite:!1,blending:2});ff.push(t);let n=new Qr(new Qi(2.4+e*.42,.009+e*.002,6,256),t);n.rotation.set(Math.PI*(.18+e*.21),e*.75,e*.45),n.position.y=.42,df.add(n)}var pf={uTime:Z.uTime,uPulse:Z.uPulse,uColor:{value:X[0].backdropColor.clone()}},mf=new Dn;id.add(mf);for(let e=0;e<7;e+=1){let t=new Qr(new Yi(.08+e%3*.05,7.5),new ca({uniforms:pf,vertexShader:`
        varying vec2 vUv2;
      ...
      `,transparent:!0,depthWrite:!1,blending:2,side:2}));t.position.set((e-3)*1.18+e%2*.28,1.35+e%2*.2,-4.1-Math.abs(e-3)*.08),mf.add(t)}var hf=950,gf=new Float32Array(hf*3),_f=new Float32Array(hf),vf=new Float32Array(hf);for(let e=0;e<hf;e+=1){let t=4+Ku()*8.5,n=Ku()*Math.PI*2;gf[e*3]=Math.cos(n)*t,gf[e*3+1]=-3.6+Ku()*10.2,gf[e*3+2]=Math.sin(n)*t*.72-1.5,_f[e]=Ku(),vf[e]=Ku()*Math.PI*2}var yf=new kr;yf.setAttribute(`position`,new hr(gf,3)),yf.setAttribute(`aScale`,new hr(_f,1)),yf.setAttribute(`aPhase`,new hr(vf,1));var bf={uTime:Z.uTime,uAudio:Z.uAudio,uColor:{value:X[0].floorColor.clone()}},xf=new Li(yf,new ca({uniforms:bf,vertexShader:`
      uniform float uTime;
      uniform float uAudio;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));id.add(xf);var Sf=new ti(new Uint8Array([35,145,255]),3,1,k);Sf.needsUpdate=!0,Sf.minFilter=a,Sf.magFilter=a;var Cf=new da({color:X[0].midColor,gradientMap:Sf,transparent:!0,opacity:.66}),wf=new qi(.13,2),Tf=new Dn;id.add(Tf);var Ef=[];for(let e=0;e<16;e+=1){let e=new Qr(wf,Cf),t=.45+Ku()*1.2;e.scale.setScalar(t),Tf.add(e),Ef.push({mesh:e,radius:2.2+Ku()*2.7,phase:Ku()*Math.PI*2,speed:(.08+Ku()*.12)*(Ku()>.5?1:-1),yAmp:.35+Ku()*1.5,tilt:-.35+Ku()*.7,scale:t})}var Df=new class{constructor(e=320){this.max=e,this.cursor=0,this.positions=new Float32Array(e*3),this.velocities=new Float32Array(e*3),this.life=new Float32Array(e),this.size=new Float32Array(e);for(let t=0;t<e;t+=1)this.positions[t*3+1]=-999;this.geometry=new kr,this.geometry.setAttribute(`position`,new hr(this.positions,3)),this.geometry.setAttribute(`aLife`,new hr(this.life,1)),this.geometry.setAttribute(`aSize`,new hr(this.size,1)),this.uniforms={uColor:{value:X[0].accentColor.clone()}},this.points=new Li(this.geometry,new ca({uniforms:this.uniforms,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:2})),id.add(this.points)}spawn(e,t,n=1,r=36){let i=new U().crossVectors(t,Math.abs(t.y)<.9?new U(0,1,0):new U(1,0,0)).normalize(),a=new U().crossVectors(t,i).normalize();for(let o=0;o<r;o+=1){let r=this.cursor;this.cursor=(this.cursor+1)%this.max;let o=r*3,s=(Math.random()-.5)*2,c=(Math.random()-.5)*2,l=.45+Math.random()*1.4,u=(.8+Math.random()*1.8)*n,d=t.clone().multiplyScalar(l).addScaledVector(i,s).addScaledVector(a,c).normalize().multiplyScalar(u);this.positions[o]=e.x+t.x*.04,this.positions[o+1]=e.y+t.y*.04,this.positions[o+2]=e.z+t.z*.04,this.velocities[o]=d.x,this.velocities[o+1]=d.y,this.velocities[o+2]=d.z,this.life[r]=.62+Math.random()*.38,this.size[r]=2.5+Math.random()*4.5}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aLife.needsUpdate=!0,this.geometry.attributes.aSize.needsUpdate=!0}update(e){for(let t=0;t<this.max;t+=1){if(this.life[t]<=0)continue;let n=t*3;this.life[t]=Math.max(0,this.life[t]-e*.72),this.positions[n]+=this.velocities[n]*e,this.positions[n+1]+=this.velocities[n+1]*e,this.positions[n+2]+=this.velocities[n+2]*e,this.velocities[n]*=.94**(e*60),this.velocities[n+1]=this.velocities[n+1]*.94**(e*60)-.28*e,this.velocities[n+2]*=.94**(e*60),this.life[t]===0&&(this.positions[n+1]=-999)}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aLife.needsUpdate=!0}},Of=[];for(let e=0;e<7;e+=1){let e=new Br({color:X[0].accentColor,transparent:!0,opacity:0,depthWrite:!1,blending:2,side:2}),t=new Qr(new Xi(.34,.38,96),e);t.visible=!1,id.add(t),Of.push({mesh:t,life:0})}var kf=0;function Af(e,t,n=1){let r=Of[kf];kf=(kf+1)%Of.length,r.life=1,r.intensity=n,r.mesh.visible=!0,r.mesh.position.copy(e).addScaledVector(t,.045),r.mesh.quaternion.setFromUnitVectors(new U(0,0,1),t),r.mesh.scale.setScalar(.08),r.mesh.material.opacity=.9}var jf={uniforms:{tDiffuse:{value:null},uTime:{value:0},uResolution:{value:new H(1,1)},uChroma:{value:.002},uPosterize:{value:0},uPulse:Z.uPulse,uAccent:Z.uAccentColor},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},Mf=new hu(rd),Nf=new gu(id,ad),Pf=new vu(new H(1,1),X[0].bloom,.26,.94),Ff=new fu(jf),If=new Su,Lf=new wu;Mf.addPass(Nf),Mf.addPass(Pf),Mf.addPass(Ff),Mf.addPass(If),Mf.addPass(Lf);var Rf=new class{constructor(){this.context=null,this.master=null,this.active=!1,this.oscillators=[],this.noiseFilter=null,this.visualEnergy=0}async start(){this.context||this.create(),await this.context.resume(),this.active=!0;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(.075,e+.5),Xp&&nm()}stop(){if(!this.context)return;this.active=!1;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(0,e+.35)}create(){let e=window.AudioContext||window.webkitAudioContext;if(!e)throw Error(`Web Audio is unavailable`);this.context=new e,this.master=this.context.createGain(),this.master.gain.value=0;let t=this.context.createDynamicsCompressor();t.threshold.value=-22,t.knee.value=20,t.ratio.value=5,t.attack.value=.02,t.release.value=.5,this.master.connect(t).connect(this.context.destination);let n=this.context.createBiquadFilter();n.type=`lowpass`,n.frequency.value=680,n.Q.value=1.2,n.connect(this.master),this.droneFilter=n,[1,1.5,2.01].forEach((e,t)=>{let r=this.context.createOscillator(),i=this.context.createGain();r.type=t===0?`sine`:`triangle`,r.frequency.value=X[0].note*e,i.gain.value=t===0?.42:.11,r.connect(i).connect(n),r.start(),this.oscillators.push({osc:r,gain:i,ratio:e})});let r=this.context.createBuffer(1,this.context.sampleRate*2,this.context.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e+=1)i[e]=Math.random()*2-1;let a=this.context.createBufferSource();a.buffer=r,a.loop=!0;let o=this.context.createBiquadFilter();o.type=`bandpass`,o.frequency.value=460,o.Q.value=2.2;let s=this.context.createGain();s.gain.value=.045,a.connect(o).connect(s).connect(this.master),a.start(),this.noiseFilter=o}update(e,t,n){if(!this.context)return;let r=this.context.currentTime;this.oscillators.forEach(({osc:n,ratio:i},a)=>{let o=Math.sin(t*(.17+a*.04)+a)*(2+a*1.5);n.frequency.setTargetAtTime(e.note*i+o,r,.18)}),this.droneFilter.frequency.setTargetAtTime(480+e.speed*320+n*840,r,.12),this.noiseFilter&&this.noiseFilter.frequency.setTargetAtTime(380+e.deform*240+n*520,r,.15),this.visualEnergy=this.active?.06+(Math.sin(t*2.35)*.5+.5)*.12+n*.18:0}ping(e=1,t=!1){if(!this.active||!this.context)return;let n=this.context.currentTime,r=this.context.createOscillator(),i=this.context.createGain(),a=this.context.createBiquadFilter();r.type=t?`square`:`sine`,r.frequency.setValueAtTime((t?420:220)+Math.random()*150,n),r.frequency.exponentialRampToValueAtTime(85+Math.random()*40,n+.42),a.type=`lowpass`,a.frequency.value=t?1500:900,i.gain.setValueAtTime(1e-4,n),i.gain.exponentialRampToValueAtTime(.055*e,n+.012),i.gain.exponentialRampToValueAtTime(1e-4,n+.46),r.connect(a).connect(i).connect(this.master),r.start(n),r.stop(n+.5)}},Q={active:!1,stream:null,context:null,analyser:null,data:null,energy:0};async function zf(){if(!navigator.mediaDevices?.getUserMedia)throw Error(`该浏览器不支持麦克风输入`);let e=await navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!1,noiseSuppression:!1,autoGainControl:!1},video:!1}),t=new(window.AudioContext||window.webkitAudioContext);await t.resume();let n=t.createMediaStreamSource(e),r=t.createAnalyser();r.fftSize=256,r.smoothingTimeConstant=.78,n.connect(r),Q.active=!0,Q.stream=e,Q.context=t,Q.analyser=r,Q.data=new Uint8Array(r.frequencyBinCount),Xp&&nm()}async function Bf(){Q.active=!1,Q.energy=0,Q.stream?.getTracks().forEach(e=>e.stop()),Q.context&&Q.context.state!==`closed`&&await Q.context.close(),Q.stream=null,Q.context=null,Q.analyser=null,Q.data=null}function Vf(){if(!Q.active||!Q.analyser||!Q.data)return 0;Q.analyser.getByteFrequencyData(Q.data);let e=0,t=Math.min(30,Q.data.length);for(let n=1;n<t;n+=1)e+=Q.data[n];let n=Hu((e/Math.max(1,t-1)-18)/105);return Q.energy=Uu(Q.energy,n,12,1/60),Q.energy}var Hf=0,Uf=0,Wf=0,Gf=0,Kf=0,qf=0,Jf=!1,$=0,Yf=0,Xf=0,Zf=0,Qf=performance.now(),$f=performance.now(),ep=0;function tp(e,t=1300){Iu.textContent=e,Iu.classList.add(`is-visible`),clearTimeout(ep),ep=setTimeout(()=>Iu.classList.remove(`is-visible`),t)}function np(){Qf=performance.now(),od.autoRotate=!1}function rp(e,t=!0){let n=kt.clamp(Number(e),0,X.length-1);Hf=n,Uf=n,Wf=n;let r=X[n];ju.textContent=`${r.zh} ${r.en}`,Mu.textContent=r.material,Nu.textContent=`μ ${r.viscosity.toFixed(2)} · σ ${r.tension.toFixed(2)} · FLOW ${r.flow.toFixed(2)}`,Pu.textContent=r.noteZh,Eu(`.mode-btn`).forEach((e,t)=>{let r=t===n;e.classList.toggle(`is-active`,r),e.setAttribute(`aria-pressed`,String(r))}),document.documentElement.style.setProperty(`--accent`,r.accent),document.documentElement.style.setProperty(`--accent-2`,r.floor),Gf=Math.max(Gf,.45),Kf=0,np(),Rf.ping(.72,n===3),t&&tp(`PHASE ${String(n+1).padStart(2,`0`)} // ${r.zh} ${r.en}`)}function ip(e=1){Gf=Math.max(Gf,e),Kf=0,Z.uPulse.value=Gf;let t=wd.getWorldPosition(new U);Df.spawn(t,new U(0,1,0),e*.75,Math.round(28+e*20)),Rf.ping(1.15*e,Hf===3),navigator.vibrate?.(Math.round(10+e*14)),np()}function ap(e,t,n,r=1){Z.uRipples.value[Zf].set(e.x,e.y,e.z,Xf),Zf=(Zf+1)%Z.uRipples.value.length,Z.uPointerVelocity.value=Math.max(Z.uPointerVelocity.value,r*.7),Af(t,n,r),Df.spawn(t,n,r,Math.round(24+r*18)),Gf=Math.max(Gf,.5*r),Rf.ping(.8+r*.35,Hf===3),navigator.vibrate?.(12)}var op=new ho,sp=new H,cp=new U(0,0,1),lp=new U(0,0,1),up=0,dp=0,fp=0,pp=new U,mp=new U,hp=new U(0,0,1),gp=!1,_p=0,vp=!1,yp=null,bp=0,xp={x:0,y:0,time:performance.now()},Sp=0,Cp=10,wp=285,Tp=24,Ep=null,Dp=null;function Op(e,t,n,r){let i=n-e,a=r-t;return i*i+a*a}function kp(e){if(Ep){if(e.pointerType!==Ep.pointerType){Ep.invalid=!0,Dp=null;return}Ep.maxTravelSq=Math.max(Ep.maxTravelSq,Op(Ep.startX,Ep.startY,e.clientX,e.clientY)),Ep.maxTravelSq>Cp*Cp&&(Ep.dragged=!0,Dp=null)}}function Ap(e){let t=Du.getBoundingClientRect();sp.x=(e.clientX-t.left)/t.width*2-1,sp.y=-((e.clientY-t.top)/t.height)*2+1}function jp(e){Ap(e),op.setFromCamera(sp,ad);let t=op.intersectObject(Ud,!1);if(!t.length)return null;let n=t[0],r=wd.worldToLocal(n.point.clone()).normalize(),i=wd.getWorldPosition(new U),a=n.point.clone().sub(i).normalize();return{...n,localPoint:r,worldNormal:a}}function Mp(e){lp.copy(e.localPoint);let t=performance.now(),n=Math.max(8,t-xp.time);if(bp=Hu(Math.hypot(sp.x-xp.x,sp.y-xp.y)/n*420),xp={x:sp.x,y:sp.y,time:t},vp&&gp){let t=e.localPoint.clone().sub(hp);t.addScaledVector(e.localPoint,-t.dot(e.localPoint));let n=Math.min(1.6,t.length()*26+bp*.32);t.lengthSq()>1e-7&&(t.normalize().multiplyScalar(n),mp.lerp(t,.74),_p=Math.min(1.65,_p+n*.12))}hp.copy(e.localPoint),gp=!0}Du.addEventListener(`pointermove`,e=>{if(yp!==null&&e.pointerId!==yp)return;kp(e);let t=jp(e);t?(Mp(t),dp=Jf?.06:vp?1.36:.15,Du.style.cursor=vp?`grabbing`:`crosshair`,vp&&performance.now()-Sp>90&&(Df.spawn(t.point,t.worldNormal,.25+bp*.35,5),Sp=performance.now())):(dp=Jf?0:vp?.78:0,Du.style.cursor=vp?`grabbing`:`grab`)},{passive:!0}),Du.addEventListener(`pointerdown`,e=>{if(yp!==null){Ep&&(Ep.invalid=!0),Dp=null;return}let t=jp(e);if(!t){Dp=null,od.enabled=!0,np();return}if(e.preventDefault(),yp=e.pointerId,Ep={pointerType:e.pointerType,startX:e.clientX,startY:e.clientY,maxTravelSq:0,dragged:!1,invalid:!1},Du.setPointerCapture?.(e.pointerId),Jf){od.enabled=!0,cp.copy(t.localPoint),lp.copy(t.localPoint),Df.spawn(t.point,t.worldNormal,.42,14),Gf=Math.max(Gf,.46),Rf.ping(.68,!0),np();return}vp=!0,Du.classList.add(`is-sculpting`),od.enabled=!1,gp=!1,mp.set(0,0,0),pp.set(0,0,0),_p=.18,Mp(t),dp=1.36,ap(t.localPoint,t.point,t.worldNormal,.85+X[Hf].swell*.15),np()},{passive:!1});function Np(e,t){if(t&&(Dp=null),yp===null||e.pointerId!==yp)return;let n=Ep;t||kp(e);let r=!t&&n&&!n.invalid&&!n.dragged?jp(e):null,i=vp;if(vp=!1,Du.classList.remove(`is-sculpting`),od.enabled=!0,dp=0,yp!==null&&Du.releasePointerCapture?.(yp),yp=null,Ep=null,i){let e=Math.min(1.7,.35+_p+bp*.45);Z.uReleasePoint.value.copy(cp),Z.uReleaseVector.value.copy(pp.lengthSq()>1e-4?pp:mp),Z.uReleaseTime.value=Xf,Z.uReleaseEnergy.value=e,mp.set(0,0,0),gp=!1,Gf=Math.max(Gf,.34+e*.18)}if(t||!n||n.invalid||n.dragged||!r){Dp=null;return}let a={pointerType:e.pointerType,time:e.timeStamp,x:e.clientX,y:e.clientY,origin:r.localPoint.clone()};if(!Dp){Dp=a;return}let o=Dp;Dp=null;let s=a.time-o.time;if(s>wp){Dp=a;return}s>=0&&a.pointerType===o.pointerType&&Op(o.x,o.y,a.x,a.y)<=Tp*Tp&&Pp(a.origin)}Du.addEventListener(`pointerup`,e=>Np(e,!1),{passive:!0}),Du.addEventListener(`pointercancel`,e=>Np(e,!0),{passive:!0}),Du.addEventListener(`pointerleave`,()=>{vp||(dp=0)},{passive:!0});function Pp(e=cp){if(Jf=!Jf,Yf=+!!Jf,qf=+!!Jf,Gf=Math.max(Gf,1),Jf){let t=e.clone().normalize();Z.uFreezeOrigin.value.copy(t),Z.uFreezeTime.value=Xf,Vd(t),Bd.visible=!0,Fd.visible=!0,Fu.textContent=`CRYSTAL`,Fu.classList.add(`is-crystal`);let n=wd.localToWorld(t.multiplyScalar(1.64));Df.spawn(n,n.clone().sub(wd.getWorldPosition(new U)).normalize(),1.05,54)}else Fu.textContent=`LIQUID`,Fu.classList.remove(`is-crystal`),Z.uReleasePoint.value.copy(Z.uFreezeOrigin.value),Z.uReleaseVector.value.copy(Z.uFreezeOrigin.value).cross(new U(.2,1,.3)).normalize(),Z.uReleaseTime.value=Xf,Z.uReleaseEnergy.value=1.15;Rf.ping(1.25,!0),tp(Jf?`PHASE TRANSITION // 晶核扩散`:`PHASE TRANSITION // 晶格熔解`),np()}window.addEventListener(`keydown`,e=>{e.target instanceof HTMLInputElement||e.target instanceof HTMLButtonElement||(e.code===`Space`?(e.preventDefault(),ip(1)):/^Digit[1-4]$/.test(e.code)?rp(Number(e.code.slice(-1))-1):e.key.toLowerCase()===`f`?Lp():e.key.toLowerCase()===`m`&&Tu(`#mic-toggle`).click())}),Eu(`.mode-btn`).forEach(e=>e.addEventListener(`click`,()=>rp(e.dataset.mode))),Tu(`#audio-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;try{Rf.active?(Rf.stop(),t.textContent=`声场 OFF`,t.setAttribute(`aria-pressed`,`false`),tp(`GENERATIVE SOUND FIELD // OFF`)):(await Rf.start(),t.textContent=`声场 ON`,t.setAttribute(`aria-pressed`,`true`),tp(`GENERATIVE SOUND FIELD // ON`),ip(.55))}catch(e){tp(`AUDIO ERROR // ${e.message}`)}}),Tu(`#mic-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{Q.active?(await Bf(),t.textContent=`MIC OFF`,t.setAttribute(`aria-pressed`,`false`),tp(`MIC REACTIVITY // OFF`)):(await zf(),t.textContent=`MIC LIVE`,t.setAttribute(`aria-pressed`,`true`),tp(`MIC REACTIVITY // LIVE`),ip(.7))}catch(e){tp(`MIC DENIED // ${e.message}`)}finally{t.disabled=!1}});function Fp(e){Lu.hidden=!e,Tu(`#panel-toggle`).setAttribute(`aria-expanded`,String(e))}Tu(`#panel-toggle`).addEventListener(`click`,()=>Fp(Lu.hidden)),Tu(`#panel-close`).addEventListener(`click`,()=>Fp(!1)),[[`deform`,`userDeform`,2],[`speed`,`userSpeed`,2],[`outline`,`outline`,2],[`bloom`,`bloom`,2],[`chroma`,`chroma`,2],[`flow`,`flow`,2],[`liveliness`,`liveliness`,2]].forEach(([e,t,n])=>{let r=Tu(`#${e}`),i=Tu(`#${e}-out`);r.addEventListener(`input`,()=>{nd[t]=Number(r.value),i.value=nd[t].toFixed(n),i.textContent=i.value,np()})}),Tu(`#reset-params`).addEventListener(`click`,()=>{Object.entries({deform:1,speed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1}).forEach(([e,t])=>{let n=Tu(`#${e}`);n.value=t,n.dispatchEvent(new Event(`input`))}),tp(`MATERIAL PARAMETERS RESET`)}),Eu(`.quality`).forEach(e=>e.addEventListener(`click`,()=>Ip(e.dataset.quality)));function Ip(e){nd.quality=e;let t=Math.min(window.devicePixelRatio||1,{high:1.5,medium:1.25,low:1}[e]);rd.setPixelRatio(t),If.enabled=e!==`low`,rd.shadowMap.enabled=e!==`low`,yf.setDrawRange(0,e===`high`?hf:e===`medium`?700:430),Eu(`.quality`).forEach(t=>t.classList.toggle(`is-active`,t.dataset.quality===e)),Rp(),tp(`RENDER QUALITY // ${e.toUpperCase()}`)}function Lp(){document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.(),np()}Tu(`#fullscreen`).addEventListener(`click`,Lp),Tu(`#capture`).addEventListener(`click`,()=>{um(),Mf.render(),Du.toBlob(e=>{if(!e){tp(`CAPTURE FAILED`);return}let t=document.createElement(`a`);t.download=`mizu-kokoro-${X[Hf].en.toLowerCase()}-${Date.now()}.png`,t.href=URL.createObjectURL(e),t.click(),setTimeout(()=>URL.revokeObjectURL(t.href),1e3),tp(`FRAME CAPTURED // PNG`)},`image/png`)});function Rp(){let e=Math.max(1,window.innerWidth),t=Math.max(1,window.innerHeight);ld(e,t),ad.aspect=e/t,ad.updateProjectionMatrix(),rd.setSize(e,t,!1),Mf.setSize(e,t);let n=rd.getPixelRatio(),r={high:.82,medium:.66,low:.5}[nd.quality]||.66,i=Math.max(1,Math.floor(e*n*r)),a=Math.max(1,Math.floor(t*n*r));pd.setSize(i,a),Z.uResolution.value.set(i,a),Ff.uniforms.uResolution.value.set(e*n,t*n)}window.addEventListener(`resize`,Rp,{passive:!0});var zp=performance.now(),Bp=performance.now(),Vp=0,Hp=!1,Up=0,Wp=0,Gp=0,Kp=null,qp=0,Jp=document.hidden,Yp=!1,Xp=null,Zp=new Set,Qp=new Set,$p=Promise.resolve();function em(e){$u(`stats`,{fps:Wp,frameTimeMs:Gp,frameCount:Up,paused:e})}async function tm(){for(;;){let e=Xp;if(e){for(let e of[Rf.context,Q.context])e?.state===`running`&&Zp.add(e);for(let e of Q.stream?.getAudioTracks()??[])e.enabled&&e.readyState===`live`&&(Qp.add(e),e.enabled=!1);await Promise.all([...Zp].map(e=>e.state===`running`?e.suspend():void 0))}else{await Promise.all([...Zp].map(e=>e.state===`suspended`?e.resume():void 0));for(let e of Qp)e.readyState===`live`&&(e.enabled=!0)}if(Xp===e){e||(Zp.clear(),Qp.clear());return}}}function nm(){$p=$p.then(tm).catch(e=>{console.error(`Orb runtime audio transition failed.`,e)})}function rm(){Vu||Xp||Kp!==null||(Kp=requestAnimationFrame(mm))}function im(){let e=Jp||Yp;if(Xp===e)return;if(Xp=e,Xp){Kp!==null&&(cancelAnimationFrame(Kp),Kp=null),nm(),em(!0);return}let t=performance.now();zp=t,Qf=t,$f=t,Bp=t,Vp=0,nm(),em(!1),rm()}function am(e){Yp=e,im()}function om(){Jp=document.hidden,im()}function sm(e){let t=X[Uf],n=1-Math.exp(-e*3.4);Z.uDeepColor.value.lerp(t.deepColor,n),Z.uMidColor.value.lerp(t.midColor,n),Z.uLightColor.value.lerp(t.lightColor,n),Z.uAccentColor.value.lerp(t.accentColor,n),Z.uInkColor.value.lerp(t.inkColor,n),sf.uColor.value.lerp(t.floorColor,n),lf.uColor.value.lerp(t.backdropColor,n),pf.uColor.value.lerp(t.backdropColor,n),bf.uColor.value.lerp(t.floorColor,n),Df.uniforms.uColor.value.lerp(t.accentColor,n),Cf.color.lerp(t.midColor,n),Kd.color.lerp(t.accentColor,n),tf.color.lerp(t.floorColor,n),rf.color.lerp(t.floorColor,n),Zd.emissive.lerp(t.floorColor,n),$d.uColor.value.lerp(t.floorColor,n),Pd.color.lerp(t.lightColor,n),zd.color.lerp(t.lightColor,n),ff.forEach(e=>e.color.lerp(t.floorColor,n)),Of.forEach(e=>e.mesh.material.color.lerp(t.accentColor,n)),dd.color.lerp(t.lightColor,n*.35),fd.color.lerp(t.accentColor,n*.45)}function cm(e){let t=X[Uf];$=Uu($,Yf,Jf?2.45:3.6,e),Math.abs($-Yf)<5e-4&&($=Yf),Z.uFreezeProgress.value=$,Z.uMode.value=Uu(Z.uMode.value,Wf,3.2,e),Z.uDeform.value=Uu(Z.uDeform.value,t.deform*nd.userDeform,4,e),Z.uTension.value=Uu(Z.uTension.value,t.tension,4.2,e),Z.uViscosity.value=Uu(Z.uViscosity.value,t.viscosity,4,e),Z.uSwell.value=Uu(Z.uSwell.value,t.swell,4,e),Z.uFlowStrength.value=Uu(Z.uFlowStrength.value,t.flow*nd.flow,4,e),Z.uTurbulence.value=Uu(Z.uTurbulence.value,t.turbulence,4,e),Z.uFoam.value=Uu(Z.uFoam.value,t.foam,4,e),Z.uClarity.value=Uu(Z.uClarity.value,t.clarity,4,e),Z.uElasticity.value=Uu(Z.uElasticity.value,t.elasticity*nd.liveliness,4,e),Z.uShear.value=Uu(Z.uShear.value,t.shear,4,e),Z.uRimStrength.value=Uu(Z.uRimStrength.value,t.rim,4,e),Z.uFacet.value=Uu(Z.uFacet.value,qf*$,5,e),Z.uOutlineThickness.value=Uu(Z.uOutlineThickness.value,.046*nd.outline,5,e);let n=.86+(1-t.clarity)*.075+(Hf===3?.025:0);Z.uOpacity.value=Uu(Z.uOpacity.value,n,4,e);let r=nd.quality===`low`?.72:1;Pf.strength=Uu(Pf.strength,(t.bloom+$*.24)*nd.bloom*r,4,e),Pf.radius=Uu(Pf.radius,Hf===3||$>.5?.16:.28,4,e),Ff.uniforms.uChroma.value=Uu(Ff.uniforms.uChroma.value,75e-5*(t.chroma+$*.42)*nd.chroma,5,e),Ff.uniforms.uPosterize.value=Uu(Ff.uniforms.uPosterize.value,Math.min(.92,t.posterize+$*.08),4,e),Zd.emissiveIntensity=Uu(Zd.emissiveIntensity,.07+Gf*.18+$*.08,4,e);let i=$>.002;Nd.visible=i,Fd.visible=i,Bd.visible=i&&Bd.userData.vertexCount>0,Pd.opacity=$*(.16+Gf*.08),zd.opacity=$*(.54+Gf*.22),Rd.setDrawRange(0,Math.floor(Bd.userData.vertexCount*$)),Kd.opacity=.28*(1-$*.88)}function lm(e){let t=X[Hf],n=1-$*.88;Gd.rotation.y+=e*(.19+t.speed*.12)*n,Gd.rotation.x=Math.sin(Xf*.21)*.14*n,qd.rotation.x+=e*.23*n,qd.rotation.y-=e*.31*n,qd.scale.setScalar(1+Gf*.07+Z.uAudio.value*.08),Fd.rotation.y-=e*.08*$,Fd.rotation.x=Math.sin(Xf*.16)*.08*$,Id.forEach((t,n)=>{let r=.82+Math.sin(Xf*.9+t.userData.phase+n*.17)*.12,i=$*r;t.scale.copy(t.userData.baseScale).multiplyScalar(i),t.rotation.y+=e*(.018+n*8e-4)*$}),wd.rotation.y+=e*kt.lerp(.028,.006,$),wd.rotation.x=Math.sin(Xf*.19)*kt.lerp(.027,.006,$);let r=kt.lerp(.048,.015,$),i=Math.sin(Xf*.72)*(Ru?.012:r);wd.position.y=.48+i,df.rotation.y+=e*.045,df.rotation.z=Math.sin(Xf*.12)*.08,df.children.forEach((t,n)=>{t.rotation.z+=e*(.025+n*.013)*(n%2?-1:1),t.material.opacity=.13-n*.02+Gf*.1+Z.uAudio.value*.12+$*.04});let a=(.34+t.flow*.78)*(1-t.viscosity*.32);Cf.opacity=kt.lerp(.72,.42,$),Ef.forEach((e,n)=>{let r=e.phase+Xf*e.speed*a,i=Math.sin(Xf*(.52+t.turbulence*.46)+e.phase)*(.08+t.swell*.1);e.mesh.position.set(Math.cos(r)*(e.radius+i),.45+Math.sin(r*(1.45+t.swell*.35)+e.phase)*e.yAmp,Math.sin(r)*e.radius*(.55+e.tilt*.15)),e.mesh.rotation.set(r*.7,r*1.3+n,r*.35);let o=1+Z.uAudio.value*(.18+n%4*.04),s=e.scale*o,c=1+t.viscosity*1.35+t.swell*.22,l=1+t.swell*.24;e.mesh.scale.set(s/l,s*c,s/l)}),ef.rotation.z+=e*(.012+t.flow*.018)*(1-$*.72),Of.forEach(n=>{if(n.life<=0)return;let r=kt.lerp(1.35,.62,t.viscosity);n.life=Math.max(0,n.life-e*r);let i=1-n.life,a=3.1+t.tension*.72+t.swell*.55,o=kt.lerp(.08,a*n.intensity,1-(1-i)**2);n.mesh.scale.setScalar(o),n.mesh.material.opacity=n.life*n.life*(.72+t.tension*.12),n.life===0&&(n.mesh.visible=!1)}),Df.update(e)}function um(){let e=wd.visible;wd.visible=!1,rd.setRenderTarget(pd),rd.clear(),rd.render(id,ad),rd.setRenderTarget(null),wd.visible=e}function dm(e=0){um(),Mf.render(e),qp+=1}function fm(){let e=new U;ad.getWorldDirection(e),uf.position.copy(od.target).addScaledVector(e,4.2),uf.quaternion.copy(ad.quaternion),mf.quaternion.copy(ad.quaternion),mf.position.copy(od.target).addScaledVector(e,.25)}function pm(){let e=performance.now(),t=e-Qf;t>15e3&&(od.autoRotate=!0,dp=Jf?0:.1,lp.set(Math.sin(Xf*.27),Math.sin(Xf*.19+1.4)*.65,Math.cos(Xf*.27)).normalize()),t>3e4&&e-$f>17e3&&(rp((Hf+1)%X.length,!1),$f=e,Qf=e-2e4)}function mm(e=performance.now()){if(Kp=null,Xp)return;let t=Math.min(Math.max((e-zp)/1e3,0),.05);zp=e;let n=X[Hf],r=Ru?.34:1;Xf+=t*n.speed*nd.userSpeed*r,Z.uTime.value=Xf,Ff.uniforms.uTime.value=Xf,pm(),sm(t),cm(t);let i=vp?kt.lerp(20,8,n.viscosity):6.5;cp.lerp(lp,1-Math.exp(-t*i)),cp.normalize(),Z.uTouchPoint.value.copy(cp);let a=vp?185:42*n.recovery*Math.max(.25,nd.liveliness),o=vp?.92:kt.clamp((.24+n.viscosity*1.02)/Math.sqrt(Math.max(.22,n.elasticity*nd.liveliness)),.18,1.42),s=2*Math.sqrt(a)*o,c=(dp-up)*a-fp*s;if(fp+=c*t,up=kt.clamp(up+fp*t,-.52,1.46),$>.72&&(up*=Math.exp(-t*10),fp*=Math.exp(-t*10)),Z.uTouchStrength.value=up,!vp){let e=kt.lerp(10.5,2,n.viscosity);mp.multiplyScalar(Math.exp(-t*e))}let l=kt.lerp(18,5.2,n.viscosity);pp.lerp(mp,1-Math.exp(-t*l)),$>.35&&pp.multiplyScalar(Math.exp(-t*8*$)),Z.uDragVector.value.copy(pp).multiplyScalar(nd.liveliness),bp=Uu(bp,0,7,t),Z.uPointerVelocity.value=Uu(Z.uPointerVelocity.value,bp,12,t),Gf=Uu(Gf,Kf,3.3,t),Z.uPulse.value=Gf,Rf.update(n,Xf,Gf);let u=Vf(),d=Q.active?u:Rf.visualEnergy;Z.uAudio.value=Uu(Z.uAudio.value,d,Q.active?11:5,t),fd.intensity=20+Gf*15+Z.uAudio.value*18+$*8,dd.intensity=48+Gf*18+$*7,nf.scale.setScalar(1+Gf*.04+Z.uAudio.value*.025+$*.018),tf.opacity=.55+Gf*.35+Z.uAudio.value*.25+$*.08,lm(t),od.update(t),fm(),dm(t),Up+=1,Vp+=1;let f=e-Bp;f>=500&&(Wp=Vp*1e3/f,Gp=f/Vp,ku.textContent=`${Math.round(Wp)} FPS`,em(!1),Bp=e,Vp=0),Hp||(Hp=!0,setTimeout(()=>Ou.classList.add(`is-hidden`),280)),rm()}function hm(e){return{object:e,position:e.position.clone(),quaternion:e.quaternion.clone(),scale:e.scale.clone(),visible:e.visible}}function gm(e){e.object.position.copy(e.position),e.object.quaternion.copy(e.quaternion),e.object.scale.copy(e.scale),e.object.visible=e.visible,e.object.updateMatrix(),e.object.matrixWorldNeedsUpdate=!0}function _m(){Df.cursor=0,Df.positions.fill(0);for(let e=0;e<Df.max;e+=1)Df.positions[e*3+1]=-999;Df.velocities.fill(0),Df.life.fill(0),Df.size.fill(0),Df.geometry.attributes.position.needsUpdate=!0,Df.geometry.attributes.aLife.needsUpdate=!0,Df.geometry.attributes.aSize.needsUpdate=!0}function vm(e,t,n){let r=X[e],i=Ru?.34:1;Hf=e,Uf=e,Wf=e,Gf=0,Kf=0,qf=+(t>0),Jf=t>0,$=t,Yf=t,Xf=n/1e3*r.speed*nd.userSpeed*i,Zf=0,Qf=n,$f=n,up=0,dp=0,fp=0,cp.set(0,0,1),lp.set(0,0,1),pp.set(0,0,0),mp.set(0,0,0),hp.set(0,0,1),gp=!1,_p=0,vp=!1,yp=null,Ep=null,bp=0,xp={x:0,y:0,time:n},Sp=0,Dp=null,Du.classList.remove(`is-sculpting`),Z.uTime.value=Xf,Z.uDeform.value=r.deform*nd.userDeform,Z.uTouchStrength.value=0,Z.uPointerVelocity.value=0,Z.uPulse.value=0,Z.uAudio.value=0,Z.uTension.value=r.tension,Z.uMode.value=e,Z.uViscosity.value=r.viscosity,Z.uSwell.value=r.swell,Z.uFlowStrength.value=r.flow*nd.flow,Z.uTurbulence.value=r.turbulence,Z.uFoam.value=r.foam,Z.uClarity.value=r.clarity,Z.uElasticity.value=r.elasticity*nd.liveliness,Z.uShear.value=r.shear,Z.uTouchPoint.value.set(0,0,1),Z.uDragVector.value.set(0,0,0),Z.uReleasePoint.value.set(0,0,1),Z.uReleaseVector.value.set(0,0,0),Z.uReleaseTime.value=-100,Z.uReleaseEnergy.value=0,Z.uFreezeProgress.value=t,Z.uFreezeOrigin.value.set(0,0,1),Z.uFreezeTime.value=Xf,Z.uRipples.value.forEach(e=>e.set(0,0,1,-100)),Z.uDeepColor.value.copy(r.deepColor),Z.uMidColor.value.copy(r.midColor),Z.uLightColor.value.copy(r.lightColor),Z.uAccentColor.value.copy(r.accentColor),Z.uInkColor.value.copy(r.inkColor),Z.uRimStrength.value=r.rim,Z.uFacet.value=t,Z.uOpacity.value=.86+(1-r.clarity)*.075+(e===3?.025:0),Z.uOutlineThickness.value=.046*nd.outline,sf.uColor.value.copy(r.floorColor),lf.uColor.value.copy(r.backdropColor),pf.uColor.value.copy(r.backdropColor),bf.uColor.value.copy(r.floorColor),Df.uniforms.uColor.value.copy(r.accentColor),Cf.color.copy(r.midColor),Kd.color.copy(r.accentColor),tf.color.copy(r.floorColor),rf.color.copy(r.floorColor),Zd.emissive.copy(r.floorColor),$d.uColor.value.copy(r.floorColor),Pd.color.copy(r.lightColor),zd.color.copy(r.lightColor),ff.forEach(e=>e.color.copy(r.floorColor)),Of.forEach(e=>{e.life=0,e.mesh.visible=!1,e.mesh.material.color.copy(r.accentColor)}),kf=0,dd.color.copy(r.lightColor),fd.color.copy(r.accentColor);let a=nd.quality===`low`?.72:1;Pf.strength=(r.bloom+t*.24)*nd.bloom*a,Pf.radius=e===3||t>.5?.16:.28,Ff.uniforms.uTime.value=Xf,Ff.uniforms.uChroma.value=75e-5*(r.chroma+t*.42)*nd.chroma,Ff.uniforms.uPosterize.value=Math.min(.92,r.posterize+t*.08),Zd.emissiveIntensity=.07+t*.08,Vd(Z.uFreezeOrigin.value);let o=t>.002;Nd.visible=o,Fd.visible=o,Bd.visible=o&&Bd.userData.vertexCount>0,Pd.opacity=t*.16,zd.opacity=t*.54,Rd.setDrawRange(0,Math.floor(Bd.userData.vertexCount*t)),Kd.opacity=.28*(1-t*.88),Rf.visualEnergy=0,Q.energy=0,_m(),lm(0),fm()}function ym(){let e=rd.getRenderTarget(),t=[Mf.readBuffer,Mf.writeBuffer,Pf.renderTargetBright,...Pf.renderTargetsHorizontal,...Pf.renderTargetsVertical];for(let e of t)rd.setRenderTarget(e),rd.clear();rd.setRenderTarget(e)}async function bm(e){let t=await crypto.subtle.digest(`SHA-256`,e);return[...new Uint8Array(t)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}async function xm(){let e=rd.getContext(),t=e.drawingBufferWidth,n=e.drawingBufferHeight,r=new Uint8Array(t*n*4);e.finish(),e.readPixels(0,0,t,n,e.RGBA,e.UNSIGNED_BYTE,r);let i=new TextEncoder().encode(`rgba8\0`),a=new Uint8Array(i.length+8+r.length);a.set(i,0);let o=new DataView(a.buffer,i.length,8);o.setUint32(0,t,!1),o.setUint32(4,n,!1);let s=t*4;for(let e=0;e<n;e+=1){let t=n-1-e;a.set(r.subarray(e*s,(e+1)*s),i.length+8+t*s)}return{width:t,height:n,hash:await bm(a)}}function Sm(){if(!Vu)return;let e=[];id.traverse(t=>e.push(hm(t)));let t=null,n=null,r=null,i=!1;window.__MIZU_KOKORO_STEP__=async a=>{if(!Qu(a,[`mode`,`freezeProgress`,`timestamp`]))throw Error(`MIZU_KOKORO_STEP input must contain exactly mode, freezeProgress, and timestamp`);if(!Number.isInteger(a.mode)||a.mode<0||a.mode>=X.length)throw Error(`MIZU_KOKORO_STEP mode must be an integer from 0 through 3`);if(!Number.isFinite(a.freezeProgress)||a.freezeProgress<0||a.freezeProgress>1)throw Error(`MIZU_KOKORO_STEP freezeProgress must be a finite number from 0 through 1`);if(!Number.isFinite(a.timestamp)||a.timestamp<0)throw Error(`MIZU_KOKORO_STEP timestamp must be a finite non-negative number`);if(i)throw Error(`MIZU_KOKORO_STEP does not allow concurrent calls`);i=!0;try{let i=rd.getDrawingBufferSize(new H);if(r===null&&(t=hm(ad),n=od.target.clone(),r=Object.freeze({width:window.innerWidth,height:window.innerHeight,devicePixelRatio:window.devicePixelRatio,rendererPixelRatio:rd.getPixelRatio(),drawingBufferWidth:i.x,drawingBufferHeight:i.y,refractionWidth:pd.width,refractionHeight:pd.height,quality:nd.quality})),window.innerWidth!==r.width||window.innerHeight!==r.height||window.devicePixelRatio!==r.devicePixelRatio||rd.getPixelRatio()!==r.rendererPixelRatio||i.x!==r.drawingBufferWidth||i.y!==r.drawingBufferHeight||pd.width!==r.refractionWidth||pd.height!==r.refractionHeight||nd.quality!==r.quality)throw Error(`MIZU_KOKORO_STEP capture environment changed after initialization`);if(Rf.context!==null||Q.context!==null)throw Error(`MIZU_KOKORO_STEP requires untouched audio and microphone state`);Kp!==null&&(cancelAnimationFrame(Kp),Kp=null),e.forEach(gm),gm(t),od.target.copy(n),od.enabled=!1,od.autoRotate=!1,zp=a.timestamp,Bp=a.timestamp,Vp=0,Up=0,Wp=0,Gp=0,rd.setRenderTarget(null),vm(a.mode,a.freezeProgress,a.timestamp),ym();let o=qp;dm(0);let s=await xm(),c=qp-o,l=Kp===null?0:1;if(c!==1||l!==0)throw Error(`MIZU_KOKORO_STEP violated the single-frame scheduler contract`);return{input:{...a},logicalFrameDelta:c,queuedAnimationFrames:l,framebuffer:s}}finally{i=!1}}}Ip(nd.quality),rp(0,!1),Rp(),Sm(),document.addEventListener(`visibilitychange`,om),Xu&&(window.addEventListener(`message`,td),$u(`ready`,{capabilities:[...Yu]})),im();
//# sourceMappingURL=index-_rlKhznJ.js.map