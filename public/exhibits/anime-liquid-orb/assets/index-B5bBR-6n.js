...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(e,t,n){let r=new Float32Array(Io),i=new H(0,1,0);return new la({name:`SphericalGaussianBlur`,defines:{n:Io,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$o(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zo(){return new la({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$o(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qo(){return new la({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$o(),fragmentShader:`
	...
	`}var es=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Tc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ec(e,t){let n=Tc[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Dc=new H;function Oc(){return W.getLuminanceCoefficients(Dc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Dc.x.toFixed(4)}, ${Dc.y.toFixed(4)}, ${Dc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=_c(i,i.VERTEX_SHADER,y),S=_c(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Cc(i,x,`vertex`),n=Cc(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},lu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},uu=new Ya(-1,1,1,-1,0,1),du=new class extends Ar{constructor(){super(),this.setAttribute(`position`,new K([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new K([0,2,0,0,2,0],2))}},fu=class{constructor(e){this._mesh=new $r(du,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,uu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},pu=class extends lu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof la?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=oa.clone(e.uniforms),this.material=new la({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new fu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},mu=class extends lu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},hu=class extends lu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},gu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new V);this._width=n.width,this._height=n.height,t=new Xt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new pu(cu),this.copyPass.material.blending=0,this.timer=new eo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}mu!==void 0&&(r instanceof mu?n=!0:r instanceof hu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new V);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},_u=class extends lu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new G}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},vu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new G(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};yu.BlurDirectionX=new V(1,0),yu.BlurDirectionY=new V(0,1);var bu={name:`SMAAEdgesShader`,defines:{SMAA_THRESHOLD:`0.1`},uniforms:{tDiffuse:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},xu={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},Su={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},Tu=class extends lu{constructor(){super(),this.isOutputPass=!0,this.uniforms=oa.clone(wu.uniforms),this.material=new ua({name:wu.name,uniforms:this.uniforms,vertexShader:wu.vertexShader,fragmentShader:wu.fragmentShader}),this._fsQuad=new fu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},W.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Eu=e=>document.querySelector(e),Du=e=>[...document.querySelectorAll(e)],Ou=Eu(`#scene`),ku=Eu(`#loading`),Au=Eu(`#fps`),ju=Eu(`#pipeline`),Mu=Eu(`#state-name`),Nu=Eu(`#material-type`),Pu=Eu(`#material-metrics`),Fu=Eu(`#material-note`),Iu=Eu(`#matter-state`),Lu=Eu(`#toast`),Ru=Eu(`#lab-panel`),zu=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,Bu=window.matchMedia(`(pointer: coarse)`).matches,Vu=new URLSearchParams(window.location.search).getAll(`qa`),Hu=Vu.length===1&&Vu[0]===`1`,Uu=e=>At.clamp(e,0,1),Wu=(e,t,n,r)=>At.damp(e,t,n,r),Gu=e=>new G(e);function Ku(e){let t=e>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}var qu=Hu?Ku(1296652885):Math.random,Ju=`shader-demo-room`,Yu=1,Xu=Object.freeze([`pause`,`stats`,`set-mode`,`set-quality`]),Zu=window.parent===window?null:Object.freeze({instanceId:crypto.randomUUID(),targetOrigin:location.origin});function Qu(e){return typeof e==`object`&&!!e&&!Array.isArray(e)&&Object.getPrototypeOf(e)===Object.prototype}function $u(e,t){if(!Qu(e))return!1;let n=Object.keys(e).sort(),r=[...t].sort();return n.length===r.length&&n.every((e,t)=>e===r[t])}function ed(e,t){Zu&&window.parent.postMessage({context:Ju,v:Yu,instanceId:Zu.instanceId,type:e,payload:t},Zu.targetOrigin)}function td(e,t){if(e===`set-paused`){if(!$u(t,[`paused`])||typeof t.paused!=`boolean`)throw Error(`Invalid set-paused payload`);return}if(e===`set-orb-mode`){if(!$u(t,[`mode`])||!Number.isInteger(t.mode)||t.mode<0||t.mode>3)throw Error(`Invalid set-orb-mode payload`);return}if(e===`set-orb-quality`){if(!$u(t,[`quality`])||![`high`,`medium`,`low`].includes(t.quality))throw Error(`Invalid set-orb-quality payload`);return}throw Error(`Unknown embedded command: ${String(e)}`)}function nd(e){if(!Zu||e.origin!==location.origin||e.source!==window.parent)return;let t=e.data;if(!$u(t,[`context`,`v`,`instanceId`,`type`,`payload`]))throw Error(`Invalid embedded command envelope`);if(t.context!==Ju||t.v!==Yu)throw Error(`Embedded command envelope does not match this runtime`);if(t.instanceId===Zu.instanceId){if(typeof t.type!=`string`)throw Error(`Embedded command type must be a string`);td(t.type,t.payload),t.type===`set-paused`?sm(t.payload.paused):t.type===`set-orb-mode`?ap(t.payload.mode):t.type===`set-orb-quality`&&Rp(t.payload.quality)}}var Y=[{zh:`静水`,en:`CALM`,material:`AQUEOUS / WATER`,deep:`#031522`,mid:`#14c8ef`,light:`#efffff`,accent:`#68f2ff`,ink:`#01070d`,floor:`#48ebff`,backdrop:`#0f708c`,deform:.78,speed:.78,bloom:.46,chroma:.25,posterize:0,rim:1.02,viscosity:.16,tension:.92,swell:.18,flow:.35,turbulence:.18,foam:.08,clarity:.94,elasticity:1.08,recovery:1.22,shear:.72,note:55,noteZh:`高表面张力、清澈折射与短促毛细波。`},{zh:`涨潮`,en:`SURGE`,material:`OCEANIC / BREAKER`,deep:`#1b0923`,mid:`#ec3b9b`,light:`#fff7df`,accent:`#ffb72f`,ink:`#10030d`,floor:`#ff56ba`,backdrop:`#8b2859`,deform:1.34,speed:1.16,bloom:.72,chroma:.72,posterize:0,rim:1.17,viscosity:.07,tension:.54,swell:1,flow:1.2,turbulence:.92,foam:1,clarity:.62,elasticity:.82,recovery:.92,shear:1.22,note:65.41,noteZh:`低黏度大惯性浪涌，陡峭波峰与破碎泡沫。`},{zh:`绽生`,en:`BLOOM`,material:`VISCOUS / PROTOPLASM`,deep:`#061b19`,mid:`#35dea8`,light:`#f4ffed`,accent:`#b2ff4d`,ink:`#02100d`,floor:`#63ffc3`,backdrop:`#1b826b`,deform:1.12,speed:.72,bloom:.6,chroma:.42,posterize:0,rim:1.1,viscosity:.9,tension:.7,swell:.34,flow:.76,turbulence:.28,foam:.12,clarity:.48,elasticity:.38,recovery:.34,shear:1.52,note:73.42,noteZh:`高黏度活体胶质，形变滞留并拉出缓慢流丝。`},{zh:`零界`,en:`VOID`,material:`METALLIC / SUPERCOOLED`,deep:`#010204`,mid:`#9eabb5`,light:`#ffffff`,accent:`#ff3a52`,ink:`#000000`,floor:`#e4fbff`,backdrop:`#677984`,deform:.68,speed:.6,bloom:.39,chroma:1.08,posterize:.72,rim:1.42,viscosity:.24,tension:1.24,swell:.08,flow:.16,turbulence:.12,foam:0,clarity:.72,elasticity:1.34,recovery:1.48,shear:.58,note:41.2,noteZh:`超冷却金属水体，流动稀少、回弹尖锐并带离散扫描。`}].map(e=>({...e,deepColor:Gu(e.deep),midColor:Gu(e.mid),lightColor:Gu(e.light),accentColor:Gu(e.accent),inkColor:Gu(e.ink),floorColor:Gu(e.floor),backdropColor:Gu(e.backdrop)})),rd={userDeform:1,userSpeed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1,quality:Bu?`medium`:`high`},X;try{X=new Rl({canvas:Ou,antialias:!1,alpha:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!0})}catch(e){throw ku.innerHTML=`<p>WEBGL INITIALIZATION FAILED<br>${String(e.message||e)}</p>`,e}X.setClearColor(198157,1),X.outputColorSpace=Ve,X.toneMapping=4,X.toneMappingExposure=.86,X.shadowMap.enabled=!0,X.shadowMap.type=1,X.debug.checkShaderErrors=!0,ju.textContent=X.capabilities.isWebGL2?`WEBGL2 / GLSL`:`WEBGL / GLSL`;var id=new Ln;id.background=new G(198157),id.fog=new In(198157,.042);var ad=new Wa(42,1,.05,80);ad.position.set(0,1.05,8.1);var od=new Yl(ad,Ou);od.target.set(0,.42,0),od.enableDamping=!0,od.dampingFactor=.055,od.enablePan=!1,od.minDistance=5.2,od.maxDistance=10.2,od.minPolarAngle=.72,od.maxPolarAngle=1.72,od.minAzimuthAngle=-1,od.maxAzimuthAngle=1,od.autoRotate=!1,od.autoRotateSpeed=.35,od.update();var sd=Object.freeze({default:Object.freeze({fov:42,targetY:.42,offsetY:.63,positionZ:8.1}),portrait:Object.freeze({fov:42,targetY:.05,offsetY:.62,positionZ:10.18}),compact:Object.freeze({fov:58,targetY:-.65,offsetY:.54,positionZ:10.18})}),cd=``;function ld(e,t){let n=e<=420?t<=520?`compact`:`portrait`:`default`;if(n===cd)return;let r=sd[n],i=Math.hypot(r.offsetY,r.positionZ);if(i<od.minDistance||i>od.maxDistance)throw Error(`Orb ${n} camera frame violates OrbitControls distance limits.`);ad.fov=r.fov,ad.position.set(0,r.targetY+r.offsetY,r.positionZ),od.target.set(0,r.targetY,0),od.update(),cd=n}var ud=new Ma(10415871,1180687,.72);id.add(ud);var dd=new Ka(14285823,52,24,Math.PI/5.5,.7,1.5);dd.position.set(-4.5,7,5.4),dd.target.position.set(0,0,0),dd.castShadow=!0,dd.shadow.mapSize.set(1024,1024),dd.shadow.bias=-2e-4,id.add(dd,dd.target);var fd=new Ja(16732120,22,16,2);fd.position.set(4.2,1.8,-2.2),id.add(fd);var pd=new Xt(1,1,{depthBuffer:!0,stencilBuffer:!1,minFilter:c,magFilter:c});pd.texture.name=`MIZU_REFRACTION_BUFFER`,pd.texture.generateMipmaps=!1;var md=`
...
`,Z={uTime:{value:0},uDeform:{value:Y[0].deform},uTouchStrength:{value:0},uPointerVelocity:{value:0},uPulse:{value:0},uAudio:{value:0},uTension:{value:Y[0].tension},uMode:{value:0},uViscosity:{value:Y[0].viscosity},uSwell:{value:Y[0].swell},uFlowStrength:{value:Y[0].flow},uTurbulence:{value:Y[0].turbulence},uFoam:{value:Y[0].foam},uClarity:{value:Y[0].clarity},uElasticity:{value:Y[0].elasticity},uShear:{value:Y[0].shear},uTouchPoint:{value:new H(0,0,1)},uDragVector:{value:new H},uReleasePoint:{value:new H(0,0,1)},uReleaseVector:{value:new H},uReleaseTime:{value:-100},uReleaseEnergy:{value:0},uFreezeProgress:{value:0},uFreezeOrigin:{value:new H(0,0,1)},uFreezeTime:{value:0},uRipples:{value:Array.from({length:5},()=>new Jt(0,0,1,-100))},uSceneTexture:{value:pd.texture},uResolution:{value:new V(1,1)},uDeepColor:{value:Y[0].deepColor.clone()},uMidColor:{value:Y[0].midColor.clone()},uLightColor:{value:Y[0].lightColor.clone()},uAccentColor:{value:Y[0].accentColor.clone()},uInkColor:{value:Y[0].inkColor.clone()},uRimStrength:{value:Y[0].rim},uFacet:{value:0},uOpacity:{value:.88},uOutlineThickness:{value:.046}},gd=`
${md}
${hd}
...
`,Td=new On;Td.position.y=.48,id.add(Td);var Ed=new Ji(1.65,5),Dd=new la({uniforms:Z,vertexShader:gd,fragmentShader:vd,transparent:!0,depthWrite:!1,side:0});Dd.extensions.derivatives=!0;var Od=new la({uniforms:Z,vertexShader:yd,fragmentShader:bd,transparent:!0,depthWrite:!1,side:1}),kd=new $r(Ed,Dd);kd.renderOrder=3,Td.add(kd);var Ad=new $r(Ed,Od);Ad.renderOrder=2,Td.add(Ad);var jd=new la({uniforms:Z,vertexShader:xd,fragmentShader:Sd,transparent:!0,depthWrite:!1,side:1}),Md=new $r(Ed,jd);Md.scale.setScalar(.985),Md.renderOrder=1,Td.add(Md);var Nd=new Ji(1.69,2),Pd=new la({uniforms:Z,vertexShader:Cd,fragmentShader:wd,transparent:!0,depthWrite:!1,side:0});Pd.extensions.derivatives=!0;var Fd=new $r(Nd,Pd);Fd.renderOrder=4,Td.add(Fd);var Id=new Vr({color:Y[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),Ld=new On,Rd=[],zd=new Yi(.18,0);for(let e=0;e<22;e+=1){let e=new $r(zd,Id),t=new H(qu()*2-1,qu()*2-1,qu()*2-1).normalize(),n=.18+qu()**.72*1.25;e.position.copy(t).multiplyScalar(n),e.rotation.set(qu()*Math.PI,qu()*Math.PI,qu()*Math.PI);let r=.22+qu()*.48,i=.72+qu()*1.75;e.scale.set(r,i,r*(.66+qu()*.55)),e.userData.baseScale=e.scale.clone(),e.userData.phase=qu()*Math.PI*2,Ld.add(e),Rd.push(e)}Ld.visible=!1,Ld.renderOrder=1,Td.add(Ld);var Bd=new Ar;Bd.setAttribute(`position`,new K([],3));var Vd=new bi({color:Y[0].lightColor.clone(),transparent:!0,opacity:0,depthWrite:!1,blending:2}),Hd=new Mi(Bd,Vd);Hd.renderOrder=3,Hd.visible=!1,Hd.userData.vertexCount=0,Td.add(Hd);function Ud(e){let t=e.clone().normalize(),n=Ku(Math.abs(Math.floor((t.x*1731+t.y*3191+t.z*7919)*1e4))+17),r=new H().crossVectors(t,Math.abs(t.y)<.92?new H(0,1,0):new H(1,0,0)).normalize(),i=new H().crossVectors(t,r).normalize(),a=[],o=(e,o,s,c,l=.22)=>{let u=e.clone(),d=o.clone().normalize();for(let e=0;e<s;e+=1){let e=r.clone().multiplyScalar((n()-.5)*2).addScaledVector(i,(n()-.5)*2).addScaledVector(t,(n()-.5)*.45).normalize(),o=u.clone().normalize().multiplyScalar(-.19);d.multiplyScalar(.78).addScaledVector(e,l).add(o).normalize();let s=u.clone().addScaledVector(d,c*(.78+n()*.46));s.length()>1.57&&s.normalize().multiplyScalar(1.55),a.push(u.x,u.y,u.z,s.x,s.y,s.z),u=s}};for(let e=0;e<12;e+=1){let e=(n()-.5)*.82,a=(n()-.5)*.82,s=t.clone().multiplyScalar(1.57).addScaledVector(r,e*.08).addScaledVector(i,a*.08),c=t.clone().multiplyScalar(-.76-n()*.22).addScaledVector(r,e).addScaledVector(i,a).normalize();o(s,c,8+Math.floor(n()*6),.13,.2),o(s.clone().addScaledVector(c,.42+n()*.3),c.clone().addScaledVector(r,(n()-.5)*1).addScaledVector(i,(n()-.5)*1).normalize(),3+Math.floor(n()*4),.105,.32)}Bd.setAttribute(`position`,new K(a,3)),Bd.computeBoundingSphere(),Hd.userData.vertexCount=a.length/3,Bd.setDrawRange(0,0)}var Wd=new Vr({transparent:!0,opacity:0,depthWrite:!1});Wd.colorWrite=!1;var Gd=new $r(new Qi(1.76,28,20),Wd);Gd.renderOrder=-10,Td.add(Gd);var Kd=new la({uniforms:{uTime:Z.uTime,uAudio:Z.uAudio,uPulse:Z.uPulse,uMode:Z.uMode,uFreezeProgress:Z.uFreezeProgress,uMidColor:Z.uMidColor,uLightColor:Z.uLightColor,uAccentColor:Z.uAccentColor},vertexShader:`
  ...
  `,transparent:!0,depthWrite:!1,blending:2,side:2}),qd=new $r(new Ji(1.02,4),Kd);qd.renderOrder=1,Td.add(qd);var Jd=new Vr({color:Y[0].accentColor,transparent:!0,opacity:.28,depthWrite:!1,blending:2}),Yd=new $r(new ea(.57,.055,220,18,2,3),Jd);Yd.renderOrder=1,Td.add(Yd);var Xd=new On;id.add(Xd);var Zd=new da({color:462874,roughness:.24,metalness:.82}),Qd=new $r(new Ki(2.22,2.48,.34,96,1),Zd);Qd.position.y=-1.32,Qd.receiveShadow=!0,Qd.castShadow=!0,Xd.add(Qd);var $d=new da({color:727332,roughness:.12,metalness:.88,emissive:Y[0].floorColor.clone(),emissiveIntensity:.08}),ef=new $r(new Ki(1.82,1.88,.065,96),$d);ef.position.y=-1.12,ef.receiveShadow=!0,Xd.add(ef);var tf={uTime:Z.uTime,uMode:Z.uMode,uFlowStrength:Z.uFlowStrength,uTurbulence:Z.uTurbulence,uFoam:Z.uFoam,uFreezeProgress:Z.uFreezeProgress,uColor:{value:Y[0].floorColor.clone()},uLightColor:Z.uLightColor},nf=new $r(new Gi(1.79,128),new la({uniforms:tf,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));nf.rotation.x=-Math.PI/2,nf.position.y=-1.078,nf.renderOrder=2,Xd.add(nf);var rf=new Vr({color:Y[0].floorColor,transparent:!0,opacity:.72,depthWrite:!1,blending:2}),af=new $r(new $i(1.96,.018,8,192),rf);af.rotation.x=Math.PI/2,af.position.y=-1.075,Xd.add(af);var of=new Vr({color:Y[0].floorColor,transparent:!0,opacity:.3}),sf=new di(new Wi(.025,.012,.16),of,48),cf=new Dn;for(let e=0;e<48;e+=1){let t=e/48*Math.PI*2;cf.position.set(Math.cos(t)*2.28,-1.105,Math.sin(t)*2.28),cf.rotation.y=-t,cf.scale.z=e%4==0?1.7:.65,cf.updateMatrix(),sf.setMatrixAt(e,cf.matrix)}Xd.add(sf);var lf={uTime:Z.uTime,uPulse:Z.uPulse,uAudio:Z.uAudio,uColor:{value:Y[0].floorColor.clone()}},uf=new $r(new Xi(32,32,1,1),new la({uniforms:lf,vertexShader:`
      varying vec2 vWorld;
      void main() {
        vec4 world = modelMatrix * vec4(position, 1.0);
        vWorld = world.xz;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));uf.rotation.x=-Math.PI/2,uf.position.y=-1.5,id.add(uf);var df={uTime:Z.uTime,uPulse:Z.uPulse,uAudio:Z.uAudio,uColor:{value:Y[0].backdropColor.clone()},uAccent:Z.uAccentColor},ff=new $r(new Gi(4.25,192),new la({uniforms:df,vertexShader:`
      varying vec2 vUv2;
      void main() {
        vUv2 = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}));ff.renderOrder=-2,id.add(ff);var pf=new On;id.add(pf);var mf=[];for(let e=0;e<3;e+=1){let t=new Vr({color:Y[0].floorColor,transparent:!0,opacity:.18-e*.035,depthWrite:!1,blending:2});mf.push(t);let n=new $r(new $i(2.4+e*.42,.009+e*.002,6,256),t);n.rotation.set(Math.PI*(.18+e*.21),e*.75,e*.45),n.position.y=.42,pf.add(n)}var hf={uTime:Z.uTime,uPulse:Z.uPulse,uColor:{value:Y[0].backdropColor.clone()}},gf=new On;id.add(gf);for(let e=0;e<7;e+=1){let t=new $r(new Xi(.08+e%3*.05,7.5),new la({uniforms:hf,vertexShader:`
        varying vec2 vUv2;
      ...
      `,transparent:!0,depthWrite:!1,blending:2,side:2}));t.position.set((e-3)*1.18+e%2*.28,1.35+e%2*.2,-4.1-Math.abs(e-3)*.08),gf.add(t)}var _f=950,vf=new Float32Array(_f*3),yf=new Float32Array(_f),bf=new Float32Array(_f);for(let e=0;e<_f;e+=1){let t=4+qu()*8.5,n=qu()*Math.PI*2;vf[e*3]=Math.cos(n)*t,vf[e*3+1]=-3.6+qu()*10.2,vf[e*3+2]=Math.sin(n)*t*.72-1.5,yf[e]=qu(),bf[e]=qu()*Math.PI*2}var xf=new Ar;xf.setAttribute(`position`,new gr(vf,3)),xf.setAttribute(`aScale`,new gr(yf,1)),xf.setAttribute(`aPhase`,new gr(bf,1));var Sf={uTime:Z.uTime,uAudio:Z.uAudio,uColor:{value:Y[0].floorColor.clone()}},Cf=new Ri(xf,new la({uniforms:Sf,vertexShader:`
      uniform float uTime;
      uniform float uAudio;
    ...
    `,transparent:!0,depthWrite:!1,blending:2}));id.add(Cf);var wf=new ni(new Uint8Array([35,145,255]),3,1,O);wf.needsUpdate=!0,wf.minFilter=a,wf.magFilter=a;var Tf=new fa({color:Y[0].midColor,gradientMap:wf,transparent:!0,opacity:.66}),Ef=new Ji(.13,2),Df=new On;id.add(Df);var Of=[];for(let e=0;e<16;e+=1){let e=new $r(Ef,Tf),t=.45+qu()*1.2;e.scale.setScalar(t),Df.add(e),Of.push({mesh:e,radius:2.2+qu()*2.7,phase:qu()*Math.PI*2,speed:(.08+qu()*.12)*(qu()>.5?1:-1),yAmp:.35+qu()*1.5,tilt:-.35+qu()*.7,scale:t})}var kf=new class{constructor(e=320){this.max=e,this.cursor=0,this.positions=new Float32Array(e*3),this.velocities=new Float32Array(e*3),this.life=new Float32Array(e),this.size=new Float32Array(e);for(let t=0;t<e;t+=1)this.positions[t*3+1]=-999;this.geometry=new Ar,this.geometry.setAttribute(`position`,new gr(this.positions,3)),this.geometry.setAttribute(`aLife`,new gr(this.life,1)),this.geometry.setAttribute(`aSize`,new gr(this.size,1)),this.uniforms={uColor:{value:Y[0].accentColor.clone()}},this.points=new Ri(this.geometry,new la({uniforms:this.uniforms,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:2})),id.add(this.points)}spawn(e,t,n=1,r=36){let i=new H().crossVectors(t,Math.abs(t.y)<.9?new H(0,1,0):new H(1,0,0)).normalize(),a=new H().crossVectors(t,i).normalize();for(let o=0;o<r;o+=1){let r=this.cursor;this.cursor=(this.cursor+1)%this.max;let o=r*3,s=(Math.random()-.5)*2,c=(Math.random()-.5)*2,l=.45+Math.random()*1.4,u=(.8+Math.random()*1.8)*n,d=t.clone().multiplyScalar(l).addScaledVector(i,s).addScaledVector(a,c).normalize().multiplyScalar(u);this.positions[o]=e.x+t.x*.04,this.positions[o+1]=e.y+t.y*.04,this.positions[o+2]=e.z+t.z*.04,this.velocities[o]=d.x,this.velocities[o+1]=d.y,this.velocities[o+2]=d.z,this.life[r]=.62+Math.random()*.38,this.size[r]=2.5+Math.random()*4.5}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aLife.needsUpdate=!0,this.geometry.attributes.aSize.needsUpdate=!0}update(e){for(let t=0;t<this.max;t+=1){if(this.life[t]<=0)continue;let n=t*3;this.life[t]=Math.max(0,this.life[t]-e*.72),this.positions[n]+=this.velocities[n]*e,this.positions[n+1]+=this.velocities[n+1]*e,this.positions[n+2]+=this.velocities[n+2]*e,this.velocities[n]*=.94**(e*60),this.velocities[n+1]=this.velocities[n+1]*.94**(e*60)-.28*e,this.velocities[n+2]*=.94**(e*60),this.life[t]===0&&(this.positions[n+1]=-999)}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aLife.needsUpdate=!0}},Af=[];for(let e=0;e<7;e+=1){let e=new Vr({color:Y[0].accentColor,transparent:!0,opacity:0,depthWrite:!1,blending:2,side:2}),t=new $r(new Zi(.34,.38,96),e);t.visible=!1,id.add(t),Af.push({mesh:t,life:0})}var jf=0;function Mf(e,t,n=1){let r=Af[jf];jf=(jf+1)%Af.length,r.life=1,r.intensity=n,r.mesh.visible=!0,r.mesh.position.copy(e).addScaledVector(t,.045),r.mesh.quaternion.setFromUnitVectors(new H(0,0,1),t),r.mesh.scale.setScalar(.08),r.mesh.material.opacity=.9}var Nf={uniforms:{tDiffuse:{value:null},uTime:{value:0},uResolution:{value:new V(1,1)},uChroma:{value:.002},uPosterize:{value:0},uPulse:Z.uPulse,uAccent:Z.uAccentColor},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},Pf=new gu(X),Ff=new _u(id,ad),If=new yu(new V(1,1),Y[0].bloom,.26,.94),Lf=new pu(Nf),Rf=new Cu,zf=new Tu;Pf.addPass(Ff),Pf.addPass(If),Pf.addPass(Lf),Pf.addPass(Rf),Pf.addPass(zf);var Bf=new class{constructor(){this.context=null,this.master=null,this.active=!1,this.oscillators=[],this.noiseFilter=null,this.visualEnergy=0}async start(){this.context||this.create(),await this.context.resume(),this.active=!0;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(.075,e+.5),Qp&&im()}stop(){if(!this.context)return;this.active=!1;let e=this.context.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(0,e+.35)}create(){let e=window.AudioContext||window.webkitAudioContext;if(!e)throw Error(`Web Audio is unavailable`);this.context=new e,this.master=this.context.createGain(),this.master.gain.value=0;let t=this.context.createDynamicsCompressor();t.threshold.value=-22,t.knee.value=20,t.ratio.value=5,t.attack.value=.02,t.release.value=.5,this.master.connect(t).connect(this.context.destination);let n=this.context.createBiquadFilter();n.type=`lowpass`,n.frequency.value=680,n.Q.value=1.2,n.connect(this.master),this.droneFilter=n,[1,1.5,2.01].forEach((e,t)=>{let r=this.context.createOscillator(),i=this.context.createGain();r.type=t===0?`sine`:`triangle`,r.frequency.value=Y[0].note*e,i.gain.value=t===0?.42:.11,r.connect(i).connect(n),r.start(),this.oscillators.push({osc:r,gain:i,ratio:e})});let r=this.context.createBuffer(1,this.context.sampleRate*2,this.context.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e+=1)i[e]=Math.random()*2-1;let a=this.context.createBufferSource();a.buffer=r,a.loop=!0;let o=this.context.createBiquadFilter();o.type=`bandpass`,o.frequency.value=460,o.Q.value=2.2;let s=this.context.createGain();s.gain.value=.045,a.connect(o).connect(s).connect(this.master),a.start(),this.noiseFilter=o}update(e,t,n){if(!this.context)return;let r=this.context.currentTime;this.oscillators.forEach(({osc:n,ratio:i},a)=>{let o=Math.sin(t*(.17+a*.04)+a)*(2+a*1.5);n.frequency.setTargetAtTime(e.note*i+o,r,.18)}),this.droneFilter.frequency.setTargetAtTime(480+e.speed*320+n*840,r,.12),this.noiseFilter&&this.noiseFilter.frequency.setTargetAtTime(380+e.deform*240+n*520,r,.15),this.visualEnergy=this.active?.06+(Math.sin(t*2.35)*.5+.5)*.12+n*.18:0}ping(e=1,t=!1){if(!this.active||!this.context)return;let n=this.context.currentTime,r=this.context.createOscillator(),i=this.context.createGain(),a=this.context.createBiquadFilter();r.type=t?`square`:`sine`,r.frequency.setValueAtTime((t?420:220)+Math.random()*150,n),r.frequency.exponentialRampToValueAtTime(85+Math.random()*40,n+.42),a.type=`lowpass`,a.frequency.value=t?1500:900,i.gain.setValueAtTime(1e-4,n),i.gain.exponentialRampToValueAtTime(.055*e,n+.012),i.gain.exponentialRampToValueAtTime(1e-4,n+.46),r.connect(a).connect(i).connect(this.master),r.start(n),r.stop(n+.5)}},Q={active:!1,stream:null,context:null,analyser:null,data:null,energy:0};async function Vf(){if(!navigator.mediaDevices?.getUserMedia)throw Error(`该浏览器不支持麦克风输入`);let e=await navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!1,noiseSuppression:!1,autoGainControl:!1},video:!1}),t=new(window.AudioContext||window.webkitAudioContext);await t.resume();let n=t.createMediaStreamSource(e),r=t.createAnalyser();r.fftSize=256,r.smoothingTimeConstant=.78,n.connect(r),Q.active=!0,Q.stream=e,Q.context=t,Q.analyser=r,Q.data=new Uint8Array(r.frequencyBinCount),Qp&&im()}async function Hf(){Q.active=!1,Q.energy=0,Q.stream?.getTracks().forEach(e=>e.stop()),Q.context&&Q.context.state!==`closed`&&await Q.context.close(),Q.stream=null,Q.context=null,Q.analyser=null,Q.data=null}function Uf(){if(!Q.active||!Q.analyser||!Q.data)return 0;Q.analyser.getByteFrequencyData(Q.data);let e=0,t=Math.min(30,Q.data.length);for(let n=1;n<t;n+=1)e+=Q.data[n];let n=Uu((e/Math.max(1,t-1)-18)/105);return Q.energy=Wu(Q.energy,n,12,1/60),Q.energy}var Wf=0,Gf=0,Kf=0,qf=0,Jf=0,Yf=0,Xf=!1,$=0,Zf=0,Qf=0,$f=0,ep=performance.now(),tp=performance.now(),np=0;function rp(e,t=1300){Lu.textContent=e,Lu.classList.add(`is-visible`),clearTimeout(np),np=setTimeout(()=>Lu.classList.remove(`is-visible`),t)}function ip(){ep=performance.now(),od.autoRotate=!1}function ap(e,t=!0){let n=At.clamp(Number(e),0,Y.length-1);Wf=n,Gf=n,Kf=n;let r=Y[n];Mu.textContent=`${r.zh} ${r.en}`,Nu.textContent=r.material,Pu.textContent=`μ ${r.viscosity.toFixed(2)} · σ ${r.tension.toFixed(2)} · FLOW ${r.flow.toFixed(2)}`,Fu.textContent=r.noteZh,Du(`.mode-btn`).forEach((e,t)=>{let r=t===n;e.classList.toggle(`is-active`,r),e.setAttribute(`aria-pressed`,String(r))}),document.documentElement.style.setProperty(`--accent`,r.accent),document.documentElement.style.setProperty(`--accent-2`,r.floor),qf=Math.max(qf,.45),Jf=0,ip(),Bf.ping(.72,n===3),t&&rp(`PHASE ${String(n+1).padStart(2,`0`)} // ${r.zh} ${r.en}`)}function op(e=1){qf=Math.max(qf,e),Jf=0,Z.uPulse.value=qf;let t=Td.getWorldPosition(new H);kf.spawn(t,new H(0,1,0),e*.75,Math.round(28+e*20)),Bf.ping(1.15*e,Wf===3),navigator.vibrate?.(Math.round(10+e*14)),ip()}function sp(e,t,n,r=1){Z.uRipples.value[$f].set(e.x,e.y,e.z,Qf),$f=($f+1)%Z.uRipples.value.length,Z.uPointerVelocity.value=Math.max(Z.uPointerVelocity.value,r*.7),Mf(t,n,r),kf.spawn(t,n,r,Math.round(24+r*18)),qf=Math.max(qf,.5*r),Bf.ping(.8+r*.35,Wf===3),navigator.vibrate?.(12)}var cp=new go,lp=new V,up=new H(0,0,1),dp=new H(0,0,1),fp=0,pp=0,mp=0,hp=new H,gp=new H,_p=new H(0,0,1),vp=!1,yp=0,bp=!1,xp=null,Sp=0,Cp={x:0,y:0,time:performance.now()},wp=0,Tp=10,Ep=285,Dp=24,Op=null,kp=null;function Ap(e,t,n,r){let i=n-e,a=r-t;return i*i+a*a}function jp(e){if(Op){if(e.pointerType!==Op.pointerType){Op.invalid=!0,kp=null;return}Op.maxTravelSq=Math.max(Op.maxTravelSq,Ap(Op.startX,Op.startY,e.clientX,e.clientY)),Op.maxTravelSq>Tp*Tp&&(Op.dragged=!0,kp=null)}}function Mp(e){let t=Ou.getBoundingClientRect();lp.x=(e.clientX-t.left)/t.width*2-1,lp.y=-((e.clientY-t.top)/t.height)*2+1}function Np(e){Mp(e),cp.setFromCamera(lp,ad);let t=cp.intersectObject(Gd,!1);if(!t.length)return null;let n=t[0],r=Td.worldToLocal(n.point.clone()).normalize(),i=Td.getWorldPosition(new H),a=n.point.clone().sub(i).normalize();return{...n,localPoint:r,worldNormal:a}}function Pp(e){dp.copy(e.localPoint);let t=performance.now(),n=Math.max(8,t-Cp.time);if(Sp=Uu(Math.hypot(lp.x-Cp.x,lp.y-Cp.y)/n*420),Cp={x:lp.x,y:lp.y,time:t},bp&&vp){let t=e.localPoint.clone().sub(_p);t.addScaledVector(e.localPoint,-t.dot(e.localPoint));let n=Math.min(1.6,t.length()*26+Sp*.32);t.lengthSq()>1e-7&&(t.normalize().multiplyScalar(n),gp.lerp(t,.74),yp=Math.min(1.65,yp+n*.12))}_p.copy(e.localPoint),vp=!0}Ou.addEventListener(`pointermove`,e=>{if(xp!==null&&e.pointerId!==xp)return;jp(e);let t=Np(e);t?(Pp(t),pp=Xf?.06:bp?1.36:.15,Ou.style.cursor=bp?`grabbing`:`crosshair`,bp&&performance.now()-wp>90&&(kf.spawn(t.point,t.worldNormal,.25+Sp*.35,5),wp=performance.now())):(pp=Xf?0:bp?.78:0,Ou.style.cursor=bp?`grabbing`:`grab`)},{passive:!0}),Ou.addEventListener(`pointerdown`,e=>{if(xp!==null){Op&&(Op.invalid=!0),kp=null;return}let t=Np(e);if(!t){kp=null,od.enabled=!0,ip();return}if(e.preventDefault(),xp=e.pointerId,Op={pointerType:e.pointerType,startX:e.clientX,startY:e.clientY,maxTravelSq:0,dragged:!1,invalid:!1},Ou.setPointerCapture?.(e.pointerId),Xf){od.enabled=!0,up.copy(t.localPoint),dp.copy(t.localPoint),kf.spawn(t.point,t.worldNormal,.42,14),qf=Math.max(qf,.46),Bf.ping(.68,!0),ip();return}bp=!0,Ou.classList.add(`is-sculpting`),od.enabled=!1,vp=!1,gp.set(0,0,0),hp.set(0,0,0),yp=.18,Pp(t),pp=1.36,sp(t.localPoint,t.point,t.worldNormal,.85+Y[Wf].swell*.15),ip()},{passive:!1});function Fp(e,t){if(t&&(kp=null),xp===null||e.pointerId!==xp)return;let n=Op;t||jp(e);let r=!t&&n&&!n.invalid&&!n.dragged?Np(e):null,i=bp;if(bp=!1,Ou.classList.remove(`is-sculpting`),od.enabled=!0,pp=0,xp!==null&&Ou.releasePointerCapture?.(xp),xp=null,Op=null,i){let e=Math.min(1.7,.35+yp+Sp*.45);Z.uReleasePoint.value.copy(up),Z.uReleaseVector.value.copy(hp.lengthSq()>1e-4?hp:gp),Z.uReleaseTime.value=Qf,Z.uReleaseEnergy.value=e,gp.set(0,0,0),vp=!1,qf=Math.max(qf,.34+e*.18)}if(t||!n||n.invalid||n.dragged||!r){kp=null;return}let a={pointerType:e.pointerType,time:e.timeStamp,x:e.clientX,y:e.clientY,origin:r.localPoint.clone()};if(!kp){kp=a;return}let o=kp;kp=null;let s=a.time-o.time;if(s>Ep){kp=a;return}s>=0&&a.pointerType===o.pointerType&&Ap(o.x,o.y,a.x,a.y)<=Dp*Dp&&Ip(a.origin)}Ou.addEventListener(`pointerup`,e=>Fp(e,!1),{passive:!0}),Ou.addEventListener(`pointercancel`,e=>Fp(e,!0),{passive:!0}),Ou.addEventListener(`pointerleave`,()=>{bp||(pp=0)},{passive:!0});function Ip(e=up){if(Xf=!Xf,Zf=+!!Xf,Yf=+!!Xf,qf=Math.max(qf,1),Xf){let t=e.clone().normalize();Z.uFreezeOrigin.value.copy(t),Z.uFreezeTime.value=Qf,Ud(t),Hd.visible=!0,Ld.visible=!0,Iu.textContent=`CRYSTAL`,Iu.classList.add(`is-crystal`);let n=Td.localToWorld(t.multiplyScalar(1.64));kf.spawn(n,n.clone().sub(Td.getWorldPosition(new H)).normalize(),1.05,54)}else Iu.textContent=`LIQUID`,Iu.classList.remove(`is-crystal`),Z.uReleasePoint.value.copy(Z.uFreezeOrigin.value),Z.uReleaseVector.value.copy(Z.uFreezeOrigin.value).cross(new H(.2,1,.3)).normalize(),Z.uReleaseTime.value=Qf,Z.uReleaseEnergy.value=1.15;Bf.ping(1.25,!0),rp(Xf?`PHASE TRANSITION // 晶核扩散`:`PHASE TRANSITION // 晶格熔解`),ip()}window.addEventListener(`keydown`,e=>{e.target instanceof HTMLInputElement||e.target instanceof HTMLButtonElement||(e.code===`Space`?(e.preventDefault(),op(1)):/^Digit[1-4]$/.test(e.code)?ap(Number(e.code.slice(-1))-1):e.key.toLowerCase()===`f`?zp():e.key.toLowerCase()===`m`&&Eu(`#mic-toggle`).click())}),Du(`.mode-btn`).forEach(e=>e.addEventListener(`click`,()=>ap(e.dataset.mode))),Eu(`#audio-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;try{Bf.active?(Bf.stop(),t.textContent=`声场 OFF`,t.setAttribute(`aria-pressed`,`false`),rp(`GENERATIVE SOUND FIELD // OFF`)):(await Bf.start(),t.textContent=`声场 ON`,t.setAttribute(`aria-pressed`,`true`),rp(`GENERATIVE SOUND FIELD // ON`),op(.55))}catch(e){rp(`AUDIO ERROR // ${e.message}`)}}),Eu(`#mic-toggle`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{Q.active?(await Hf(),t.textContent=`MIC OFF`,t.setAttribute(`aria-pressed`,`false`),rp(`MIC REACTIVITY // OFF`)):(await Vf(),t.textContent=`MIC LIVE`,t.setAttribute(`aria-pressed`,`true`),rp(`MIC REACTIVITY // LIVE`),op(.7))}catch(e){rp(`MIC DENIED // ${e.message}`)}finally{t.disabled=!1}});function Lp(e){Ru.hidden=!e,Eu(`#panel-toggle`).setAttribute(`aria-expanded`,String(e))}Eu(`#panel-toggle`).addEventListener(`click`,()=>Lp(Ru.hidden)),Eu(`#panel-close`).addEventListener(`click`,()=>Lp(!1)),[[`deform`,`userDeform`,2],[`speed`,`userSpeed`,2],[`outline`,`outline`,2],[`bloom`,`bloom`,2],[`chroma`,`chroma`,2],[`flow`,`flow`,2],[`liveliness`,`liveliness`,2]].forEach(([e,t,n])=>{let r=Eu(`#${e}`),i=Eu(`#${e}-out`);r.addEventListener(`input`,()=>{rd[t]=Number(r.value),i.value=rd[t].toFixed(n),i.textContent=i.value,ip()})}),Eu(`#reset-params`).addEventListener(`click`,()=>{Object.entries({deform:1,speed:1,outline:1,bloom:1,chroma:.45,flow:1,liveliness:1}).forEach(([e,t])=>{let n=Eu(`#${e}`);n.value=t,n.dispatchEvent(new Event(`input`))}),rp(`MATERIAL PARAMETERS RESET`)}),Du(`.quality`).forEach(e=>e.addEventListener(`click`,()=>Rp(e.dataset.quality)));function Rp(e){rd.quality=e;let t=Math.min(window.devicePixelRatio||1,{high:1.5,medium:1.25,low:1}[e]);X.setPixelRatio(t),Rf.enabled=e!==`low`,X.shadowMap.enabled=e!==`low`,xf.setDrawRange(0,e===`high`?_f:e===`medium`?700:430),Du(`.quality`).forEach(t=>t.classList.toggle(`is-active`,t.dataset.quality===e)),Bp(),rp(`RENDER QUALITY // ${e.toUpperCase()}`)}function zp(){document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.(),ip()}Eu(`#fullscreen`).addEventListener(`click`,zp),Eu(`#capture`).addEventListener(`click`,()=>{fm(),Pf.render(),Ou.toBlob(e=>{if(!e){rp(`CAPTURE FAILED`);return}let t=document.createElement(`a`);t.download=`mizu-kokoro-${Y[Wf].en.toLowerCase()}-${Date.now()}.png`,t.href=URL.createObjectURL(e),t.click(),setTimeout(()=>URL.revokeObjectURL(t.href),1e3),rp(`FRAME CAPTURED // PNG`)},`image/png`)});function Bp(){let e=Math.max(1,window.innerWidth),t=Math.max(1,window.innerHeight);ld(e,t),ad.aspect=e/t,ad.updateProjectionMatrix(),X.setSize(e,t,!1),Pf.setSize(e,t);let n=X.getPixelRatio(),r={high:.82,medium:.66,low:.5}[rd.quality]||.66,i=Math.max(1,Math.floor(e*n*r)),a=Math.max(1,Math.floor(t*n*r));pd.setSize(i,a),Z.uResolution.value.set(i,a),Lf.uniforms.uResolution.value.set(e*n,t*n)}window.addEventListener(`resize`,Bp,{passive:!0});var Vp=performance.now(),Hp=performance.now(),Up=0,Wp=!1,Gp=0,Kp=0,qp=0,Jp=null,Yp=0,Xp=document.hidden,Zp=!1,Qp=null,$p=new Set,em=new Set,tm=Promise.resolve();function nm(e){ed(`stats`,{fps:Kp,frameTimeMs:qp,frameCount:Gp,paused:e})}async function rm(){for(;;){let e=Qp;if(e){for(let e of[Bf.context,Q.context])e?.state===`running`&&$p.add(e);for(let e of Q.stream?.getAudioTracks()??[])e.enabled&&e.readyState===`live`&&(em.add(e),e.enabled=!1);await Promise.all([...$p].map(e=>e.state===`running`?e.suspend():void 0))}else{await Promise.all([...$p].map(e=>e.state===`suspended`?e.resume():void 0));for(let e of em)e.readyState===`live`&&(e.enabled=!0)}if(Qp===e){e||($p.clear(),em.clear());return}}}function im(){tm=tm.then(rm).catch(e=>{console.error(`Orb runtime audio transition failed.`,e)})}function am(){Hu||Qp||Jp!==null||(Jp=requestAnimationFrame(gm))}function om(){let e=Xp||Zp;if(Qp===e)return;if(Qp=e,Qp){Au.textContent=`PAUSED`,Jp!==null&&(cancelAnimationFrame(Jp),Jp=null),im(),nm(!0);return}let t=performance.now();Vp=t,ep=t,tp=t,Hp=t,Up=0,Au.textContent=`-- FPS`,im(),nm(!1),am()}function sm(e){Zp=e,om()}function cm(){Xp=document.hidden,om()}function lm(e){let t=Y[Gf],n=1-Math.exp(-e*3.4);Z.uDeepColor.value.lerp(t.deepColor,n),Z.uMidColor.value.lerp(t.midColor,n),Z.uLightColor.value.lerp(t.lightColor,n),Z.uAccentColor.value.lerp(t.accentColor,n),Z.uInkColor.value.lerp(t.inkColor,n),lf.uColor.value.lerp(t.floorColor,n),df.uColor.value.lerp(t.backdropColor,n),hf.uColor.value.lerp(t.backdropColor,n),Sf.uColor.value.lerp(t.floorColor,n),kf.uniforms.uColor.value.lerp(t.accentColor,n),Tf.color.lerp(t.midColor,n),Jd.color.lerp(t.accentColor,n),rf.color.lerp(t.floorColor,n),of.color.lerp(t.floorColor,n),$d.emissive.lerp(t.floorColor,n),tf.uColor.value.lerp(t.floorColor,n),Id.color.lerp(t.lightColor,n),Vd.color.lerp(t.lightColor,n),mf.forEach(e=>e.color.lerp(t.floorColor,n)),Af.forEach(e=>e.mesh.material.color.lerp(t.accentColor,n)),dd.color.lerp(t.lightColor,n*.35),fd.color.lerp(t.accentColor,n*.45)}function um(e){let t=Y[Gf];$=Wu($,Zf,Xf?2.45:3.6,e),Math.abs($-Zf)<5e-4&&($=Zf),Z.uFreezeProgress.value=$,Z.uMode.value=Wu(Z.uMode.value,Kf,3.2,e),Z.uDeform.value=Wu(Z.uDeform.value,t.deform*rd.userDeform,4,e),Z.uTension.value=Wu(Z.uTension.value,t.tension,4.2,e),Z.uViscosity.value=Wu(Z.uViscosity.value,t.viscosity,4,e),Z.uSwell.value=Wu(Z.uSwell.value,t.swell,4,e),Z.uFlowStrength.value=Wu(Z.uFlowStrength.value,t.flow*rd.flow,4,e),Z.uTurbulence.value=Wu(Z.uTurbulence.value,t.turbulence,4,e),Z.uFoam.value=Wu(Z.uFoam.value,t.foam,4,e),Z.uClarity.value=Wu(Z.uClarity.value,t.clarity,4,e),Z.uElasticity.value=Wu(Z.uElasticity.value,t.elasticity*rd.liveliness,4,e),Z.uShear.value=Wu(Z.uShear.value,t.shear,4,e),Z.uRimStrength.value=Wu(Z.uRimStrength.value,t.rim,4,e),Z.uFacet.value=Wu(Z.uFacet.value,Yf*$,5,e),Z.uOutlineThickness.value=Wu(Z.uOutlineThickness.value,.046*rd.outline,5,e);let n=.86+(1-t.clarity)*.075+(Wf===3?.025:0);Z.uOpacity.value=Wu(Z.uOpacity.value,n,4,e);let r=rd.quality===`low`?.72:1;If.strength=Wu(If.strength,(t.bloom+$*.24)*rd.bloom*r,4,e),If.radius=Wu(If.radius,Wf===3||$>.5?.16:.28,4,e),Lf.uniforms.uChroma.value=Wu(Lf.uniforms.uChroma.value,75e-5*(t.chroma+$*.42)*rd.chroma,5,e),Lf.uniforms.uPosterize.value=Wu(Lf.uniforms.uPosterize.value,Math.min(.92,t.posterize+$*.08),4,e),$d.emissiveIntensity=Wu($d.emissiveIntensity,.07+qf*.18+$*.08,4,e);let i=$>.002;Fd.visible=i,Ld.visible=i,Hd.visible=i&&Hd.userData.vertexCount>0,Id.opacity=$*(.16+qf*.08),Vd.opacity=$*(.54+qf*.22),Bd.setDrawRange(0,Math.floor(Hd.userData.vertexCount*$)),Jd.opacity=.28*(1-$*.88)}function dm(e){let t=Y[Wf],n=1-$*.88;qd.rotation.y+=e*(.19+t.speed*.12)*n,qd.rotation.x=Math.sin(Qf*.21)*.14*n,Yd.rotation.x+=e*.23*n,Yd.rotation.y-=e*.31*n,Yd.scale.setScalar(1+qf*.07+Z.uAudio.value*.08),Ld.rotation.y-=e*.08*$,Ld.rotation.x=Math.sin(Qf*.16)*.08*$,Rd.forEach((t,n)=>{let r=.82+Math.sin(Qf*.9+t.userData.phase+n*.17)*.12,i=$*r;t.scale.copy(t.userData.baseScale).multiplyScalar(i),t.rotation.y+=e*(.018+n*8e-4)*$}),Td.rotation.y+=e*At.lerp(.028,.006,$),Td.rotation.x=Math.sin(Qf*.19)*At.lerp(.027,.006,$);let r=At.lerp(.048,.015,$),i=Math.sin(Qf*.72)*(zu?.012:r);Td.position.y=.48+i,pf.rotation.y+=e*.045,pf.rotation.z=Math.sin(Qf*.12)*.08,pf.children.forEach((t,n)=>{t.rotation.z+=e*(.025+n*.013)*(n%2?-1:1),t.material.opacity=.13-n*.02+qf*.1+Z.uAudio.value*.12+$*.04});let a=(.34+t.flow*.78)*(1-t.viscosity*.32);Tf.opacity=At.lerp(.72,.42,$),Of.forEach((e,n)=>{let r=e.phase+Qf*e.speed*a,i=Math.sin(Qf*(.52+t.turbulence*.46)+e.phase)*(.08+t.swell*.1);e.mesh.position.set(Math.cos(r)*(e.radius+i),.45+Math.sin(r*(1.45+t.swell*.35)+e.phase)*e.yAmp,Math.sin(r)*e.radius*(.55+e.tilt*.15)),e.mesh.rotation.set(r*.7,r*1.3+n,r*.35);let o=1+Z.uAudio.value*(.18+n%4*.04),s=e.scale*o,c=1+t.viscosity*1.35+t.swell*.22,l=1+t.swell*.24;e.mesh.scale.set(s/l,s*c,s/l)}),nf.rotation.z+=e*(.012+t.flow*.018)*(1-$*.72),Af.forEach(n=>{if(n.life<=0)return;let r=At.lerp(1.35,.62,t.viscosity);n.life=Math.max(0,n.life-e*r);let i=1-n.life,a=3.1+t.tension*.72+t.swell*.55,o=At.lerp(.08,a*n.intensity,1-(1-i)**2);n.mesh.scale.setScalar(o),n.mesh.material.opacity=n.life*n.life*(.72+t.tension*.12),n.life===0&&(n.mesh.visible=!1)}),kf.update(e)}function fm(){let e=Td.visible;Td.visible=!1,X.setRenderTarget(pd),X.clear(),X.render(id,ad),X.setRenderTarget(null),Td.visible=e}function pm(e=0){fm(),Pf.render(e),Yp+=1}function mm(){let e=new H;ad.getWorldDirection(e),ff.position.copy(od.target).addScaledVector(e,4.2),ff.quaternion.copy(ad.quaternion),gf.quaternion.copy(ad.quaternion),gf.position.copy(od.target).addScaledVector(e,.25)}function hm(){let e=performance.now(),t=e-ep;t>15e3&&(od.autoRotate=!0,pp=Xf?0:.1,dp.set(Math.sin(Qf*.27),Math.sin(Qf*.19+1.4)*.65,Math.cos(Qf*.27)).normalize()),t>3e4&&e-tp>17e3&&(ap((Wf+1)%Y.length,!1),tp=e,ep=e-2e4)}function gm(e=performance.now()){if(Jp=null,Qp)return;let t=Math.min(Math.max((e-Vp)/1e3,0),.05);Vp=e;let n=Y[Wf],r=zu?.34:1;Qf+=t*n.speed*rd.userSpeed*r,Z.uTime.value=Qf,Lf.uniforms.uTime.value=Qf,hm(),lm(t),um(t);let i=bp?At.lerp(20,8,n.viscosity):6.5;up.lerp(dp,1-Math.exp(-t*i)),up.normalize(),Z.uTouchPoint.value.copy(up);let a=bp?185:42*n.recovery*Math.max(.25,rd.liveliness),o=bp?.92:At.clamp((.24+n.viscosity*1.02)/Math.sqrt(Math.max(.22,n.elasticity*rd.liveliness)),.18,1.42),s=2*Math.sqrt(a)*o,c=(pp-fp)*a-mp*s;if(mp+=c*t,fp=At.clamp(fp+mp*t,-.52,1.46),$>.72&&(fp*=Math.exp(-t*10),mp*=Math.exp(-t*10)),Z.uTouchStrength.value=fp,!bp){let e=At.lerp(10.5,2,n.viscosity);gp.multiplyScalar(Math.exp(-t*e))}let l=At.lerp(18,5.2,n.viscosity);hp.lerp(gp,1-Math.exp(-t*l)),$>.35&&hp.multiplyScalar(Math.exp(-t*8*$)),Z.uDragVector.value.copy(hp).multiplyScalar(rd.liveliness),Sp=Wu(Sp,0,7,t),Z.uPointerVelocity.value=Wu(Z.uPointerVelocity.value,Sp,12,t),qf=Wu(qf,Jf,3.3,t),Z.uPulse.value=qf,Bf.update(n,Qf,qf);let u=Uf(),d=Q.active?u:Bf.visualEnergy;Z.uAudio.value=Wu(Z.uAudio.value,d,Q.active?11:5,t),fd.intensity=20+qf*15+Z.uAudio.value*18+$*8,dd.intensity=48+qf*18+$*7,af.scale.setScalar(1+qf*.04+Z.uAudio.value*.025+$*.018),rf.opacity=.55+qf*.35+Z.uAudio.value*.25+$*.08,dm(t),od.update(t),mm(),pm(t),Gp+=1,Up+=1;let f=e-Hp;f>=500&&(Kp=Up*1e3/f,qp=f/Up,Au.textContent=`${Math.round(Kp)} FPS`,nm(!1),Hp=e,Up=0),Wp||(Wp=!0,setTimeout(()=>ku.classList.add(`is-hidden`),280)),am()}function _m(e){return{object:e,position:e.position.clone(),quaternion:e.quaternion.clone(),scale:e.scale.clone(),visible:e.visible}}function vm(e){e.object.position.copy(e.position),e.object.quaternion.copy(e.quaternion),e.object.scale.copy(e.scale),e.object.visible=e.visible,e.object.updateMatrix(),e.object.matrixWorldNeedsUpdate=!0}function ym(){kf.cursor=0,kf.positions.fill(0);for(let e=0;e<kf.max;e+=1)kf.positions[e*3+1]=-999;kf.velocities.fill(0),kf.life.fill(0),kf.size.fill(0),kf.geometry.attributes.position.needsUpdate=!0,kf.geometry.attributes.aLife.needsUpdate=!0,kf.geometry.attributes.aSize.needsUpdate=!0}function bm(e,t,n){let r=Y[e],i=zu?.34:1;Wf=e,Gf=e,Kf=e,qf=0,Jf=0,Yf=+(t>0),Xf=t>0,$=t,Zf=t,Qf=n/1e3*r.speed*rd.userSpeed*i,$f=0,ep=n,tp=n,fp=0,pp=0,mp=0,up.set(0,0,1),dp.set(0,0,1),hp.set(0,0,0),gp.set(0,0,0),_p.set(0,0,1),vp=!1,yp=0,bp=!1,xp=null,Op=null,Sp=0,Cp={x:0,y:0,time:n},wp=0,kp=null,Ou.classList.remove(`is-sculpting`),Z.uTime.value=Qf,Z.uDeform.value=r.deform*rd.userDeform,Z.uTouchStrength.value=0,Z.uPointerVelocity.value=0,Z.uPulse.value=0,Z.uAudio.value=0,Z.uTension.value=r.tension,Z.uMode.value=e,Z.uViscosity.value=r.viscosity,Z.uSwell.value=r.swell,Z.uFlowStrength.value=r.flow*rd.flow,Z.uTurbulence.value=r.turbulence,Z.uFoam.value=r.foam,Z.uClarity.value=r.clarity,Z.uElasticity.value=r.elasticity*rd.liveliness,Z.uShear.value=r.shear,Z.uTouchPoint.value.set(0,0,1),Z.uDragVector.value.set(0,0,0),Z.uReleasePoint.value.set(0,0,1),Z.uReleaseVector.value.set(0,0,0),Z.uReleaseTime.value=-100,Z.uReleaseEnergy.value=0,Z.uFreezeProgress.value=t,Z.uFreezeOrigin.value.set(0,0,1),Z.uFreezeTime.value=Qf,Z.uRipples.value.forEach(e=>e.set(0,0,1,-100)),Z.uDeepColor.value.copy(r.deepColor),Z.uMidColor.value.copy(r.midColor),Z.uLightColor.value.copy(r.lightColor),Z.uAccentColor.value.copy(r.accentColor),Z.uInkColor.value.copy(r.inkColor),Z.uRimStrength.value=r.rim,Z.uFacet.value=t,Z.uOpacity.value=.86+(1-r.clarity)*.075+(e===3?.025:0),Z.uOutlineThickness.value=.046*rd.outline,lf.uColor.value.copy(r.floorColor),df.uColor.value.copy(r.backdropColor),hf.uColor.value.copy(r.backdropColor),Sf.uColor.value.copy(r.floorColor),kf.uniforms.uColor.value.copy(r.accentColor),Tf.color.copy(r.midColor),Jd.color.copy(r.accentColor),rf.color.copy(r.floorColor),of.color.copy(r.floorColor),$d.emissive.copy(r.floorColor),tf.uColor.value.copy(r.floorColor),Id.color.copy(r.lightColor),Vd.color.copy(r.lightColor),mf.forEach(e=>e.color.copy(r.floorColor)),Af.forEach(e=>{e.life=0,e.mesh.visible=!1,e.mesh.material.color.copy(r.accentColor)}),jf=0,dd.color.copy(r.lightColor),fd.color.copy(r.accentColor);let a=rd.quality===`low`?.72:1;If.strength=(r.bloom+t*.24)*rd.bloom*a,If.radius=e===3||t>.5?.16:.28,Lf.uniforms.uTime.value=Qf,Lf.uniforms.uChroma.value=75e-5*(r.chroma+t*.42)*rd.chroma,Lf.uniforms.uPosterize.value=Math.min(.92,r.posterize+t*.08),$d.emissiveIntensity=.07+t*.08,Ud(Z.uFreezeOrigin.value);let o=t>.002;Fd.visible=o,Ld.visible=o,Hd.visible=o&&Hd.userData.vertexCount>0,Id.opacity=t*.16,Vd.opacity=t*.54,Bd.setDrawRange(0,Math.floor(Hd.userData.vertexCount*t)),Jd.opacity=.28*(1-t*.88),Bf.visualEnergy=0,Q.energy=0,ym(),dm(0),mm()}function xm(){let e=X.getRenderTarget(),t=[Pf.readBuffer,Pf.writeBuffer,If.renderTargetBright,...If.renderTargetsHorizontal,...If.renderTargetsVertical];for(let e of t)X.setRenderTarget(e),X.clear();X.setRenderTarget(e)}async function Sm(e){let t=await crypto.subtle.digest(`SHA-256`,e);return[...new Uint8Array(t)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}async function Cm(e,t,n){let r=new TextEncoder().encode(`rgba8\0`),i=new Uint8Array(r.length+8+n.length);i.set(r,0);let a=new DataView(i.buffer,r.length,8);return a.setUint32(0,e,!1),a.setUint32(4,t,!1),i.set(n,r.length+8),Sm(i)}async function wm(){let e=X.getContext(),t=e.drawingBufferWidth,n=e.drawingBufferHeight,r=new Uint8Array(t*n*4);e.finish(),e.readPixels(0,0,t,n,e.RGBA,e.UNSIGNED_BYTE,r);let i=new TextEncoder().encode(`rgba8\0`),a=new Uint8Array(i.length+8+r.length);a.set(i,0);let o=new DataView(a.buffer,i.length,8);o.setUint32(0,t,!1),o.setUint32(4,n,!1);let s=t*4;for(let e=0;e<n;e+=1){let t=n-1-e;a.set(r.subarray(e*s,(e+1)*s),i.length+8+t*s)}return{width:t,height:n,hash:await Sm(a)}}function Tm(){if(!Hu)return;let e=[];id.traverse(t=>e.push(_m(t)));let t=null,n=null,i=null,a=!1,o=1440,s=1.25,l=Object.freeze({frozen:Object.freeze({x:540,y:426,width:48,height:48}),unfrozen:Object.freeze({x:852,y:426,width:48,height:48}),interior:Object.freeze({x:672,y:402,width:96,height:96})}),u=new Ln;u.background=new G(0);let f=new Wa(42,o/900,.05,80);f.position.set(8.1,.48,0),f.lookAt(0,.48,0),f.updateMatrixWorld(!0);let p=new $r(Ed,jd);p.position.y=.48,p.scale.setScalar(.985),p.updateMatrixWorld(!0),u.add(p);let m=new Xt(o,900,{format:E,type:d,colorSpace:He,minFilter:c,magFilter:c,generateMipmaps:!1,depthBuffer:!0,stencilBuffer:!1,samples:0});m.texture.internalFormat=`RGBA8`;let h=new Uint8Array(4096*4);for(let e=0;e<64;e+=1)for(let t=0;t<64;t+=1){let n=(e*64+t)*4;h[n]=Math.round(255*t/63),h[n+1]=Math.round(255*e/63),h[n+2]=((t>>3)+(e>>3))%2==0?32:224,h[n+3]=255}let g=new ni(h,64,64,E,d);g.colorSpace=He,g.internalFormat=`RGBA8`,g.flipY=!1,g.generateMipmaps=!1,g.unpackAlignment=1,g.wrapS=r,g.wrapT=r,g.minFilter=c,g.magFilter=c,g.needsUpdate=!0;let _=Cm(64,64,h);function v(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode(...e.subarray(r,r+n));return btoa(t)}function y(){return[`uTime`,`uMode`,`uFlowStrength`,`uTurbulence`,`uClarity`,`uFreezeProgress`,`uFreezeOrigin`,`uFreezeTime`,`uSceneTexture`,`uDeepColor`,`uMidColor`,`uLightColor`].map(e=>{let t=Z[e],n=t.value;return{name:e,uniform:t,value:n,copiedValue:n?.isVector3||n?.isColor?n.clone():n}})}function b(e){e.forEach(({uniform:e,value:t,copiedValue:n})=>{e.value=t,(t?.isVector3||t?.isColor)&&t.copy(n)})}function x(e){e.forEach(({name:e,uniform:t,value:n,copiedValue:r})=>{if(t.value!==n)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME failed to restore ${e} identity`);if((n?.isVector3||n?.isColor)&&!n.equals(r)||!(n?.isVector3||n?.isColor)&&n!==r)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME failed to restore ${e} value`)})}function S(e,t){let n=new Uint8Array(t.width*t.height*3),r=0;for(let i=t.y;i<t.y+t.height;i+=1)for(let a=t.x;a<t.x+t.width;a+=1){let t=(i*o+a)*4;n[r]=e[t],n[r+1]=e[t+1],n[r+2]=e[t+2],r+=3}return n}async function C(){let e=new Uint8Array(o*900*4);X.getContext().finish(),X.readRenderTargetPixels(m,0,0,o,900,e);let t=new Uint8Array(e.length),n=o*4;for(let r=0;r<900;r+=1){let i=899-r;t.set(e.subarray(r*n,(r+1)*n),i*n)}let r={};for(let[e,n]of Object.entries(l)){let i=S(t,n);r[e]={...n,channels:`rgb8`,sampleCount:n.width*n.height,bytesBase64:v(i),hash:await Sm(i)}}return{framebuffer:{width:o,height:900,format:`rgba8`,hash:await Cm(o,900,t)},regions:r}}window.__MIZU_KOKORO_STEP__=async r=>{if(!$u(r,[`mode`,`freezeProgress`,`timestamp`]))throw Error(`MIZU_KOKORO_STEP input must contain exactly mode, freezeProgress, and timestamp`);if(!Number.isInteger(r.mode)||r.mode<0||r.mode>=Y.length)throw Error(`MIZU_KOKORO_STEP mode must be an integer from 0 through 3`);if(!Number.isFinite(r.freezeProgress)||r.freezeProgress<0||r.freezeProgress>1)throw Error(`MIZU_KOKORO_STEP freezeProgress must be a finite number from 0 through 1`);if(!Number.isFinite(r.timestamp)||r.timestamp<0)throw Error(`MIZU_KOKORO_STEP timestamp must be a finite non-negative number`);if(a)throw Error(`MIZU_KOKORO_STEP does not allow concurrent calls`);a=!0;try{let a=X.getDrawingBufferSize(new V);if(i===null&&(t=_m(ad),n=od.target.clone(),i=Object.freeze({width:window.innerWidth,height:window.innerHeight,devicePixelRatio:window.devicePixelRatio,rendererPixelRatio:X.getPixelRatio(),drawingBufferWidth:a.x,drawingBufferHeight:a.y,refractionWidth:pd.width,refractionHeight:pd.height,quality:rd.quality})),window.innerWidth!==i.width||window.innerHeight!==i.height||window.devicePixelRatio!==i.devicePixelRatio||X.getPixelRatio()!==i.rendererPixelRatio||a.x!==i.drawingBufferWidth||a.y!==i.drawingBufferHeight||pd.width!==i.refractionWidth||pd.height!==i.refractionHeight||rd.quality!==i.quality)throw Error(`MIZU_KOKORO_STEP capture environment changed after initialization`);if(Bf.context!==null||Q.context!==null)throw Error(`MIZU_KOKORO_STEP requires untouched audio and microphone state`);Jp!==null&&(cancelAnimationFrame(Jp),Jp=null),e.forEach(vm),vm(t),od.target.copy(n),od.enabled=!1,od.autoRotate=!1,Vp=r.timestamp,Hp=r.timestamp,Up=0,Gp=0,Kp=0,qp=0,X.setRenderTarget(null),bm(r.mode,r.freezeProgress,r.timestamp),xm();let o=Yp;pm(0);let s=await wm(),c=Yp-o,l=Jp===null?0:1;if(c!==1||l!==0)throw Error(`MIZU_KOKORO_STEP violated the single-frame scheduler contract`);return{input:{...r},logicalFrameDelta:c,queuedAnimationFrames:l,framebuffer:s}}finally{a=!1}},window.__MIZU_KOKORO_CAPTURE_VOLUME__=async e=>{if(!$u(e,[`mode`,`freezeProgress`,`freezeOrigin`,`timestamp`]))throw Error(`MIZU_KOKORO_CAPTURE_VOLUME input must contain exactly mode, freezeProgress, freezeOrigin, and timestamp`);if(!Number.isInteger(e.mode)||e.mode<0||e.mode>=Y.length)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME mode must be an integer from 0 through 3`);if(!Number.isFinite(e.freezeProgress)||e.freezeProgress<0||e.freezeProgress>1)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME freezeProgress must be a finite number from 0 through 1`);if(!Array.isArray(e.freezeOrigin)||e.freezeOrigin.length!==3||e.freezeOrigin.some(e=>!Number.isFinite(e)))throw Error(`MIZU_KOKORO_CAPTURE_VOLUME freezeOrigin must contain exactly three finite numbers`);let t=new H(...e.freezeOrigin);if(t.lengthSq()===0)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME freezeOrigin must be non-zero`);if(t.normalize(),!Number.isFinite(e.timestamp)||e.timestamp<0)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME timestamp must be a finite non-negative number`);if(a)throw Error(`MIZU_KOKORO_CAPTURE_VOLUME does not allow concurrent calls`);a=!0;let n=y(),r=X.getRenderTarget(),i=X.getActiveCubeFace(),c=X.getActiveMipmapLevel(),l;try{let n=Y[e.mode];Z.uTime.value=e.timestamp/1e3,Z.uMode.value=e.mode,Z.uFlowStrength.value=n.flow,Z.uTurbulence.value=n.turbulence,Z.uClarity.value=n.clarity,Z.uFreezeProgress.value=e.freezeProgress,Z.uFreezeOrigin.value.copy(t),Z.uFreezeTime.value=s,Z.uSceneTexture.value=g,Z.uDeepColor.value.copy(n.deepColor),Z.uMidColor.value.copy(n.midColor),Z.uLightColor.value.copy(n.lightColor),X.setRenderTarget(m),X.clear(),X.render(u,f),l=await C()}finally{b(n),X.setRenderTarget(r,i,c),a=!1}return x(n),{input:{mode:e.mode,freezeProgress:e.freezeProgress,freezeOrigin:t.toArray(),timestamp:e.timestamp},capture:{width:o,height:900,devicePixelRatio:1,cameraPosition:f.position.toArray(),freezeTime:s},texture:{width:64,height:64,format:`rgba8`,colorSpace:`linear-srgb`,hash:await _},framebuffer:l.framebuffer,regions:l.regions,stateRestored:!0}}}Rp(rd.quality),ap(0,!1),Bp(),Tm(),document.addEventListener(`visibilitychange`,cm),Zu&&(window.addEventListener(`message`,nd),ed(`ready`,{capabilities:[...Xu]})),om();
//# sourceMappingURL=index-B5bBR-6n.js.map